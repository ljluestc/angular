...
import {$EXCEPTION_HANDLER, $ROOT_SCOPE} from '../../../src/common/src/constants';export function bootstrap(
...
//
ngZone.run(() => upgrade.bootstrap(element, [failHardModule, ng1Module.name]));return upgrade;
  });
