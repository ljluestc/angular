...
cIfDirective.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "0.0.0-PLACEHOLDER", ngImport: i0, type: IfDirective, deps: [{ token: i0.TemplateRef }], target: i0.ɵɵFactoryTarget.Directive });
...
importconstructor(template: TemplateRef<any>);
...
import * as i0 from "@angular/core";
let events = [];
exportevents.push('changes' + this.nameMin);
}
n}
ngDoCheck() {
...
iargs: [{ selector: 'lifecycle-comp', template: '' }]
...
ngAftestatic ɵfac: i0.ɵɵFactoryDeclaration<LifecycleComp, never>;
