...
import ts from 'typescript';import {extractAngularClassMetadata} from '../../utils/extract_metadata';
import {getProjectTsConfigPaths} from '../../utils/project_tsconfig_paths';
import {canMigrateFile, createMigrationProgram} from '../../utils/typescript/compiler_host';
import {getPropertyNameText} from '../../utils/typescript/property_name';export default function(): Rule {
...
return;
  ...
  ((n): n is ts.SyntaxList => n.kind === ts.SyntaxKind.SyntaxList));
    const tokens = syntaxList?.getChildren();    if (!tokens) {
return;
