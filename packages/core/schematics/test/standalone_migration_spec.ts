...
import shx from 'shelljs';describe('standalone migration', () => {
  let runner: SchematicTestRunner;
  let host: TempScopedNodeJsSyncHost;
  let tree: UnitTestTree;
  let tmpDirPath: string;
  let previousWorkingDir: string;  function writeFile(filePath: string, contents: string) {
    ...
    tree = new UnitTestTree(new HostTree(host));    writeFile('/tsconfig.json', JSON.stringify({
compilerOptions: {
  lib: ['es2015'],
...
import {PlatformRef} from '@angular/core';export const platformBrowser: () => PlatformRef;
    `);    writeFile('/node_modules/@angular/platform-browser/animations/index.d.ts', `
import {ModuleWithProviders} from '@angular/core';export declare class BrowserAnimationsModule {
...
import {PlatformRef} from '@angular/core';export const platformBrowserDynamic: () => PlatformRef;
    `);    writeFile('/node_modules/@angular/common/index.d.ts', `
import {ɵɵDirectiveDeclaration, ɵɵNgModuleDeclaration} from '@angular/core';export declare class NgIf {
  ngIf: any;
...
'ngIfElse': 'ngIfElse';
  ...
  ngForOf: any;  static ɵdir: ɵɵDirectiveDeclaration<NgForOf, '[ngFor][ngForOf]', never, {
'ngForOf': 'ngForOf';
  }, {}, never, never, true>;
...
import {ModuleWithProviders, ɵɵDirectiveDeclaration, ɵɵNgModuleDeclaration} from '@angular/core';export declare class RouterLink {
...
import {ModuleWithProviders} from '@angular/core';export declare class HttpClientModule {
...
export declare function setupModule(config: any);
    ...
    tmpDirPath = getSystemPath(host.root);    // Switch into the temporary directory path. This allows us to run
    ...
    let error: string|null = null;    writeFile('dir.ts', `
import {Directive} from '@angular/core';@Directive({selector: '[dir]'})
export class MyDir {}
    `);    try {
...
error = e.message;
    ...
    let error: string|null = null;    writeFile('dir.ts', '');    try {
...
error = e.message;
  ...
  /Migration path .*\/dir\.ts has to be a directory\. Cannot run the standalone migration/);
    ...
    writeFile('module.ts', `
import {NgModule, Directive} from '@angular/core';@Directive({selector: '[dir]'})
export class MyDir {}@NgModule({declarations: [MyDir]})
export class Mod {}
    `);    await runMigration('convert-to-standalone');    expect(stripWhitespace(tree.readContent('module.ts')))
...
import {CommonModule} from '@angular/common';@Directive({selector: '[dir]'})
export class MyDir {}@NgModule({declarations: [MyDir], imports: [CommonModule]})
export class Mod {}
    `);    await runMigration('convert-to-standalone');    expect(stripWhitespace(tree.readContent('module.ts')))
 ...
 writeFile('module.ts', `
  import {NgModule, Directive} from '@angular/core';
  import {CommonModule} from '@angular/common';  @Directive({selector: '[dir]'})
  export class MyDir {}  @Directive({selector: '[dir]'})
  export class MyOtherDir {}  const extraDeclarations = [MyOtherDir];  @NgModule({declarations: [MyDir, ...extraDeclarations], imports: [CommonModule]})
  export class Mod {}
`); await runMigration('convert-to-standalone'); expect(stripWhitespace(tree.readContent('module.ts')))
...
`@NgModule({imports: [CommonModule, MyDir, ...extraDeclarations]})`));
 ...
 writeFile('module.ts', `
  import {NgModule, Directive} from '@angular/core';
  import {CommonModule} from '@angular/common';  @Directive({selector: '[dir]'})
  export class MyDir {}  @Directive({selector: '[dir]', standalone: true})
  export class MyOtherDir {}  const extraImports = [MyOtherDir];  @NgModule({declarations: [MyDir], imports: [CommonModule, ...extraImports]})
  export class Mod {}
`); await runMigration('convert-to-standalone'); expect(stripWhitespace(tree.readContent('module.ts')))
.toContain(
stripWhitespace(`@NgModule({imports: [CommonModule, ...extraImports, MyDir]})`));
 ...
 writeFile('module.ts', `
  import {NgModule, Directive} from '@angular/core';
  import {CommonModule} from '@angular/common';  @Directive({selector: '[dir]'})
  export class MyDir {}  const DECLARATIONS = [MyDir];  @NgModule({declarations: DECLARATIONS, imports: [CommonModule]})
  export class Mod {}
`); await runMigration('convert-to-standalone'); expect(stripWhitespace(tree.readContent('module.ts')))
.toContain(stripWhitespace(`@NgModule({imports: [CommonModule, ...DECLARATIONS]})`));
 ...
 writeFile('module.ts', `
  import {NgModule, Directive} from '@angular/core';
  import {CommonModule} from '@angular/common';  @Directive({selector: '[dir]'})
  export class MyDir {}  const IMPORTS = [CommonModule];  @NgModule({declarations: [MyDir], imports: IMPORTS})
  export class Mod {}
`); await runMigration('convert-to-standalone'); expect(stripWhitespace(tree.readContent('module.ts')))
.toContain(stripWhitespace(`@NgModule({imports: [...IMPORTS, MyDir]})`));
 ...
 writeFile('module.ts', `
  import {NgModule, Directive} from '@angular/core';
  import {CommonModule} from '@angular/common';  @Directive({selector: '[dir]'})
  export class MyDir {}  const IMPORTS = [CommonModule];
  const DECLARATIONS = [MyDir];  @NgModule({declarations: DECLARATIONS, imports: IMPORTS})
  export class Mod {}
`); await runMigration('convert-to-standalone'); expect(stripWhitespace(tree.readContent('module.ts')))
.toContain(stripWhitespace(`@NgModule({imports: [...IMPORTS, ...DECLARATIONS]})`));
    ...
    writeFile('module.ts', `
import {NgModule, Directive} from '@angular/core';@Directive({selector: '[dir]'})
export class MyDir {}@NgModule({declarations: [MyDir], exports: [MyDir]})
export class Mod {}
    `);    await runMigration('convert-to-standalone');    const result = tree.readContent('module.ts');    expect(stripWhitespace(result))
  ...
  .toContain(stripWhitespace(`@NgModule({imports: [MyDir], exports: [MyDir]})`));
    ...
    writeFile('module.ts', `
import {NgModule, Pipe} from '@angular/core';@Pipe({name: 'myPipe'})
export class MyPipe {}@NgModule({declarations: [MyPipe], exports: [MyPipe]})
export class Mod {}
    `);    await runMigration('convert-to-standalone');    const result = tree.readContent('module.ts');    expect(stripWhitespace(result))
...
export class Mod {}
    ...
    writeFile('./apps/app-2/module.ts', content);    await runMigration('convert-to-standalone', './apps/app-2');    expect(tree.readContent('./apps/app-1/module.ts')).not.toContain('standalone');
...
import {MyDir} from './dir';@NgModule({declarations: [MyDir], exports: [MyDir]})
export class Mod {}
    `);    writeFile('dir.ts', `
import {Directive} from '@angular/core';@Directive({selector: '[dir]'})
export class MyDir {}
  ...
  .toContain(stripWhitespace(`@Directive({selector: '[dir]', standalone: true})`));
    ...
    writeFile('module.ts', `
import {NgModule} from '@angular/core';
import {MyComp} from './comp';@NgModule({declarations: [MyComp], exports: [MyComp]})
export class Mod {}
    `);    writeFile('comp.ts', `
import {Component} from '@angular/core';@Component({selector: 'my-comp', template: '<h1>Hello</h1>'})
export class MyComp {}
    `);    await runMigration('convert-to-standalone');    expect(stripWhitespace(tree.readContent('module.ts')))
...
import {MyTooltip} from './tooltip';@NgModule({declarations: [MyComp, MyButton, MyTooltip], exports: [MyComp]})
export class Mod {}
    `);    writeFile('comp.ts', `
import {Component} from '@angular/core';@Component({selector: 'my-comp', template: '<my-button tooltip="Click me">Hello</my-button>'})
export class MyComp {}
    `);    writeFile('button.ts', `
import {Component} from '@angular/core';@Component({selector: 'my-button', template: '<ng-content></ng-content>'})
export class MyButton {}
    `);    writeFile('tooltip.ts', `
import {Directive} from '@angular/core';@Directive({selector: '[tooltip]'})
export class MyTooltip {}
    `);    await runMigration('convert-to-standalone');    const myCompContent = tree.readContent('comp.ts');    expect(myCompContent).toContain(`import { MyButton } from './button';`);
...
import {NgModule} from '@angular/core';
import {MyComp} from './comp';
import {MyButton} from './button';@NgModule({declarations: [MyComp, MyButton], exports: [MyComp]})
export class Mod {}
    `);    writeFile('comp.ts', `
import {Component} from '@angular/core';
import {helper} from './button';helper();@Component({selector: 'my-comp', template: '<my-button>Hello</my-button>'})
export class MyComp {}
    `);    writeFile('button.ts', `
import {Component} from '@angular/core';@Component({selector: 'my-button', template: '<ng-content></ng-content>'})
export class MyButton {}export function helper() {}
    `);    await runMigration('convert-to-standalone');    const myCompContent = tree.readContent('comp.ts');    expect(myCompContent).toContain(`import { helper, MyButton } from './button';`);
    expect(stripWhitespace(myCompContent)).toContain(stripWhitespace(`
@Component({
  selector: 'my-comp',
 ...
 writeFile('module.ts', `
  import {NgModule} from '@angular/core';
  import {MyComp} from './comp';
  import {MyButton} from './button';  @NgModule({imports: [MyButton], declarations: [MyComp], exports: [MyComp]})
  export class Mod {}
`); writeFile('comp.ts', `
  import {Component} from '@angular/core';  @Component({selector: 'my-comp', template: '<my-button>Hello</my-button>'})
  export class MyComp {}
`); writeFile('button.ts', `
  import {Component} from '@angular/core';
  import {MyComp} from './comp';  @Component({selector: 'my-button', template: '<ng-content></ng-content>', standalone: true})
  export class MyButton {}
`); await runMigration('convert-to-standalone');
 const myCompContent = tree.readContent('comp.ts'); expect(myCompContent).toContain(`import { MyButton } from './button';`);
 expect(stripWhitespace(myCompContent)).toContain(stripWhitespace(`
t({
selector: 'my-comp',
template: '<my-button>Hello</my-button>',
...
import {NgModule} from '@angular/core';
import {MyComp} from './comp';
import {ButtonModule} from './button.module';@NgModule({imports: [ButtonModule], declarations: [MyComp], exports: [MyComp]})
export class Mod {}
    `);    writeFile('button.module.ts', `
import {NgModule} from '@angular/core';
import {MyButton} from './button';@NgModule({declarations: [MyButton], exports: [MyButton]})
...
@NgModule({imports: [MyButton], exports: [MyButton]})
 ...
 writeFile('./should-migrate/module.ts', `
  import {NgModule} from '@angular/core';
  import {MyComp} from './comp';
  import {ButtonModule} from '../do-not-migrate/button.module';  @NgModule({imports: [ButtonModule], declarations: [MyComp], exports: [MyComp]})
  export class Mod {}
...
`); writeFile('./do-not-migrate/button.ts', `
  import {Component} from '@angular/core';  @Component({selector: 'my-button', template: '<ng-content></ng-content>'})
  export class MyButton {}
`); await runMigration('convert-to-standalone', './should-migrate'); const myCompContent = tree.readContent('./should-migrate/comp.ts'); expect(myCompContent)
...
import {MyComp, MyOtherComp} from './comp';@NgModule({imports: [CommonModule], declarations: [MyComp, MyOtherComp], exports: [MyComp]})
export class Mod {}
    `);    writeFile('comp.ts', `
...
export class MyOtherComp {
  isShown = true;
    ...
    `);    await runMigration('convert-to-standalone');    const myCompContent = tree.readContent('comp.ts');    expect(myCompContent).toContain(`import { NgFor, NgIf } from '@angular/common';`);
    expect(stripWhitespace(myCompContent)).toContain(stripWhitespace(`
@Component({
  selector: 'my-comp',
  template: \`
...
import {NgModule} from '@angular/core';
import {MyComp} from './comp';
import {MyPipe} from './pipe';@NgModule({declarations: [MyComp, MyPipe], exports: [MyComp]})
export class Mod {}
    `);    writeFile('comp.ts', `
import {Component} from '@angular/core';@Component({selector: 'my-comp', template: '{{"hello" | myPipe}}'})
export class MyComp {}
    `);    writeFile('pipe.ts', `
import {Pipe} from '@angular/core';@Pipe({name: 'myPipe'})
export class MyPipe {
  transform() {}
}
    `);    await runMigration('convert-to-standalone');    const myCompContent = tree.readContent('comp.ts');    expect(myCompContent).toContain(`import { MyPipe } from './pipe';`);
    expect(stripWhitespace(myCompContent)).toContain(stripWhitespace(`
@Component({
  selector: 'my-comp',
...
import {TestBed} from '@angular/core/testing';describe('bootstrapping an app', () => {
  it('should work', () => {
@Component({selector: 'hello', template: 'Hello'})
class Hello {}@Component({template: '<hello></hello>'})
class App {}@NgModule({declarations: [App, Hello], exports: [App, Hello]})
class Mod {}TestBed.configureTestingModule({imports: [Mod]});
const fixture = TestBed.createComponent(App);
expect(fixture.nativeElement.innerHTML).toBe('<hello>Hello</hello>');
  });
});
    `);    await runMigration('convert-to-standalone');    const content = stripWhitespace(tree.readContent('app.spec.ts'));    expect(content).toContain(stripWhitespace(`
...
class Mod {}
    ...
    writeFile('comp.ts', `
import {Component} from '@angular/core';@Component({selector: 'comp', template: '', standalone: true})
export class MyComp {}
    `);    writeFile('app.spec.ts', `
import {TestBed} from '@angular/core/testing';
import {MyComp} from './comp';describe('bootstrapping an app', () => {
  it('should work', () => {
TestBed.configureTestingModule({declarations: [MyComp]});
expect(() => TestBed.createComponent(MyComp)).not.toThrow();
  });
});
    `);    await runMigration('convert-to-standalone');    expect(stripWhitespace(tree.readContent('app.spec.ts'))).toContain(stripWhitespace(`
import {TestBed} from '@angular/core/testing';
import {MyComp} from './comp';describe('bootstrapping an app', () => {
  it('should work', () => {
...
import {NgModule} from '@angular/core';
import {MyComp} from './comp';
import {ButtonModule} from '../do-not-migrate/button.module';@NgModule({imports: [ButtonModule], declarations: [MyComp]})
export class Mod {}
    `);    writeFile('./should-migrate/comp.ts', `
import {Component} from '@angular/core';@Component({selector: 'my-comp', template: '<my-button>Hello</my-button>'})
export class MyComp {}
...
import {MyButton} from './button';@NgModule({
  imports: [forwardRef(() => ButtonModule)],
  exports: [forwardRef(() => ButtonModule)]
})
export class ExporterModule {}@NgModule({declarations: [MyButton], exports: [MyButton]})
export class ButtonModule {}
    `);    writeFile('./do-not-migrate/button.ts', `
import {Component} from '@angular/core';@Component({selector: 'my-button', template: '<ng-content></ng-content>'})
export class MyButton {}
    `);    await runMigration('convert-to-standalone', './should-migrate');    const myCompContent = tree.readContent('./should-migrate/comp.ts');
...
import {NgModule} from '@angular/core';
import {MyComp} from './comp';
import {ɵButtonModule} from '../do-not-migrate/button.module';@NgModule({imports: [ɵButtonModule], declarations: [MyComp]})
export class Mod {}
    `);    writeFile('./should-migrate/comp.ts', `
import {Component} from '@angular/core';@Component({selector: 'my-comp', template: '<my-button>Hello</my-button>'})
export class MyComp {}
...
import {MatCardModule} from '@angular/material/card';describe('bootstrapping an app', () => {
  it('should work', () => {
...
class App {}
    `;    writeFile('app.spec.ts', initialContent);    await runMigration('convert-to-standalone');    expect(tree.readContent('app.spec.ts')).toBe(initialContent);
...
import {NoopAnimationsModule} from '@angular/platform-browser/animations';describe('bootstrapping an app', () => {
 it('should work', () => {
   TestBed.configureTestingModule({
...
import {TestBed} from '@angular/core/testing';
import {MatCardModule} from '@angular/material/card';
import {BrowserAnimationsModule} from '@angular/platform-browser/animations';describe('bootstrapping an app', () => {
 it('should work', () => {
   TestBed.configureTestingModule({
...
`; writeFile('app.component.ts', appComponentContent);
 writeFile('app.module.ts', appModuleContent); writeFile('app.spec.ts', `
  import {Component} from '@angular/core';
  import {TestBed} from '@angular/core/testing';
  import {ButtonModule} from './button.module';
  import {MatCardModule} from '@angular/material/card';
  import {AppComponent} from './app.component';  describe('bootstrapping an app', () => {
it('should work', () => {
 TestBed.configureTestingModule({
 ...
 expect(fixture.nativeElement.innerHTML).toBe('');
  ...
  class TestComp {}
`); await runMigration('convert-to-standalone'); const testContent = stripWhitespace(tree.readContent('app.spec.ts')); expect(tree.readContent('app.module.ts')).toBe(appModuleContent);
...
`));
    ...
    const initialModule = `
import {NgModule, Component} from '@angular/core';@Component({selector: 'root-comp', template: 'hello'})
export class RootComp {}@NgModule({declarations: [RootComp], bootstrap: [RootComp]})
export class Mod {}
    `;    writeFile('module.ts', initialModule);    await runMigration('convert-to-standalone');    expect(tree.readContent('module.ts')).toBe(initialModule);
  });  it('should migrate a module with an empty `bootstrap` array', async () => {
    writeFile('module.ts', `
import {NgModule, Component} from '@angular/core';@Component({selector: 'root-comp', template: 'hello'})
export class RootComp {}@NgModule({declarations: [RootComp], bootstrap: []})
export class Mod {}
    `);    await runMigration('convert-to-standalone');    expect(stripWhitespace(tree.readContent('module.ts'))).toBe(stripWhitespace(`
import {NgModule, Component} from '@angular/core';@Component({selector: 'root-comp', template: 'hello', standalone: true})
export class RootComp {}@NgModule({imports: [RootComp], bootstrap: []})
export class Mod {}
    `));
  });  it('should migrate declarations that are not being bootstrapped in a root module', async () => {
    writeFile('dir.ts', `
import {Directive} from '@angular/core';@Directive({selector: '[foo]'})
export class MyDir {}
    `);    writeFile('module.ts', `
import {NgModule, Component} from '@angular/core';
import {MyDir} from './dir';@Component({selector: 'root-comp', template: 'hello'})
export class RootComp {}@NgModule({declarations: [RootComp, MyDir], bootstrap: [RootComp]})
export class Mod {}
    `);    await runMigration('convert-to-standalone');    expect(stripWhitespace(tree.readContent('dir.ts'))).toBe(stripWhitespace(`
import {Directive} from '@angular/core';@Directive({selector: '[foo]', standalone: true})
export class MyDir {}
    `));    expect(stripWhitespace(tree.readContent('module.ts'))).toBe(stripWhitespace(`
import {NgModule, Component} from '@angular/core';
import {MyDir} from './dir';@Component({selector: 'root-comp', template: 'hello'})
export class RootComp {}@NgModule({imports: [MyDir], declarations: [RootComp], bootstrap: [RootComp]})
export class Mod {}
    `));
  });  it('should generate a forwardRef for forward reference within the same file', async () => {
    writeFile('decls.ts', `
import {Component, Directive} from '@angular/core';@Component({
  selector: 'comp',
  template: '<div my-dir></div>'
})
export class MyComp {}@Directive({selector: '[my-dir]'})
export class MyDir {}
    `);    writeFile('module.ts', `
import {NgModule} from '@angular/core';
import {MyComp, MyDir} from './decls';@NgModule({declarations: [MyComp, MyDir]})
export class Mod {}
    `);    await runMigration('convert-to-standalone');    expect(stripWhitespace(tree.readContent('decls.ts'))).toEqual(stripWhitespace(`
import {Component, Directive, forwardRef} from '@angular/core';@Component({
  selector: 'comp',
  template: '<div my-dir></div>',
  standalone: true,
  imports: [forwardRef(() => MyDir)]
})
export class MyComp {}@Directive({selector: '[my-dir]', standalone: true})
export class MyDir {}
    `));
...
export class MyComp {}
    `);    writeFile('module.ts', `
import {NgModule} from '@angular/core';
import {MyComp} from './decls';@NgModule({declarations: [MyComp]})
export class Mod {}
    `);    await runMigration('convert-to-standalone');    expect(stripWhitespace(tree.readContent('decls.ts'))).toEqual(stripWhitespace(`
import {Component} from '@angular/core';@Component({
  selector: 'comp',
...
export class MyComp {}@NgModule({imports: [RouterModule], declarations: [MyComp]})
export class Mod {}
    `);    await runMigration('convert-to-standalone');    expect(stripWhitespace(tree.readContent('comp.ts'))).toEqual(stripWhitespace(`
import {Component, NgModule} from '@angular/core';
import {RouterModule} from '@angular/router';@Component({
  selector: 'comp',
  template: '<div routerLink="/"></div>',
...
export class MyComp {}@NgModule({imports: [RouterModule, MyComp]})
export class Mod {}
    `));
  });  it('should not duplicate doc strings', async () => {
    writeFile('module.ts', `
import {NgModule, Directive} from '@angular/core';/** Directive used for testing. */
@Directive({selector: '[dir]'})
export class MyDir {}/** Module used for testing. */
...
export class Mod {}
    `);    writeFile('comp.ts', `
import {Component} from '@angular/core';
import {MyButton} from '@external/button';MyButton.sayHello();@Component({selector: 'my-comp', template: '<my-button>Hello</my-button>'})
export class MyComp {}
    `);    writeFile('button.ts', `
import {Component} from '@angular/core';@Component({selector: 'my-button', template: '<ng-content></ng-content>'})
export class MyButton {}
    `);    await runMigration('convert-to-standalone');    expect(stripWhitespace(tree.readContent('comp.ts'))).toBe(stripWhitespace(`
import {Component} from '@angular/core';
import {MyButton} from '@external/button';
import {MyButton as MyButton_1} from './button';MyButton.sayHello();@Component({
...
export class MyComp {}
    ...
    writeFile('module.ts', `
import {NgModule, Directive} from '@angular/core';@Directive({selector: '[dir]'})
export class MyDir {}@NgModule({
  declarations: [MyDir],
  exports: [MyDir],
})
export class Mod {}
    `);    await runMigration('convert-to-standalone');    expect(stripWhitespace(tree.readContent('module.ts'))).toContain(stripWhitespace(`
@NgModule({
  imports: [MyDir],
  exports: [MyDir],
})
...
import {NgModule, Directive} from '@angular/core';
import {CommonModule} from '@angular/common';
import {RouterModule} from '@angular/router';@Directive({selector: '[dir]'})
export class MyDir {}@NgModule({
  imports: [
CommonModule,
RouterModule,
...
MyDir,
  ...
  exports: [MyDir],
    ...
    writeFile('module.ts', `
import {NgModule, Directive} from '@angular/core';@Directive({
  selector: '[dir]',
  exportAs: 'dir',
})
export class MyDir {}@NgModule({declarations: [MyDir]})
...
@Directive({
  ...
  standalone: true,
    ...
    writeFile('module.ts', `
import {NgModule, Directive, Component} from '@angular/core';@Directive({selector: '[dir-one]'})
export class DirOne {}@Directive({selector: '[dir-two]'})
export class DirTwo {}@Directive({selector: '[dir-three]'})
export class DirThree {}@Component({
  selector: 'my-comp',
  template: '<div dir-one dir-two dir-three></div>',
})
export class MyComp {}@NgModule({declarations: [DirOne, DirTwo, DirThree, MyComp]})
export class Mod {}
    `);    await runMigration('convert-to-standalone');    expect(stripWhitespace(tree.readContent('module.ts'))).toContain(stripWhitespace(`
@Component({
  selector: 'my-comp',
...
import {NgModule} from '@angular/core';
import {MyComp} from './comp';
import {ButtonModule} from './button.module';@NgModule({imports: [ButtonModule], declarations: [MyComp], exports: [ButtonModule, MyComp]})
export class AppModule {}
    `);    writeFile('button.module.ts', `
import {NgModule} from '@angular/core';
import {MyButton} from './button';@NgModule({imports: [MyButton], exports: [MyButton]})
export class ButtonModule {}
    `);    writeFile('comp.ts', `
import {Component} from '@angular/core';@Component({selector: 'my-comp', template: '<my-button>Hello</my-button>'})
export class MyComp {}
    `);    writeFile('button.ts', `
import {Component} from '@angular/core';@Component({selector: 'my-button', template: '<ng-content></ng-content>', standalone: true})
export class MyButton {}
    `);    await runMigration('prune-ng-modules');    const appModule = tree.readContent('app.module.ts');    expect(tree.exists('button.module.ts')).toBe(false);
...
import {NgModule} from '@angular/core';
import {MyComp} from './comp';
import {ButtonModule} from './button.module';@NgModule({declarations: [MyComp]})
export class AppModule {}
    `;    writeFile('app.module.ts', initialAppModule);
    writeFile('comp.ts', `
import {Component} from '@angular/core';@Component({selector: 'my-comp', template: 'Hello'})
export class MyComp {}
    `);    await runMigration('prune-ng-modules');    expect(tree.readContent('app.module.ts')).toBe(initialAppModule);
  });  it('should not remove a module that bootstraps a component', async () => {
    const initialAppModule = `
import {NgModule} from '@angular/core';
import {MyComp} from './comp';
import {ButtonModule} from './button.module';@NgModule({bootstrap: [MyComp]})
export class AppModule {}
    `;    writeFile('app.module.ts', initialAppModule);
    writeFile('comp.ts', `
import {Component} from '@angular/core';@Component({selector: 'my-comp', template: 'Hello'})
export class MyComp {}
    ...
    const initialAppModule = `
import {NgModule, InjectionToken} from '@angular/core';const token = new InjectionToken('token');@NgModule({providers: [{provide: token, useValue: 123}]})
export class AppModule {}
    `;    writeFile('app.module.ts', initialAppModule);    await runMigration('prune-ng-modules');    expect(tree.readContent('app.module.ts')).toBe(initialAppModule);
...
export class RoutingModule {}
    ...
    const initialAppModule = `
import {NgModule} from '@angular/core';
import {ButtonModule} from './button.module';@NgModule()
export class AppModule {
...
export class AppModule {
  constructor() {
    ...
    `);
    await runMigration('prune-ng-modules');    expect(tree.exists('app.module.ts')).toBe(false);
...
export class AppModule {}
    ...
    writeFile('app.module.ts', `
import {NgModule} from '@angular/core';const ONE = 1;
const TWO = 2;console.log(ONE + TWO);@NgModule()
export class AppModule {}
    `);
    await runMigration('prune-ng-modules');    expect(tree.exists('app.module.ts')).toBe(false);
 ...
 writeFile('app.module.ts', `
import {NgModule} from '@angular/core';
import {ButtonModule} from './button.module';@NgModule({declarations: [], providers: [], bootstrap: []})
export class AppModule {}
  `);
 await runMigration('prune-ng-modules'); expect(tree.exists('app.module.ts')).toBe(false);
...
import {NgModule} from '@angular/core';
import {ModuleA} from './a.module';@NgModule({imports: [ModuleA]})
export class ModuleB {}
    `);    writeFile('c.module.ts', `
import {NgModule} from '@angular/core';
import {ModuleB} from './b.module';@NgModule({imports: [ModuleB]})
export class ModuleC {}
    `);    writeFile('app.module.ts', `
import {NgModule} from '@angular/core';
import {MyDir} from './dir';
import {ModuleC} from './c.module';@NgModule({imports: [ModuleC], declarations: [MyDir]})
export class AppModule {}
    `);    writeFile('dir.ts', `
import {Directive} from '@angular/core';@Directive({selector: '[myDir]'})
export class MyDir {}
    `);    await runMigration('prune-ng-modules');    const appModule = tree.readContent('app.module.ts');    expect(tree.exists('a.module.ts')).toBe(false);
...
import {NgModule, InjectionToken} from '@angular/core';export const token = new InjectionToken<any>('token');@NgModule({providers: [{provide: token, useValue: 123}]})
export class ModuleA {}
...
import {Directive} from '@angular/core';@Directive({selector: '[myDir]'})
export class MyDir {}
  `); await runMigration('prune-ng-modules'); expect(tree.readContent('a.module.ts')).toBe(moduleAContent);
 ...
 expect(tree.readContent('app.module.ts')).toBe(appModuleContent);
     ...
     async () => {
 const moduleAContent = `
import {NgModule} from '@angular/core';@NgModule({imports: [RouterModule.forRoot([{path: '/foo'}])]})
export class ModuleA {}
  `; const moduleBContent = `
import {NgModule} from '@angular/core';
import {ModuleA} from './a.module';@NgModule({imports: [ModuleA]})
...
import {NgModule} from '@angular/core';
import {MyComp} from './comp';
import {sum, ButtonModule, multiply} from './button.module';@NgModule({imports: [ButtonModule], declarations: [MyComp], exports: [ButtonModule, MyComp]})
export class AppModule {}console.log(sum(1, 2), multiply(3, 4));
    `);    writeFile('button.module.ts', `
import {NgModule} from '@angular/core';
import {MyButton} from './button';export function sum(a: number, b: number) {
  return a + b;
}@NgModule({imports: [MyButton], exports: [MyButton]})
export class ButtonModule {}export function multiply(a: number, b: number) {
  return a * b;
}
    `);    writeFile('comp.ts', `
import {Component} from '@angular/core';@Component({selector: 'my-comp', template: '<my-button>Hello</my-button>'})
...
import {Component} from '@angular/core';@Component({selector: 'my-button', template: '<ng-content></ng-content>', standalone: true})
export class MyButton {}
    `);    await runMigration('prune-ng-modules');    expect(stripWhitespace(tree.readContent('button.module.ts'))).toBe(stripWhitespace(`
import {NgModule} from '@angular/core';
import {MyButton} from './button';export function sum(a: number, b: number) {
  return a + b;
...
import {NgModule} from '@angular/core';
import {MyComp} from './comp';
import {sum, multiply} from './button.module';@NgModule({imports: [], declarations: [MyComp], exports: [MyComp]})
export class AppModule {}console.log(sum(1, 2), multiply(3, 4));
    `));
...
import {NgModule} from '@angular/core';
import {MyComp} from './comp';
import {ButtonModule, TooltipModule} from './shared-modules';@NgModule({
...
import {NgModule} from '@angular/core';
import {MyButton} from './button';
import {MyTooltip} from './tooltip';@NgModule({imports: [MyButton], exports: [MyButton]})
export class ButtonModule {}@NgModule({imports: [MyTooltip], exports: [MyTooltip]})
export class TooltipModule {}
    `);    writeFile('button.ts', `
import {Directive} from '@angular/core';@Directive({selector: '[my-button]' standalone: true})
export class MyButton {}
    `);    writeFile('tooltip.ts', `
import {Directive} from '@angular/core';@Directive({selector: '[my-tooltip]' standalone: true})
export class MyTooltip {}
    `);    await runMigration('prune-ng-modules');    const appModule = tree.readContent('app.module.ts');    expect(tree.exists('shared-modules.ts')).toBe(false);
    expect(appModule).not.toContain('ButtonModule');
...
import {NgModule} from '@angular/core';
import {MyComp} from './comp';
import Foo, {ButtonModule} from './button.module';@NgModule({imports: [ButtonModule], declarations: [MyComp], exports: [ButtonModule, MyComp]})
export class AppModule {}
  `); writeFile('button.module.ts', `
import {NgModule} from '@angular/core';
import {MyButton} from './button';@NgModule({imports: [MyButton], exports: [MyButton]})
...
import {Component} from '@angular/core';@Component({selector: 'my-button', template: '<ng-content></ng-content>', standalone: true})
export class MyButton {}
  `); await runMigration('prune-ng-modules'); expect(tree.exists('button.module.ts')).toBe(false);
 expect(tree.readContent('app.module.ts')).toContain(`import Foo from './button.module';`);
    ...
    writeFile('app.module.ts', `
import {NgModule} from '@angular/core';
import {MyComp} from './comp';@NgModule({imports: [MyComp]})
export class AppModule {}
    `);    writeFile('button.module.ts', `
import {NgModule} from '@angular/core';
import {MyButton} from './button';@NgModule({imports: [MyButton], exports: [MyButton]})
...
export {MyComp} from './comp';
    ...
    writeFile('app.module.ts', `
import {NgModule} from '@angular/core';
import {MyDir} from './dir';@NgModule({imports: [MyDir]})
export class AppModule {}
    `);    writeFile('dir.ts', `
import {Directive} from '@angular/core';@Directive({selector: '[dir]', standalone: true})
export class MyDir {}
    `);    writeFile('index.ts', `export * from './app.module';`);
    writeFile('index-2.ts', `export * from './index';`);
    writeFile('index-3.ts', `export * from './index-2';`);    await runMigration('prune-ng-modules');    expect(tree.exists('index.ts')).toBe(false);
...
import {NgModule} from '@angular/core';
import {MyComp} from './comp';
import {ButtonModule} from './button.module';console.log(ButtonModule);if (typeof ButtonModule !== 'undefined') {
  console.log('Exists!');
}export const FOO = ButtonModule;@NgModule({imports: [ButtonModule], declarations: [MyComp], exports: [ButtonModule, MyComp]})
export class AppModule {}
    `);    writeFile('button.module.ts', `
import {NgModule} from '@angular/core';@NgModule()
export class ButtonModule {}
...
export class MyComp {}
    ...
    expect(stripWhitespace(tree.readContent('app.module.ts'))).toBe(stripWhitespace(`
import {NgModule} from '@angular/core';
import {MyComp} from './comp';console.log( /* TODO(standalone-migration): clean up removed NgModule reference manually. */ ButtonModule);if (typeof  /* TODO(standalone-migration): clean up removed NgModule reference manually. */ ButtonModule !== 'undefined') {
  console.log('Exists!');
}export const FOO =  /* TODO(standalone-migration): clean up removed NgModule reference manually. */ ButtonModule;@NgModule({imports: [], declarations: [MyComp], exports: [MyComp]})
export class AppModule {}
    `));
...
import {CommonModule} from '@angular/common';
import {RouterModule} from '@angular/router';const token = new InjectionToken('token');@NgModule()
export class ToDelete {}@NgModule({
  imports: [
CommonModule,
ToDelete,
RouterModule,
...
export class AppModule {}
    `;    writeFile('app.module.ts', initialAppModule);    await runMigration('prune-ng-modules');    expect(stripWhitespace(tree.readContent('app.module.ts'))).toContain(stripWhitespace(`
@NgModule({
  imports: [
CommonModule,
RouterModule,
...
import {platformBrowser} from '@angular/platform-browser';platformBrowser().bootstrapModule(AppModule).catch(e => console.error(e));
    `);    writeFile('./app/app.module.ts', `
import {NgModule, Component} from '@angular/core';@Component({template: 'hello'})
export class AppComponent {}@NgModule({declarations: [AppComponent], bootstrap: [AppComponent]})
export class AppModule {}
    `);    await runMigration('standalone-bootstrap');    expect(stripWhitespace(tree.readContent('main.ts'))).toBe(stripWhitespace(`
import {AppComponent} from './app/app.module';
import {platformBrowser, bootstrapApplication} from '@angular/platform-browser';bootstrapApplication(AppComponent).catch(e => console.error(e));
    `));    expect(stripWhitespace(tree.readContent('./app/app.module.ts'))).toBe(stripWhitespace(`
import {NgModule, Component} from '@angular/core';@Component({template: 'hello', standalone: true})
export class AppComponent {}
    `));
 ...
 writeFile('main.ts', `
import {AppModule} from './app/app.module';
import {platformBrowserDynamic} from '@angular/platform-browser-dynamic';platformBrowserDynamic().bootstrapModule(AppModule).catch(e => console.error(e));
  `); writeFile('./app/app.module.ts', `
import {NgModule, Component} from '@angular/core';@Component({template: 'hello'})
export class AppComponent {}@NgModule({declarations: [AppComponent], bootstrap: [AppComponent]})
export class AppModule {}
...
import {bootstrapApplication} from '@angular/platform-browser';bootstrapApplication(AppComponent).catch(e => console.error(e));
  `)); expect(stripWhitespace(tree.readContent('./app/app.module.ts'))).toBe(stripWhitespace(`
import {NgModule, Component} from '@angular/core';@Component({template: 'hello', standalone: true})
export class AppComponent {}
  `));
    ...
    writeFile('main.ts', `
import {AppModule} from './app/app.module';
import {PlatformRef} from '@angular/core';const foo: PlatformRef = null!;foo.bootstrapModule(AppModule).catch(e => console.error(e));
    `);    writeFile('./app/app.module.ts', `
import {NgModule, Component} from '@angular/core';@Component({template: 'hello'})
export class AppComponent {}@NgModule({declarations: [AppComponent], bootstrap: [AppComponent]})
export class AppModule {}
...
import {bootstrapApplication} from '@angular/platform-browser';const foo: PlatformRef = null!;bootstrapApplication(AppComponent).catch(e => console.error(e));
    `));    expect(stripWhitespace(tree.readContent('./app/app.module.ts'))).toBe(stripWhitespace(`
import {NgModule, Component} from '@angular/core';@Component({template: 'hello', standalone: true})
export class AppComponent {}
    `));
...
import {Component} from '@angular/core';@Component({template: '<div *ngIf="show" dir>hello</div>'})
export class AppComponent {
  show = true;
}
...
import {Dir} from './dir';@NgModule({
  imports: [CommonModule],
  declarations: [AppComponent, Dir],
  bootstrap: [AppComponent]
})
export class AppModule {}
    `);    await runMigration('standalone-bootstrap');    expect(tree.exists('./app/app.module.ts')).toBe(false);
...
import {CommonModule} from '@angular/common';bootstrapApplication(AppComponent, {
...
import {Component} from '@angular/core';
import {Dir} from './dir';
import {NgIf} from '@angular/common';@Component({
...
import {platformBrowser} from '@angular/platform-browser';platformBrowser().bootstrapModule(AppModule).catch(e => console.error(e));
    `);    writeFile('./app/app.component.ts', `
import {Component} from '@angular/core';@Component({template: 'hello'})
export class AppComponent {}
...
import {AppComponent} from './app.component';@NgModule({declarations: [AppComponent], bootstrap: [AppComponent]})
export class AppModule {}
    `);    await runMigration('standalone-bootstrap');    expect(stripWhitespace(tree.readContent('./app/app.component.ts'))).toBe(stripWhitespace(`
import {Component} from '@angular/core';@Component({template: 'hello', standalone: true})
export class AppComponent {}
...
import {InternalInterface} from './interfaces/internal-interface';const internalToken = new InjectionToken<string>('internalToken');
export const exportedToken = new InjectionToken<InternalInterface>('exportedToken');export class ExportedClass {}export function exportedFactory(value: InternalInterface) {
  return value.foo;
...
export class AppModule {}
    `);    await runMigration('standalone-bootstrap');    // Note that this leaves a couple of unused imports from `app.module`.
...
import {InjectionToken} from '@angular/core';const internalToken = new InjectionToken<string>('internalToken');
const unexportedExtraProviders = [
  {provide: aliasedExternalToken, useFactory: (value: ExternalInterface) => value.foo}
...
import {platformBrowser} from '@angular/platform-browser';platformBrowser().bootstrapModule(AppModule).catch(e => console.error(e));
    `);    writeFile('./app/app.module.ts', `
import {NgModule, Component, InjectionToken} from '@angular/core';export const token = new InjectionToken<string>('token');console.log(token);@Component({template: 'hello'})
export class AppComponent {}@NgModule({
  declarations: [AppComponent],
  bootstrap: [AppComponent],
...
import {platformBrowser, bootstrapApplication} from '@angular/platform-browser';
import {InjectionToken} from '@angular/core';bootstrapApplication(AppComponent, {
  providers: [{ provide: token, useValue: 'hello' }]
}).catch(e => console.error(e));
    `));    expect(stripWhitespace(tree.readContent('./app/app.module.ts'))).toBe(stripWhitespace(`
import {NgModule, Component, InjectionToken} from '@angular/core';export const token = new InjectionToken<string>('token');console.log(token);@Component({template: 'hello', standalone: true})
export class AppComponent {}
    `));
...
import {platformBrowser} from '@angular/platform-browser';platformBrowser().bootstrapModule(AppModule).catch(e => console.error(e));
  `); writeFile('./app/app.module.ts', `
import {NgModule, Component} from '@angular/core';
import {ROUTES} from '@angular/router';@Component({template: 'hello'})
export class AppComponent {}@NgModule({
 declarations: [AppComponent],
 bootstrap: [AppComponent],
 providers: [{
...
import {AppComponent} from './app/app.module';
import {platformBrowser, bootstrapApplication} from '@angular/platform-browser';
import {ROUTES} from '@angular/router';bootstrapApplication(AppComponent, {
 providers: [{
   provide: ROUTES,
   useValue: [
 {path: 'internal-comp', loadComponent: () => import("./routes/internal-comp").then(c => c.InternalComp)},
...
`); writeFile('./modules/internal.module.ts', `
  import {NgModule} from '@angular/core';
  import {token} from '../token';  @NgModule({providers: [{provide: token, useValue: 'InternalModule'}]})
  export class InternalModule {}
`); writeFile('./app/app.module.ts', `
  import {NgModule, Component} from '@angular/core';
  import {CommonModule} from '@angular/common';
  import {InternalModule} from '../modules/internal.module';
  import {token} from '../token';  @Component({template: 'hello', standalone: true})
  export class AppComponent {}  @NgModule({providers: [{provide: token, useValue: 'SameFileModule'}]})
  export class SameFileModule {}  @NgModule({
...
import {platformBrowser} from '@angular/platform-browser';platformBrowser().bootstrapModule(AppModule).catch(e => console.error(e));
    `);    writeFile('./app/app.module.ts', `
import {NgModule, Component} from '@angular/core';
import {RouterModule} from '@angular/router';@Component({template: 'hello'})
export class AppComponent {}@NgModule({
  declarations: [AppComponent],
  bootstrap: [AppComponent],
  imports: [
...
import {AppComponent} from './app/app.module';
import {platformBrowser, bootstrapApplication} from '@angular/platform-browser';
import {provideRouter} from '@angular/router';bootstrapApplication(AppComponent, {
...
import {APP_ROUTES} from './routes';@Component({template: 'hello'})
export class AppComponent {}@NgModule({
  declarations: [AppComponent],
  bootstrap: [AppComponent],
...
import {NgModule, Component} from '@angular/core';
import {RouterModule} from '@angular/router';
import {of} from 'rxjs';@Component({template: 'hello'})
export class AppComponent {}@NgModule({
  declarations: [AppComponent],
  bootstrap: [AppComponent],
...
import {platformBrowser, bootstrapApplication} from '@angular/platform-browser';
import {of} from 'rxjs';
import {withPreloading, provideRouter} from '@angular/router';bootstrapApplication(AppComponent, {
...
import {AppComponent} from './app/app.module';
import {platformBrowser, bootstrapApplication} from '@angular/platform-browser';
import {withDebugTracing, provideRouter} from '@angular/router';bootstrapApplication(AppComponent, {
...
import {AppComponent} from './app/app.module';
import {platformBrowser, bootstrapApplication} from '@angular/platform-browser';
import {withEnabledBlockingInitialNavigation, provideRouter} from '@angular/router';bootstrapApplication(AppComponent, {
...
import {AppComponent} from './app/app.module';
import {platformBrowser, bootstrapApplication} from '@angular/platform-browser';
import {withDisabledInitialNavigation, provideRouter} from '@angular/router';bootstrapApplication(AppComponent, {
...
import {AppComponent} from './app/app.module';
import {platformBrowser, bootstrapApplication} from '@angular/platform-browser';
import {withHashLocation, provideRouter} from '@angular/router';bootstrapApplication(AppComponent, {
...
import {AppComponent} from './app/app.module';
import {platformBrowser, bootstrapApplication} from '@angular/platform-browser';
import {withNavigationErrorHandler, provideRouter} from '@angular/router';bootstrapApplication(AppComponent, {
...
import {AppComponent} from './app/app.module';
import {platformBrowser, bootstrapApplication} from '@angular/platform-browser';
import {withInMemoryScrolling, provideRouter} from '@angular/router';bootstrapApplication(AppComponent, {
...
import {AppComponent} from './app/app.module';
import {platformBrowser, bootstrapApplication} from '@angular/platform-browser';
import {withHashLocation, withRouterConfig, provideRouter} from '@angular/router';bootstrapApplication(AppComponent, {
...
`); writeFile('./app/app.module.ts', `
  import {NgModule, Component} from '@angular/core';
  import {RouterModule} from '@angular/router';  @Component({template: 'hello'})
  export class AppComponent {}  const extraOptions = {useHash: true};  @NgModule({
declarations: [AppComponent],
bootstrap: [AppComponent],
imports: [RouterModule.forRoot([], {
 enableTracing: true,
...
`); await runMigration('standalone-bootstrap'); expect(stripWhitespace(tree.readContent('main.ts'))).toBe(stripWhitespace(`
  ...
  import {platformBrowser, bootstrapApplication} from '@angular/platform-browser';
  import {importProvidersFrom} from '@angular/core';
  import {RouterModule} from '@angular/router';  const extraOptions = {useHash: true};  bootstrapApplication(AppComponent, {
...
import {platformBrowser} from '@angular/platform-browser';platformBrowser().bootstrapModule(AppModule).catch(e => console.error(e));
    `);    writeFile('./app/app.module.ts', `
import {NgModule, Component} from '@angular/core';
import {BrowserAnimationsModule} from '@angular/platform-browser/animations';@Component({template: 'hello'})
export class AppComponent {}@NgModule({
  declarations: [AppComponent],
  bootstrap: [AppComponent],
...
import {AppComponent} from './app/app.module';
import {platformBrowser, bootstrapApplication} from '@angular/platform-browser';
import {provideAnimations} from '@angular/platform-browser/animations';bootstrapApplication(AppComponent, {
...
import {platformBrowser, bootstrapApplication} from '@angular/platform-browser';
import {importProvidersFrom} from '@angular/core';
import {BrowserAnimationsModule} from '@angular/platform-browser/animations';bootstrapApplication(AppComponent, {
...
import {platformBrowser} from '@angular/platform-browser';platformBrowser().bootstrapModule(AppModule).catch(e => console.error(e));
    `);    writeFile('./app/app.module.ts', `
import {NgModule, Component} from '@angular/core';
import {NoopAnimationsModule} from '@angular/platform-browser/animations';@Component({template: 'hello'})
export class AppComponent {}@NgModule({
  declarations: [AppComponent],
  bootstrap: [AppComponent],
...
import {AppComponent} from './app/app.module';
import {platformBrowser, bootstrapApplication} from '@angular/platform-browser';
import {provideNoopAnimations} from '@angular/platform-browser/animations';bootstrapApplication(AppComponent, {
...
import {platformBrowser} from '@angular/platform-browser';platformBrowser().bootstrapModule(AppModule).catch(e => console.error(e));
    `); writeFile('./app/app.module.ts', `
import {NgModule, Component} from '@angular/core';
import {HttpClientModule} from '@angular/common/http';@Component({template: 'hello'})
export class AppComponent {}@NgModule({
  declarations: [AppComponent],
  bootstrap: [AppComponent],
...
import {AppComponent} from './app/app.module';
import {platformBrowser, bootstrapApplication} from '@angular/platform-browser';
import {withInterceptorsFromDi, provideHttpClient} from '@angular/common/http';bootstrapApplication(AppComponent, {
...
`); writeFile('./app/app.module.ts', `
  ...
  import {CommonModule} from '@angular/common';  @Directive({selector: '[dir]', standalone: true})
  export class Dir {}  @Component({template: '<span dir></span>'})
  export class AppComponent {}  @NgModule({imports: [Dir, CommonModule], declarations: [AppComponent], bootstrap: [AppComponent]})
  export class AppModule {}
`); await runMigration('standalone-bootstrap'); expect(stripWhitespace(tree.readContent('main.ts'))).toBe(stripWhitespace(`
  import {AppComponent} from './app/app.module';
  import {platformBrowser, bootstrapApplication} from '@angular/platform-browser';
...
import {NgModule, Component, InjectionToken} from '@angular/core';const token = new InjectionToken<string>('token');@Component({selector: 'root-comp', template: '', standalone: true})
export class Root {}@NgModule({
 imports: [Root],
 exports: [Root],
 providers: [{provide: token, useValue: 'hello'}]
})
export class RootModule {}
  `); writeFile('./app/app.module.ts', `
import {NgModule, Component} from '@angular/core';
import {RootModule, Root} from './root.module';@NgModule({
 imports: [RootModule],
 bootstrap: [Root]
})
export class AppModule {}
...
import {platformBrowser, bootstrapApplication} from '@angular/platform-browser';
import {importProvidersFrom} from '@angular/core';
import {RootModule, Root} from './app/root.module';bootstrapApplication(Root, {
...
import {platformBrowser} from '@angular/platform-browser';platformBrowser().bootstrapModule(AppModule).catch(e => console.error(e));
    `);    writeFile('./app/app.module.ts', `
import {NgModule, Component} from '@angular/core';@Component({selector: 'app', template: 'hello'})
export class AppComponent {}@NgModule({declarations: [AppComponent], bootstrap: [AppComponent]})
export class AppModule {}
...
expect(await rootSelector.isPresent()).toBe(true);
    ...
    `);    await runMigration('standalone-bootstrap');    expect(stripWhitespace(tree.readContent('main.ts'))).toBe(stripWhitespace(`
import {AppComponent} from './app/app.module';
import {platformBrowser, provideProtractorTestingSupport, bootstrapApplication} from '@angular/platform-browser';bootstrapApplication(AppComponent, {
...
export class AppModule {}
    `);    writeFile('./app/app.e2e.spec.ts', `
import {browser, by, element} from 'protractor/some/deep-import';describe('app', () => {
  beforeAll(async () => {
await browser.get(browser.params.testUrl);
  });  it('should work', async () => {
const rootSelector = element(by.css('app'));
