...
import {of} from 'rxjs';describe('text instructions', () => {
...
nine = 9;
    ...
    fixture.detectChanges();    const allTextContent =
  Array.from((fixture.nativeElement as HTMLElement).querySelectorAll('div'))
 .map((div: HTMLDivElement) => div.textContent);    expect(allTextContent).toEqual([
'a1b2c3d4e5f6g7h8i9j',
'a1b2c3d4e5f6g7h8i',
'a1b2c3d4e5f6g7h',
'a1b2c3d4e5f6g',
...
item = of({
  ...
  where: 'seashore',
    ...
    const fixture = TestBed.createComponent(App);
    fixture.detectChanges();    const p = fixture.nativeElement.querySelector('p') as HTMLDivElement;
...
thisisfine = 'javascript:alert("image_of_dog_with_coffee_in_burning_building.gif")';
    ...
    const p = fixture.nativeElement.querySelector('p');    expect(p.textContent)
...
test = '<h1>LOL, big text</h1>';
    ...
    const fixture = TestBed.createComponent(App);
    fixture.detectChanges();
    const div = fixture.nativeElement.querySelector('div');    expect(div.innerHTML).toBe('&lt;h1&gt;LOL, big text&lt;/h1&gt;');
...
test = function foo() {};
    ...
    const fixture = TestBed.createComponent(App);
    fixture.detectChanges();
    const div = fixture.nativeElement.querySelector('div');    expect(div.innerHTML).toBe(fixture.componentInstance.test.toString());
...
object = new TestObject();
    ...
    const fixture = TestBed.createComponent(App);
    fixture.detectChanges();    expect(fixture.nativeElement.textContent).toBe('toString');
...
symbol = Symbol('hello');
    ...
    const fixture = TestBed.createComponent(App);
    fixture.detectChanges();    // Note that this uses `toContain`, because a polyfilled `Symbol` produces something like
...
template: `{{'Interpolations look like {{this}}'}}`,
    ...
    const fixture = TestBed.createComponent(App);
    fixture.detectChanges();    expect(fixture.nativeElement.textContent).toBe('Interpolations look like {{this}}');
  });
});
