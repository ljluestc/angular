...
import {expect} from '@angular/platform-browser/testing/src/matchers';describe('pipe', () => {
...
person = {name: 'bob'};
    ...
    fixture.detectChanges();    expect(fixture.nativeElement.textContent).toBe('bob state:0');
...
@ViewChild(Dir) directive!: Dir;
    ...
    const fixture = TestBed.createComponent(App);
    fixture.detectChanges();    expect(fixture.componentInstance.directive.dirProp).toBe('aa');
...
person = {name: 'value', address: {city: 'two'}};
    ...
    const fixture = TestBed.createComponent(App);
    fixture.detectChanges();    expect(fixture.nativeElement.textContent).toBe('value one two default');
...
person = {name: 'value'};
    ...
    const fixture = TestBed.createComponent(App);
    fixture.detectChanges();    expect(fixture.nativeElement.textContent).toEqual('value a b default 0 1 2 3');
...
declarations: [PipeB, App],
    ...
    const fixture = TestBed.createComponent(App);
    fixture.detectChanges();    expect(fixture.nativeElement.textContent).toBe('PipeB: 10');
  });  it('should respect imported module order when selecting Pipe (last imported Pipe is used)',
     () => {
 @Pipe({name: 'number'})
 class PipeA implements PipeTransform {
(value: any) {
return `PipeA: ${value}`; } @NgModule({
ons: [PipeA],
[PipeA],
 })
 class ModuleA {
...
ons: [App],
 ...
 fixture.detectChanges(); expect(fixture.nativeElement.textContent).toBe('PipeB: 10');
    ...
    let calls: any[] = [];    @Pipe({name: 'identityPipe'})
...
person = {name: 'Megatron'};
    ...
    const fixture = TestBed.createComponent(App);
    fixture.detectChanges();    expect(calls).toEqual(['Megatron']);    fixture.detectChanges();    expect(calls).toEqual(['Megatron']);
...
person = {name: 'bob'};
    ...
    const fixture = TestBed.createComponent(App);
    fixture.detectChanges();    expect(fixture.nativeElement.textContent).toEqual('bob from duplicate 2');
...
condition = false;
    ...
    const fixture = TestBed.createComponent(App);
    fixture.detectChanges();    expect(fixture.nativeElement).toHaveText('b');    fixture.componentInstance.condition = true;
...
getHello() {
  return 'Hello there';
    ...
    // @Injectable()
    class ParentPipe {
constructor(protected sayHelloService: SayHelloService) {}static ɵfac = (t?: any) => new(t || ParentPipe)(ɵɵinject(SayHelloService));
...
value = 'test';
    ...
    fixture.detectChanges();    expect(fixture.nativeElement.textContent).toBe('Hello there');
  });  describe('pure', () => {
...
const fixture = TestBed.createComponent(App);
fixture.detectChanges();// change from undefined -> null
...
expect(fixture.nativeElement.textContent).toEqual('null state:0');// change from null -> some value
fixture.componentInstance.person.name = 'bob';
fixture.detectChanges();
expect(fixture.nativeElement.textContent).toEqual('bob state:1');fixture.detectChanges();
expect(fixture.nativeElement.textContent).toEqual('bob state:1');// change from some value -> some other value
...
expect(fixture.nativeElement.textContent).toEqual('bart state:2');
    ...
    let impurePipeInstances: CountingImpurePipe[] = [];    @Pipe({name: 'countingImpurePipe', pure: false})
...
constructor() {
  impurePipeInstances.push(this);
    ...
    afterEach(() => impurePipeInstances = []);    it('should call impure pipes on each change detection run', () => {
@Component({
...
const fixture = TestBed.createComponent(App);
const pipe = impurePipeInstances[0];spyOn(pipe, 'transform').and.returnValue('');
expect(pipe.transform).not.toHaveBeenCalled();fixture.detectChanges();
...
TestBed.createComponent(App);expect(impurePipeInstances.length).toEqual(4);
...
let destroyCalls = 0;@Pipe({name: 'pipeWithOnDestroy'})
...
const fixture = TestBed.createComponent(App);
fixture.detectChanges();
fixture.destroy();expect(destroyCalls).toBe(1);
    });
...
const fixture = TestBed.createComponent(App);
fixture.detectChanges();expect(fixture.nativeElement.textContent).toBe('MyComponent Title - Service Title');
    });    it('should be able to handle Token injections', () => {
class Service {
  title = 'Service Title';
}const token = new InjectionToken<Service>('service token');@Pipe({name: 'myConcatPipe'})
class ConcatPipe implements PipeTransform {
...
fixture.detectChanges();expect(fixture.nativeElement.textContent).toBe('MyComponent Title - Service Title');
 ...
 () => {
hangeDetectorRef: ChangeDetectorRef|undefined;t({
changeDetection: ChangeDetectionStrategy.OnPush,
selector: 'some-comp',
template: 'Inner value: "{{displayValue}}"',eComp {
@Input() value: any;
displayValue = 0;t({
changeDetection: ChangeDetectionStrategy.OnPush,
template: `
...
pipeValue = 10;
displayValue = 0;me: 'testPipe'})
tPipe implements PipeTransform {
constructor(changeDetectorRef: ChangeDetectorRef) {
  pipeChangeDetectorRef = changeDetectorRef;
}transform() {
  return '';
}onfigureTestingModule({declarations: [App, SomeComp, TestPipe]});
ture = TestBed.createComponent(App);
etectChanges();omponentInstance.displayValue = 1;
omponentInstance.comp.displayValue = 1;
eDetectorRef!.markForCheck();
etectChanges();xture.nativeElement.textContent).toContain('Outer value: "1"');
xture.nativeElement.textContent).toContain('Inner value: "0"');
...
changeDetection: ChangeDetectionStrategy.OnPush,
selector: 'some-comp',
template: 'Inner value: "{{displayValue}}" <ng-content></ng-content>',eComp {
@Input() value: any;
displayValue = 0;t({
changeDetection: ChangeDetectionStrategy.OnPush,
template: `
...
TestBed.configureTestingModule({declarations: [App, ThrowPipe]}).createComponent(App);// first invocation
expect(() => fixture.detectChanges()).toThrowError(/ThrowPipeError/);// second invocation - should not throw
fixture.detectChanges();
...
TestBed.configureTestingModule({declarations: [App, ThrowPipe]}).createComponent(App);// first invocation - no error thrown
fixture.detectChanges();
...
expect(fixture.nativeElement.textContent).toBe('anything');// third invocation with no changes to input - should not thrown and preserve the last known
// results
fixture.detectChanges();
...
val = 'anything';
  ...
  ' Verify that it is declared or imported in this module'));    describe(
