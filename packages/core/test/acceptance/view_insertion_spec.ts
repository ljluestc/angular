...
class App {
  ...
  container: ViewContainerRef = null!;  @ViewChild('simple', {read: TemplateRef, static: true}) simple: TemplateRef<any> = null!;  view0: EmbeddedViewRef<any> = null!;
  view1: EmbeddedViewRef<any> = null!;
  view2: EmbeddedViewRef<any> = null!;
  view3: EmbeddedViewRef<any> = null!;  constructor(public changeDetector: ChangeDetectorRef) {}  ngAfterViewInit() {
// insert at the front
this.view1 = this.container.createEmbeddedView(this.simple);  // "created0"// insert at the front again
this.view0 = this.container.createEmbeddedView(this.simple, {}, 0);  // "created1"// insert at the end
this.view3 = this.container.createEmbeddedView(this.simple);  // "created2"// insert in the middle
this.view2 = this.container.createEmbeddedView(this.simple, {}, 2);  // "created3"// We need to run change detection here to avoid
...
const app = fixture.componentInstance;expect(app.container.indexOf(app.view0)).toBe(0);
...
class App {
  @ViewChild('container', {read: ViewContainerRef}) container: ViewContainerRef = null!;  @ViewChild('empty', {read: TemplateRef}) empty: TemplateRef<any> = null!;  view0: EmbeddedViewRef<any> = null!;
  view1: EmbeddedViewRef<any> = null!;
  view2: EmbeddedViewRef<any> = null!;
  view3: EmbeddedViewRef<any> = null!;  ngAfterViewInit() {
// insert at the front
this.view1 = this.container.createEmbeddedView(this.empty);// insert at the front again
this.view0 = this.container.createEmbeddedView(this.empty, {}, 0);// insert at the end
this.view3 = this.container.createEmbeddedView(this.empty);// insert in the middle
...
class Comp {
  @ViewChild('container', {read: ViewContainerRef}) container: ViewContainerRef = null!;  @ViewChild('projection', {read: TemplateRef}) projection: TemplateRef<any> = null!;  view0: EmbeddedViewRef<any> = null!;
  view1: EmbeddedViewRef<any> = null!;
  view2: EmbeddedViewRef<any> = null!;
  view3: EmbeddedViewRef<any> = null!;  ngAfterViewInit() {
// insert at the front
this.view1 = this.container.createEmbeddedView(this.projection);// insert at the front again
this.view0 = this.container.createEmbeddedView(this.projection, {}, 0);// insert at the end
this.view3 = this.container.createEmbeddedView(this.projection);// insert in the middle
...
const fixture = TestBed.createComponent(App);
fixture.detectChanges();
const comp = fixture.debugElement.query(By.directive(Comp)).injector.get(Comp);expect(comp.container.indexOf(comp.view0)).toBe(0);
expect(comp.container.indexOf(comp.view1)).toBe(1);
expect(comp.container.indexOf(comp.view2)).toBe(2);
expect(comp.container.indexOf(comp.view3)).toBe(3);// Both ViewEngine and Ivy only honor one of the inserted ng-content components, even though
// all are inserted.
...
class App {
  @ViewChild('container', {read: ViewContainerRef}) container: ViewContainerRef = null!;  @ViewChild('subContainer', {read: TemplateRef}) subContainer: TemplateRef<any> = null!;  view0: EmbeddedViewRef<any> = null!;
  view1: EmbeddedViewRef<any> = null!;
  view2: EmbeddedViewRef<any> = null!;
  view3: EmbeddedViewRef<any> = null!;  constructor(public changeDetectorRef: ChangeDetectorRef) {}  ngAfterViewInit() {
// insert at the front
this.view1 = this.container.createEmbeddedView(this.subContainer, null, 0);// insert at the front again
this.view0 = this.container.createEmbeddedView(this.subContainer, null, 0);// insert at the end
this.view3 = this.container.createEmbeddedView(this.subContainer, null, 2);// insert in the middle
this.view2 = this.container.createEmbeddedView(this.subContainer, null, 2);// We need to run change detection here to avoid
...
expect(app.container.indexOf(app.view1)).toBe(1);
expect(app.container.indexOf(app.view2)).toBe(2);
expect(app.container.indexOf(app.view3)).toBe(3);expect(fixture.debugElement.queryAll(By.css('div.dynamic')).length).toBe(4);
    });
  });  describe('before another view', () => {
    @Directive({selector: '[viewInserting]', exportAs: 'vi'})
    class ViewInsertingDir {
constructor(private _vcRef: ViewContainerRef) {}insert(beforeView: ViewRef, insertTpl: TemplateRef<{}>) {
...
class TestCmpt {
  ...
  @ViewChild('vi', {static: true}) viewInsertingDir!: ViewInsertingDir;  minutes = 10;  insert() {
...
<ng-template #before>${beforeTpl}</ng-template><div><ng-template #vi="vi" viewInserting></ng-template></div>
  `);
  const fixture = TestBed.createComponent(TestCmpt);
  fixture.detectChanges();  fixture.componentInstance.insert();
  fixture.detectChanges();  return fixture.nativeElement;
...
<ng-container>
 ...
 .toBe('insert|before');
});it('should insert before a view with ICU container inside a ng-container as the first root node',expect(
createAndInsertViews(
    `<ng-container i18n>{minutes, plural, =0 {just now} =1 {one minute ago} other {|before}}</ng-container>`)
    .textContent)
.toBe('insert|before');it('should insert before a view with a container as the first root node', () => {
 ...
 .toBe('insert|before');
});it('should insert before a view with a ng-container where ViewContainerRef is injected',expect(createAndInsertViews(`
<ng-container [ngTemplateOutlet]="after">|before</ng-container>
<ng-template #after>|after</ng-template>
  `).textContent)
.toBe('insert|before|after');it('should insert before a view with an element where ViewContainerRef is injected', () => {
  expect(createAndInsertViews(`
...
template: `
 ...
 <div>|end</div> <ng-template #tpl>test</ng-template>
`
  })
  class AppComponent {
insertTpl = false;
...
imports: [CommonModule],
  ...
  fixture.detectChanges();  expect(fixture.nativeElement.textContent).toBe('start|test|end');  fixture.componentInstance.insertTpl = true;
  fixture.detectChanges();
...
class WithContentCmpt {
  @ViewChild('insert', {static: true}) insertTpl!: TemplateRef<{}>;
  @ViewChild('before', {static: true}) beforeTpl!: TemplateRef<{}>;
  @ViewChild('vi', {static: true}) viewInsertingDir!: ViewInsertingDir;  insert() {
const beforeView = this.beforeTpl.createEmbeddedView({});
// change-detect the "before view" to create all child views
beforeView.detectChanges();
this.viewInsertingDir.insert(beforeView, this.insertTpl);
...
imports: [CommonModule],
  ...
  const fixture = TestBed.createComponent(TestCmpt);
  fixture.detectChanges();  fixture.componentInstance.withContentCmpt.insert();
  fixture.detectChanges();  expect(fixture.nativeElement.textContent).toBe('insert|before');
});it('should insert before a view with projected container', () => {
  TestBed.overrideTemplate(
 TestCmpt,
 `<with-content #wc><ng-template [ngIf]="true">|before</ng-template></with-content>`);  const fixture = TestBed.createComponent(TestCmpt);
  fixture.detectChanges();  fixture.componentInstance.withContentCmpt.insert();
  fixture.detectChanges();  expect(fixture.nativeElement.textContent).toBe('insert|before');
});
...
template: `
 ...
 <div><ng-template #vi="vi" viewInserting></ng-template></div>
  ...
  class TestCmpt {
@ViewChild('insert', {static: true}) insertTpl!: TemplateRef<{}>;
@ViewChild('vi', {static: true}) viewInsertingDir!: ViewInsertingDir;constructor(private _vcr: ViewContainerRef, private _injector: Injector) {}insert() {
 ...
 {declarations: [TestCmpt, ViewInsertingDir, DynamicComponent]});  const fixture = TestBed.createComponent(TestCmpt);
  fixture.detectChanges();  fixture.componentInstance.insert();
  fixture.detectChanges();  expect(fixture.nativeElement.textContent).toBe('insert|before');
});
    });
 ...
 () => {
t({selector: 'dynamic-cmpt', template: 'dynamic'})
amicComponent {t({
selector: 'app-root',
template: `
 <div>start|</div>
 <ng-container #container></ng-container>
 <div>|end</div> <div (click)="click()" >|click</div>
  `Component {
@ViewChild('container', {read: ViewContainerRef, static: true}) vcr!: ViewContainerRef;click() {
  this.vcr.createComponent(DynamicComponent);
}onfigureTestingModule({
declarations: [AppComponent, DynamicComponent],ture = TestBed.createComponent(AppComponent);
etectChanges();
xture.nativeElement.textContent).toBe('start||end|click');omponentInstance.click();
etectChanges();
xture.nativeElement.textContent).toBe('start|dynamic|end|click');
...
template: `
  ...
  <ng-container #container></ng-container>
  <div>|container end</div>  <ng-template #template >test</ng-template>
  <div (click)="click()" >|click</div>
  `Component {
@ViewChild('container', {read: ViewContainerRef, static: true}) vcr!: ViewContainerRef;@ViewChild('template', {read: TemplateRef, static: true}) template!: TemplateRef<any>;click() {
  this.vcr.createEmbeddedView(this.template, undefined, 0);
}onfigureTestingModule({
declarations: [AppComponent],ture = TestBed.createComponent(AppComponent);
etectChanges();
xture.nativeElement.textContent).toBe('container start||container end|click');omponentInstance.click();
etectChanges();
xture.nativeElement.textContent).toBe('container start|test|container end|click');
...
fixture.detectChanges();
expect(fixture.nativeElement.textContent.trim()).toContain('1');fixture.componentInstance.items = [2, 1];
fixture.detectChanges();expect(fixture.nativeElement.textContent.trim()).toContain('2  1');
    });
...
class TestCmpt {
  ...
  TestBed.createComponent(TestCmpt);
}).toThrowError('Error in a constructor');const fixture = TestBed.createComponent(TestCmpt);
...
class TestCmpt {
  ...
  TestBed.createComponent(TestCmpt);
}).toThrowError('Error in an input');expect(() => {
  TestBed.createComponent(TestCmpt);
...
throw new Error('Error in static query setter');
  ...
  TestBed.createComponent(TestCmpt);
}).toThrowError('Error in static query setter');expect(() => {
  TestBed.createComponent(TestCmpt);
...
if (!hasThrown) {
 ...
 throw new Error('Error in static query setter');
  ...
  TestBed.createComponent(TestCmpt);
}).toThrowError('Error in static query setter');const fixture = TestBed.createComponent(TestCmpt);expect(fixture.componentInstance.directive).toBeInstanceOf(SomeDirective);
    });    it('should render a recursive component if it throws during the first creation pass', () => {
let hasThrown = false;@Component({
  selector: 'test',
...
}).toThrowError('Error in a constructor');const fixture = TestBed.createComponent(App);
...
fixture.detectChanges();
expect(fixture.nativeElement.textContent).toContain('0');fixture.componentInstance.value = 1;
fixture.detectChanges();
expect(fixture.nativeElement.textContent).toContain('1');fixture.componentInstance.value = 2;
fixture.detectChanges();
...
class App {
  @ViewChild('broken') template!: TemplateRef<unknown>;  constructor(private _viewContainerRef: ViewContainerRef) {}  insertTemplate() {
...
fixture.detectChanges();// We try to render the same template twice to ensure that we get consistent error messages.
