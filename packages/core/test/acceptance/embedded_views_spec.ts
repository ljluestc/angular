...
import {TestBed} from '@angular/core/testing';describe('embedded views', () => {
...
addItem() {
  items.push(this.item);
    ...
    fixture.detectChanges();    const childCmp: ChildCmp = fixture.debugElement.children[0].componentInstance;    childCmp.addItemFn!();
    childCmp.addItemFn!();    expect(items).toEqual(['CmpItem', 'CmpItem']);
    ...
    const fixture = TestBed.createComponent(TestCmp);
    fixture.detectChanges();    expect(fixture.nativeElement.textContent).toBe('true');
...
myProp = 'Hello';
    ...
    const fixture = TestBed.createComponent(TestCmp);
    fixture.detectChanges();    expect(fixture.nativeElement.textContent).toBe('HelloHello');
  });
});
