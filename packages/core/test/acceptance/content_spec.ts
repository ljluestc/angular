...
import {expect} from '@angular/platform-browser/testing/src/matchers';describe('projection', () => {
  ...
  .replace(/\sng-reflect-\S*="[^"]*"/g, '');
    ...
    fixture.detectChanges();    expect(fixture.nativeElement.innerHTML).toBe(`<child><div>content</div></child>`);
...
template: '<child>content</child>',
    ...
    const fixture = TestBed.createComponent(Parent);
    fixture.detectChanges();    expect(fixture.nativeElement.innerHTML).toBe(`<child>content</child>`);
    ...
    const fixture = TestBed.createComponent(Parent);
    fixture.detectChanges();    expect(fixture.nativeElement.innerHTML).toBe(`<child>before<div>content</div>after</child>`);
...
showing = false;
    ...
    class Parent {
    }    TestBed.configureTestingModule({declarations: [Parent, Child], imports: [CommonModule]});    const fixture = TestBed.createComponent(Parent);
    const childDebugEl = fixture.debugElement.query(By.directive(Child));
    const childInstance = childDebugEl.injector.get(Child);
    const childElement = childDebugEl.nativeElement as HTMLElement;    childInstance.showing = true;
    fixture.detectChanges();    expect(getElementHtml(childElement)).toBe(`Before-<div>A</div>Some text-After`);    childInstance.showing = false;
    fixture.detectChanges();    expect(getElementHtml(childElement)).toBe(`Before--After`);    childInstance.showing = true;
...
`
    ...
    const childDebugEl = fixture.debugElement.query(By.directive(Child));
    const childInstance = childDebugEl.injector.get(Child);    childInstance.showing = true;
    fixture.detectChanges();    expect(getElementHtml(fixture.nativeElement))
  .toBe('<child><span>B</span> Before- <div>A</div> -After</child>');    childInstance.showing = false;
    fixture.detectChanges();
    expect(getElementHtml(fixture.nativeElement))
  .toBe('<child><span>B</span> Before-  -After</child>');    childInstance.showing = true;
    fixture.detectChanges();
    expect(getElementHtml(fixture.nativeElement))
...
{selector: 'comp', template: `<ng-template><ng-content></ng-content></ng-template>`})
 class Comp {
d(TemplateRef, {static: true}) template!: TemplateRef<any>;
 } @Directive({selector: '[trigger]'})
 class Trigger {
trigger!: Comp;or(public vcr: ViewContainerRef) {}this.vcr.createEmbeddedView(this.trigger.template); } @Component({
 'parent',
 `
...
`
 ...
 class Parent {
 } TestBed.configureTestingModule({declarations: [Parent, Trigger, Comp]}); const fixture = TestBed.createComponent(Parent);
 const trigger = fixture.debugElement.query(By.directive(Trigger)).injector.get(Trigger);
 fixture.detectChanges(); expect(getElementHtml(fixture.nativeElement)).toBe(`<button></button><comp></comp>`); trigger.open();
 expect(getElementHtml(fixture.nativeElement))
...
items = [1, 2];
  ...
  {declarations: [MyApp, RootComp, NestedComp], imports: [CommonModule]});
    ...
    fixture.detectChanges();    // expecting # of divs to be (items.length - 1), since last element is filtered out by *ngIf,
    // this applies to all other assertions below
    expect(fixture.nativeElement.querySelectorAll('div').length).toBe(1);    fixture.componentInstance.items = [3, 4, 5];
    fixture.detectChanges();
    expect(fixture.nativeElement.querySelectorAll('div').length).toBe(2);    fixture.componentInstance.items = [6, 7, 8, 9];
    fixture.detectChanges();
...
TestBed.configureTestingModule({declarations: [Child, Parent]});
const fixture = TestBed.createComponent(Parent);fixture.componentInstance.value = true;
fixture.detectChanges();expect(getElementHtml(fixture.nativeElement))
...
items: number[] = [1, 2, 3];
    ...
    const fixture = TestBed.createComponent(MyApp);
    fixture.detectChanges();    // expecting # of elements to be (items.length - 1), since last element is filtered out by
    // *ngIf, this applies to all other assertions below
    expect(fixture.nativeElement).toHaveText('1|2|');    fixture.componentInstance.items = [4, 5];
    fixture.detectChanges();
    expect(fixture.nativeElement).toHaveText('4|');    fixture.componentInstance.items = [6, 7, 8, 9];
    fixture.detectChanges();
...
`
    ...
    const fixture = TestBed.createComponent(MyApp);
    fixture.detectChanges();    expect(fixture.nativeElement).toHaveText('hello');
...
template: `
  <card>
r]="'red'" [margin]="10" ngProjectAs="[card-title]">Title</h1>
k:href="google.com" ngProjectAs="[card-subtitle]">Subtitle</h2>
e="font-color: blue;" ngProjectAs="[card-content]">content</div>
or]="'blue'" ngProjectAs="[card-footer]">footer</div>
  </card>
`
    })
    class CardWithTitle {
    ...
    fixture.detectChanges();    expect(fixture.nativeElement.textContent).toEqual('Title --- Subtitle --- content --- footer');
...
template: `
  <card>
jectAs="[card-title]">Title</h1>
nt ngProjectAs="[card-content]"></ng-content>
  </card>
`
    })
    class CardWithTitle {
...
`
    ...
    const fixture = TestBed.createComponent(App);
    fixture.detectChanges();    expect(fixture.nativeElement.textContent).toEqual('Title --- content');
...
template: `
  <card>
jectAs="[non-existing-title-slot],[card-title]">Title</h1>
  </card>
`
    })
    class App {
    ...
    const fixture = TestBed.createComponent(App);
    fixture.detectChanges();    expect(fixture.nativeElement.textContent).not.toEqual('Title content');
...
declarations: [Root, Projector],
    ...
    fixture.detectChanges();    const projectedElement = fixture.debugElement.query(By.css('div'));
...
const fixture = TestBed.createComponent<SelectorMainComp>(SelectorMainComp);fixture.detectChanges();
...
fixture.detectChanges();let content = fixture.nativeElement.textContent;
expect(content).toContain('as element');
expect(content).toContain('as attribute');
expect(content).toContain('as class');fixture.componentInstance.show = false;
fixture.detectChanges();content = fixture.nativeElement.textContent;
...
template:
 ...
 {declarations: [XDirective, SelectedNgContentComp, SelectorMainComp]});
  ...
  expect(fixture.nativeElement).toHaveText('Hello world!');
  expect(xDirectives).toEqual(1);
});it('should work without exception when subelement has both ngIf and class as interpolation',@Component(
...
const fixture = TestBed.createComponent<ParentComp>(ParentComp);fixture.detectChanges();
expect(fixture.nativeElement.innerHTML).toBe('<child-comp></child-comp>');    });    it('selection of child element should properly work even with confusing attribute names', () => {
