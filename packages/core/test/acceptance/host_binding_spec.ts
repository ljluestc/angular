...
import {NoopAnimationsModule} from '@angular/platform-browser/animations';describe('host bindings', () => {
...
@HostBinding('class') myClassesExp = {};
    ...
    fixture.detectChanges();    expect(element.style['width']).toEqual('100px');
    expect(element.classList.contains('foo')).toBeTruthy();    component.myStylesExp = {width: '200px'};
...
fixture.detectChanges();const element = fixture.nativeElement;
expect(element.classList.contains('bar')).toBeTruthy();
...
const fixture = TestBed.createComponent(MyApp);
const element = fixture.nativeElement;
fixture.detectChanges();expect(element.style['color']).toEqual('red');
expect(element.classList.contains('foo')).toBeTruthy();
...
class ParentCmp {
  private _prop = '';  @ViewChild('template', {read: ViewContainerRef}) vcr: ViewContainerRef = null!;  private child: ComponentRef<ChildCmp> = null!;  @Input()
...
fixture.detectChanges();fixture.componentInstance.prop = 'b';
...
expect(queryResult.nativeElement.style.color).toBe('red');
 ...
 () => {
e({
selector: '[animationPropDir]',mationPropDir {
@HostBinding('@myAnimation') myAnimation: string = 'color';t({
selector: 'my-comp',
...
imports: [NoopAnimationsModule],ture = TestBed.createComponent(App);
etectChanges();
ryResult = fixture.debugElement.query(By.directive(AnimationPropDir));
eryResult.nativeElement.style.color).toBe('green');
...
class AnimationPropDir {
  @HostBinding('@myAnimation') myAnimation: string = 'a';  @HostListener('@myAnimation.start')
  onAnimationStart() {
...
expect(events).toEqual(['@myAnimation.start', '@myAnimation.done']);
 ...
 async () => {
nts: string[] = [];e({
selector: 'animation-dir',mationDir {
@HostBinding('@myAnimation') myAnimation: string = 'a';@HostListener('@myAnimation.start')
onAnimationStart() {
  events.push('@myAnimation.start');
}@HostListener('@myAnimation.done')
...
],p extends AnimationDir {onfigureTestingModule({
declarations: [Comp],
imports: [NoopAnimationsModule],ture = TestBed.createComponent(Comp);
etectChanges();
ture.whenStable();  // wait for animations to complete
xture.nativeElement.style.color).toBe('yellow');
ents).toEqual(['@myAnimation.start', '@myAnimation.done']);
 });
...
const fixture = TestBed.createComponent(MyApp);
const element = fixture.nativeElement;
fixture.detectChanges();const childElement = element.querySelector('child-and-parent-cmp');
...
expect(childElement.style.opacity).toEqual('0.5');
 ...
 () => {
t({template: '<div child-dir sibling-dir></div>'})
pp {e({selector: '[parent-dir]'})
entDir {
...
get color1() {
  return 'red';
}e({selector: '[child-dir]'})
ldDir extends ParentDir {
@HostBinding('style.width')
get width2() {
  return '200px';
}@HostBinding('style.height')
...
get color1() {
  return 'blue';
}onfigureTestingModule({declarations: [MyApp, ParentDir, SiblingDir, ChildDir]});
ture = TestBed.createComponent(MyApp);
ment = fixture.nativeElement;
etectChanges();ldElement = element.querySelector('div');height values were set in all directives, but the sub-class directive
Dir) had priority over the parent directive (ParentDir) which is why its
won. It also won over Dir because the SiblingDir directive was declared
in `declarations`.
ildElement.style.width).toEqual('200px');
ildElement.style.height).toEqual('200px');Dir styled the color first before Dir
ildElement.style.color).toEqual('red');s the only directive to style opacity
ildElement.style.opacity).toEqual('0.5');
...
@ViewChild(Dir) directiveInstance!: Dir;
    ...
    const fixture = TestBed.createComponent(App);
    const element = fixture.nativeElement;
    fixture.detectChanges();    expect(element.innerHTML).toContain('class="foo"');    fixture.componentInstance.directiveInstance.klass = 'bar';
    fixture.detectChanges();    expect(element.innerHTML).toContain('class="bar"');
...
@HostBinding() title = 'my-title';
    ...
    const element = fixture.nativeElement;
    fixture.detectChanges();    expect(element.title).toBe('my-title');    fixture.componentInstance.title = 'other-title';
    fixture.detectChanges();    expect(element.title).toBe('other-title');
...
value = 'two';
    ...
    class App {
constructor(public serviceOne: ServiceOne, public serviceTwo: ServiceTwo) {}@HostBinding() title = 'my-title';
    }    TestBed.configureTestingModule({declarations: [App]});
    const fixture = TestBed.createComponent(App);
    const element = fixture.nativeElement;
    fixture.detectChanges();    expect(element.title).toBe('my-title');
    expect(fixture.componentInstance.serviceOne.value).toEqual('one');
    expect(fixture.componentInstance.serviceTwo.value).toEqual('two');    fixture.componentInstance.title = 'other-title';
    fixture.detectChanges();
...
@ViewChild(HostBindingDir) hostBindingDir!: HostBindingDir;
    ...
    const fixture = TestBed.createComponent(App);
    const element = fixture.nativeElement;
    fixture.detectChanges();    const hostBindingDiv = element.querySelector('div') as HTMLElement;
    const hostTitleComp = element.querySelector('host-title-comp') as HTMLElement;
    expect(hostBindingDiv.id).toEqual('foo');
    expect(hostTitleComp.title).toEqual('my-title');    fixture.componentInstance.hostBindingDir!.id = 'bar';
    fixture.detectChanges();
...
@ViewChildren(HostBindingComp) hostBindingComp!: QueryList<HostBindingComp>;
    ...
    const fixture = TestBed.createComponent(App);
    fixture.detectChanges();
    const comps = fixture.componentInstance.hostBindingComp.toArray();    const hostBindingEls =
  fixture.nativeElement.querySelectorAll('host-binding-comp') as NodeListOf<HTMLElement>;    expect(hostBindingEls.length).toBe(2);    comps[0].id = 'red';
    fixture.detectChanges();
    expect(hostBindingEls[0].id).toBe('red');    // second element should not be affected
    expect(hostBindingEls[1].id).toBe('blue');    comps[1].id = 'red';
    fixture.detectChanges();    // now second element should take updated value
 ...
 class App {
d(HostBindingDir) hostBindingDir!: HostBindingDir;
 } TestBed.configureTestingModule({declarations: [App, SomeDir, HostBindingDir]});
 const fixture = TestBed.createComponent(App);
 fixture.detectChanges(); const hostBindingDiv = fixture.nativeElement.querySelector('div') as HTMLElement;
 expect(hostBindingDiv.id).toEqual('foo'); fixture.componentInstance.hostBindingDir!.id = 'bar';
 fixture.detectChanges();
 expect(hostBindingDiv.id).toEqual('bar');
...
@Input() inputValue = '';changesValue = '';
initValue = '';
checkValue = '';ngOnChanges() {
...
value = 'input';
    ...
    const fixture = TestBed.createComponent(App);
    fixture.detectChanges();    const initHookComp = fixture.nativeElement.querySelector('init-hook-comp') as HTMLElement;
    expect(initHookComp.title).toEqual('input-changes-init-check');    fixture.componentInstance.value = 'input2';
    fixture.detectChanges();
...
@Input() disabled = false;@HostBinding('disabled') hostDisabled = false;
...
isDisabled = true;
    ...
    const fixture = TestBed.createComponent(App);
    fixture.detectChanges();
    const hostBindingInputDir = fixture.componentInstance.hostBindingInputDir;    const hostBindingEl = fixture.nativeElement.querySelector('input') as HTMLInputElement;
    expect(hostBindingInputDir.disabled).toBe(true);
    expect(hostBindingEl.disabled).toBe(false);    fixture.componentInstance.isDisabled = false;
    fixture.detectChanges();
    expect(hostBindingInputDir.disabled).toBe(false);
    expect(hostBindingEl.disabled).toBe(false);    hostBindingInputDir.hostDisabled = true;
    fixture.detectChanges();
    expect(hostBindingInputDir.disabled).toBe(false);
...
<parent></parent>
  `
    ...
    const fixture = TestBed.createComponent(App);
    fixture.detectChanges();    const divs = fixture.nativeElement.querySelectorAll('div');
...
rows: number[] = [];
    ...
    fixture.detectChanges();    const paragraphs = fixture.nativeElement.querySelectorAll('p');
...
name = '';
    ...
    const fixture = TestBed.createComponent(App);
    fixture.detectChanges();    const nameComp = fixture.componentInstance.nameComp;
    ...
    expect(nameComp.names).toEqual(['Nancy', 'Betty', 'Ned']);    const firstArray = nameComp.names;
    fixture.detectChanges();
    expect(firstArray).toBe(nameComp.names);    fixture.componentInstance.name = 'my-id';
    fixture.detectChanges();
    expect(hostBindingEl.id).toBe('my-id');
...
otherName = '';
    ...
    const fixture = TestBed.createComponent(App);
    fixture.detectChanges();
    const {nameComp, hostBindingComp} = fixture.componentInstance;    fixture.componentInstance.name = 'Frank';
    fixture.componentInstance.otherName = 'Joe';
    fixture.detectChanges();    const hostBindingEl = fixture.nativeElement.querySelector('host-binding-comp') as HTMLElement;
    ...
    expect(nameComp!.names).toEqual(['Frank', 'Nancy', 'Joe']);    const firstArray = nameComp!.names;
    fixture.detectChanges();
    expect(firstArray).toBe(nameComp!.names);    hostBindingComp.id = 'green';
    ...
    let events: string[] = [];    @Directive({selector: '[hostDir]', host: {'[title]': `[title, 'other title']`}})
    class HostBindingDir {
title = 'my title';
...
onClick() {
  events.push('click!');
    ...
    const fixture = TestBed.createComponent(App);
    fixture.detectChanges();    const button = fixture.nativeElement.querySelector('button')!;
    button.click();
...
@ViewChild(HostBindingDir) hostBindingDir!: HostBindingDir;
    ...
    expect(hostElement.title).toBe('my title,other title');    fixture.componentInstance.hostBindingDir.title = 'blue';
    fixture.detectChanges();
    expect(hostElement.title).toBe('blue,other title');    fixture.componentInstance.hostBindingComp.id = 'green';
    fixture.detectChanges();
...
name = '';
    ...
    const fixture = TestBed.createComponent(App);
    fixture.detectChanges();    const hostElement = fixture.nativeElement.querySelector('host-binding-comp') as HTMLElement;
    fixture.componentInstance.name = 'Ned';
    fixture.detectChanges();    expect(hostElement.id).toBe('red,blue');
    expect(hostElement.title).toBe('blue');
    expect(fixture.nativeElement.innerHTML.endsWith('Ned')).toBe(true);    fixture.componentInstance.hostBindingComp.condition = false;
    fixture.componentInstance.hostBindingComp.title = 'TITLE';
    fixture.detectChanges();
    expect(hostElement.id).toBe('green');
    expect(hostElement.title).toBe('TITLE');    fixture.componentInstance.hostBindingComp.otherCondition = false;
    fixture.detectChanges();
    expect(hostElement.id).toBe('green');
...
@ViewChild(SuperDirective) superDir!: SuperDirective;
    ...
    const fixture = TestBed.createComponent(App);
    fixture.detectChanges();
    const els = fixture.nativeElement.querySelectorAll('div') as NodeListOf<HTMLElement>;    const firstDivEl = els[0];
    const secondDivEl = els[1];    // checking first div element with inherited directive
    expect(firstDivEl.id).toEqual('my-id');
    expect(firstDivEl.title).toEqual('my-title');    fixture.componentInstance.subDir.title = 'new-title';
    fixture.detectChanges();
    expect(firstDivEl.id).toEqual('my-id');
    expect(firstDivEl.title).toEqual('new-title');    fixture.componentInstance.subDir.id = 'new-id';
    fixture.detectChanges();
    expect(firstDivEl.id).toEqual('new-id');
    expect(firstDivEl.title).toEqual('new-title');    // checking second div element with simple directive
    expect(secondDivEl.id).toEqual('my-id');    fixture.componentInstance.superDir.id = 'new-id';
    fixture.detectChanges();
...
myValue = 'initial';ngAfterContentInit() {
...
const fixture = TestBed.createComponent(App);
fixture.detectChanges();const hostBindingEl =
fixture.nativeElement.querySelector('host-binding-to-styles') as HTMLElement;
expect(hostBindingEl.style.width).toEqual('2px');fixture.componentInstance.hostBindingDir.width = 5;
fixture.detectChanges();
...
const fixture = TestBed.createComponent(App);
fixture.detectChanges();const hostBindingEl = fixture.nativeElement.querySelector('div') as HTMLElement;
expect(hostBindingEl.style.width).toEqual('2px');fixture.componentInstance.hostBindingDir.width = 5;
fixture.detectChanges();
expect(hostBindingEl.style.width).toEqual('5px');
...
const fixture = TestBed.createComponent(App);
fixture.detectChanges();const hostBindingEl = fixture.nativeElement.querySelector('static-host-class') as HTMLElement;
...
@ViewChild(UnsafeDir) unsafeDir!: UnsafeDir;
  ...
  const current = () => isAttribute ? el.getAttribute(prop) : (el as any)[prop];  fixture.componentInstance.unsafeDir.value = value;
  fixture.detectChanges();
...
expect(span.className).toBe('a');fixture.componentInstance.dir.true = 1;
fixture.componentInstance.dir.false = 2;
fixture.detectChanges();expect(span.className).toBe('a c d');
...
fixture.detectChanges();
const span = fixture.nativeElement.querySelector('span');
expect(span.className).toBe('b');fixture.componentInstance.dir['is-a'] = 1;
fixture.componentInstance.dir['"is-c"'] = 2;
fixture.detectChanges();expect(span.className).toBe('b a c');
    });
  });
});
