...
import {TestBed} from '@angular/core/testing';describe('standalone components, directives, and pipes', () => {
...
declarations: [AppComponent],
    ...
    fixture.detectChanges();    expect(fixture.nativeElement.textContent).toBe('standalone|standalone');
...
ComponentB = ComponentB;
    ...
    fixture.detectChanges();    const textContent = fixture.nativeElement.textContent;
...
@ViewChild('insert', {read: ViewContainerRef, static: true}) vcRef!: ViewContainerRef;ngOnInit(): void {
  this.vcRef.createComponent(InnerCmp);
    ...
    expect(fixture.nativeElement.textContent).toBe('Inner(Service)');
     ...
     () => {
 class Service {
or(readonly value = 'Service') {}
 } class NodeOverrideService extends Service {
or() {
super('NodeOverrideService'); } class EnvOverrideService extends Service {
or() {
super('EnvOverrideService'); } @NgModule({providers: [Service]})
 class Module {
 } @Component({
e: true,
 'Inner({{service.value}})',
...
[InnerCmp],
 ...
 class AppCmp implements OnInit {
d('insert', {read: ViewContainerRef, static: true}) vcRef!: ViewContainerRef;or(readonly inj: Injector, readonly envInj: EnvironmentInjector) {}): void {
const lhsInj = Injector.create({
  providers: [{provide: Service, useClass: NodeOverrideService}],
  parent: this.inj,
});const rhsInj = createEnvironmentInjector(
[{provide: Service, useClass: EnvOverrideService}], this.envInj);this.vcRef.createComponent(InnerCmp, {injector: lhsInj, environmentInjector: rhsInj}); } const fixture = TestBed.createComponent(AppCmp);
 fixture.detectChanges();
...
[InnerCmp],
 ...
 class AppCmp implements OnInit {
d('insert', {read: ViewContainerRef, static: true}) vcRef!: ViewContainerRef;or(readonly envInj: EnvironmentInjector) {}): void {
const rhsInj = createEnvironmentInjector(
[{provide: Service, useClass: EnvOverrideService}], this.envInj);this.vcRef.createComponent(InnerCmp, {environmentInjector: rhsInj}); } const fixture = TestBed.createComponent(AppCmp);
 fixture.detectChanges(); // The Service (an ambient provider) gets injected here as the standalone injector is a child
...
transform() {
  return 'blue';
    ...
    }    const DirAndPipe = [RedIdDirective, BluePipe] as const;    @Component({
selector: 'standalone',
standalone: true,
template: `<div red>{{'' | blue}}</div>`,
imports: [DirAndPipe],
...
class AppCmp {
}TestBed.createComponent(AppCmp);const errorRegex = unknownElErrorRegex('unknown-tag');
...
class AppCmp {
}TestBed.createComponent(AppCmp);const errorRegexA = unknownElErrorRegex('unknown-tag-A');
const errorRegexB = unknownElErrorRegex('unknown-tag-B');expect(spy).toHaveBeenCalledWith(jasmine.stringMatching(errorRegexA));
...
class AppCmp {
}TestBed.createComponent(AppCmp);expect(spy).not.toHaveBeenCalled();
...
imports: [CommonModule],Cmp {ture = TestBed.createComponent(AppCmp);
etectChanges();orRegex = unknownElErrorRegex('unknown-tag');
y).toHaveBeenCalledOnceWith(jasmine.stringMatching(errorRegex));
 });
  });  /*
    The following test verify that we don't impose limits when it comes to extending components of
    various type (standalone vs. non-standalone).    This is based on the reasoning that the "template"
...
class NonAnnotatedClass {}expect(isStandalone(NonAnnotatedClass)).toBeFalse();
