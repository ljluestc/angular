...
import {TestBed} from '@angular/core/testing';describe('standalone injector', () => {
  it('should create one standalone injector for each parent EnvInjector', () => {
    let counter = 0;    class Service {
value = counter++;
...
constructor(readonly service: Service) {}
    ...
    class AppComponent {
@ViewChild('insert', {static: true, read: ViewContainerRef}) vcRef!: ViewContainerRef;createComponent(envInjector?: EnvironmentInjector): void {
  this.vcRef.createComponent(TestComponent, {environmentInjector: envInjector});
}
    }    const fixture = TestBed.createComponent(AppComponent);
    const currEnvInjector = TestBed.inject(EnvironmentInjector);    fixture.componentInstance.createComponent(currEnvInjector);
    fixture.detectChanges();
    expect(fixture.nativeElement.textContent).toBe('(0)');    // inserting the same standalone component second time and asserting that no new injector /
    // service instance gets created
    fixture.componentInstance.createComponent(currEnvInjector);
    fixture.detectChanges();
    expect(fixture.nativeElement.textContent).toBe('(0)(0)');    // inserting with a different EnvInjector as a parent should trigger a new service instance
    // creation
...
constructor(readonly service: Service) {}
    ...
    class AppComponent {
    }    const fixture = TestBed.createComponent(AppComponent);    const environmentInjector =
  createEnvironmentInjector([Service], TestBed.inject(EnvironmentInjector));
    ...
    componentRef.changeDetectorRef.detectChanges();    expect(componentRef.location.nativeElement.textContent).toBe('Service value');
  });
});
