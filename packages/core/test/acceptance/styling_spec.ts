...
import {expectPerfCounters} from '@angular/private/testing';describe('styling', () => {
  beforeEach(ngDevModeResetPerfCounters);  describe('apply in prioritization order', () => {
    it('should perform static bindings', () => {
@Component({template: `<div class="STATIC" style="color: blue"></div>`})
class Cmp {
}TestBed.configureTestingModule({declarations: [Cmp]});
const fixture = TestBed.createComponent(Cmp);
const staticDiv = fixture.nativeElement.querySelectorAll('div')[0];expect(getSortedClassName(staticDiv)).toEqual('STATIC');
...
const fixture = TestBed.createComponent(Cmp);
fixture.detectChanges();const div = fixture.nativeElement.querySelector('div');
...
const fixture = TestBed.createComponent(Cmp);
fixture.detectChanges();const divElements = fixture.nativeElement.querySelectorAll('div');
...
const fixture = TestBed.createComponent(Cmp);
fixture.detectChanges();const classDiv = fixture.nativeElement.querySelector('div');
...
const fixture = TestBed.createComponent(Cmp);
fixture.detectChanges();const styleDiv = fixture.nativeElement.querySelector('div');
...
expect(getSortedStyle(div)).toEqual('font-family: dynamic;');
  ...
  CSS.supports('color', 'var(--fake-var)');    it('should support css variables', () => {
...
TestBed.configureTestingModule({declarations: [Cmp]});
const fixture = TestBed.createComponent(Cmp);
fixture.detectChanges();const span = fixture.nativeElement.querySelector('span') as HTMLElement;
...
TestBed.configureTestingModule({declarations: [Cmp]});
const fixture = TestBed.createComponent(Cmp);
fixture.detectChanges();const header = fixture.nativeElement.querySelector('h1') as HTMLElement;
...
set klass(value: string) {
  this.elementRef.nativeElement.setAttribute('shadow-class', value);
    ...
    const fixture = TestBed.createComponent(Cmp);
    fixture.detectChanges();    const divs = fixture.nativeElement.querySelectorAll('div');    // TODO: Use destructuring once Domino supports native ES2015, or when jsdom is used.
    const div1 = divs[0];
    const div2 = divs[1];    // Static value `class="s1"` is always written to the DOM.
    expect(div1.className).toEqual('s1');
    expect(div1.getAttribute('shadow-class')).toEqual('s1 d1');    expect(div2.className).toEqual('');
...
set klass(value: string) {
  this.elementRef.nativeElement.setAttribute('shadow-class', value);
    ...
    const divBinding = divs[1];    expectClass(divStatic).toEqual({'DIRECTIVE': true, 's1': true});
    expect(divStatic.getAttribute('shadow-class')).toEqual('s1');    expectClass(divBinding).toEqual({'DIRECTIVE': true, 's1': true});
...
set style(value: string) {
  this.elementRef.nativeElement.setAttribute('shadow-style', value);
    ...
    fixture.detectChanges();    const divs = fixture.nativeElement.querySelectorAll('div');    // TODO: Use destructuring once Domino supports native ES2015, or when jsdom is used.
    const divStatic = divs[0];
    const divBinding = divs[1];    expectStyle(divStatic).toEqual({'color': 'red', 'width': '1px'});
    expect(divStatic.getAttribute('shadow-style')).toEqual('width: 1px;');    expectStyle(divBinding).toEqual({'color': 'red', 'width': '1px'});
...
ing: any = undefined;
 ...
 class DirectiveShadowsClassInput {
or(private elementRef: ElementRef) {}
lass')
(value: string) {
this.elementRef.nativeElement.setAttribute('shadow-class', value); } TestBed.configureTestingModule({declarations: [Cmp, DirectiveShadowsClassInput]});
 const fixture = TestBed.createComponent(Cmp);
 fixture.detectChanges(); const div = fixture.nativeElement.querySelector('div');
 expect(div.className).toEqual('s1');
 expect(div.getAttribute('shadow-class')).toEqual('s1'); fixture.componentInstance.classBinding = null;
 fixture.detectChanges();
 expect(div.className).toEqual('s1');
 expect(div.getAttribute('shadow-class')).toEqual('s1'); fixture.componentInstance.classBinding = false;
 fixture.detectChanges();
 expect(div.className).toEqual('s1');
 expect(div.getAttribute('shadow-class')).toEqual('s1'); fixture.componentInstance.classBinding = {toString: () => 'd1'};
 fixture.detectChanges();
 expect(div.className).toEqual('s1');
...
set style(value: string) {
  this.elementRef.nativeElement.setAttribute('shadow-style', value);
    ...
    class DirectiveShadowsClassInput {
@Input('class') klass: string|undefined;@HostBinding('class')
get hostClasses() {
  return `${this.klass} SUFFIX`;
}
    }    TestBed.configureTestingModule({declarations: [Cmp, DirectiveShadowsClassInput]});
    const fixture = TestBed.createComponent(Cmp);
    expect(() => fixture.detectChanges()).not.toThrow();    const div = fixture.nativeElement.querySelector('div');
...
foo = `throw_foo`;maybeThrow(value: any) {
...
throw new Error('class.myDir');
  ...
  return myDirHostBinding;
    ...
    const div = fixture.nativeElement.querySelector('div');
    const span = fixture.nativeElement.querySelector('span');    expect(() => fixture.detectChanges()).toThrowError(/throw_id/);
    expect(div.id).toBeFalsy();
    expectClass(span).toEqual({});    cmp.id = 'myId';
    expect(() => fixture.detectChanges()).toThrowError(/throw_klass/);
    expect(div.id).toEqual('myId');
    expectClass(span).toEqual({});    cmp.klass = ['BAR'];
    expect(() => fixture.detectChanges()).toThrowError(/throw_foo/);
    expect(div.id).toEqual('myId');
    expectClass(span).toEqual({BAR: true});    cmp.foo = 'foo';
    expect(() => fixture.detectChanges()).toThrowError(/class.myDir/);
    expect(div.id).toEqual('myId');
    expectClass(span).toEqual({BAR: true, foo: true});    myDirHostBinding = true;
    fixture.detectChanges();
    expect(div.id).toEqual('myId');
...
native.setAttribute('data-captured-classes', native.className); } TestBed.configureTestingModule({declarations: [Cmp, DirectiveExpectingStyling]});
 const fixture = TestBed.createComponent(Cmp);
 fixture.detectChanges(); const element = fixture.nativeElement.querySelector('div');
...
`
 ...
 fixture.detectChanges(); const inner = element.querySelector('.inner-area');
...
declarations: [App, Comp],
    ...
    fixture.detectChanges();    expect(fixture.debugElement.queryAll(By.css('.a')).length).toBe(3);
  });  it('should do nothing for empty style bindings', () => {
    @Component({template: '<div [style.color]></div>'})
    class App {
    }    TestBed.configureTestingModule({declarations: [App]});
    const fixture = TestBed.createComponent(App);
    fixture.detectChanges();    expect(fixture.nativeElement.innerHTML).toBe('<div></div>');
...
opacity = 0;
    ...
    const fixture = TestBed.createComponent(App);
    fixture.detectChanges();    expect(fixture.componentInstance.div.nativeElement.style.opacity).toBe('0');
...
image!: SafeStyle;
    ...
    const fixture = TestBed.createComponent(Cmp);
    const sanitizer: DomSanitizer = TestBed.inject(DomSanitizer);    fixture.componentInstance.image = sanitizer.bypassSecurityTrustStyle('url("#test")');
    fixture.detectChanges();    const div = fixture.nativeElement.querySelector('div') as HTMLDivElement;
    expect(div.style.backgroundImage).toBe('url("#test")');    expectPerfCounters({
rendererSetStyle: 1,
tNode: 2,
    });
...
width!: string;
    ...
    fixture.detectChanges();
    const html = fixture.nativeElement.innerHTML;    // We have to check the `style` attribute, because `element.style.prop` doesn't include
    // `!important`. Use a regex, because the different renderers produce different whitespace.
    expect(html).toMatch(/style=["|']width:\s*50px\s*!important/);    expectPerfCounters({
rendererSetStyle: 1,
tNode: 2,
    });
...
marginRight!: string;
    ...
    const html = fixture.nativeElement.innerHTML;    // We have to check the `style` attribute, because `element.style.prop` doesn't include
    // `!important`. Use a regex, because the different renderers produce different whitespace.
    expect(html).toMatch(/style=["|']margin-right:\s*5px\s*!important/);    expectPerfCounters({
rendererSetStyle: 1,
tNode: 2,
    });
...
styles!: string;
    ...
    const html = fixture.nativeElement.innerHTML;    // We have to check the `style` attribute, because `element.style.prop` doesn't include
    // `!important`. Use a regex, because the different renderers produce different whitespace.
    expect(html).toMatch(/style=["|']height:\s*25px\s*!important;\s*width:\s*50px\s*!important/);    expectPerfCounters({
rendererSetStyle: 2,
tNode: 2,
    });
...
styles!: string;
    ...
    const html = fixture.nativeElement.innerHTML;    // We have to check the `style` attribute, because `element.style.prop` doesn't include
    // `!important`. Use a regex, because the different renderers produce different whitespace.
    expect(html).toMatch(/style=["|']height:\s*25px;\s*width:\s*50px\s*!important/);    expectPerfCounters({
rendererSetStyle: 2,
tNode: 2,
    });
...
path!: SafeStyle;
    ...
    const fixture = TestBed.createComponent(Cmp);
    const sanitizer: DomSanitizer = TestBed.inject(DomSanitizer);    fixture.componentInstance.path = sanitizer.bypassSecurityTrustStyle('url("#test")');
    fixture.detectChanges();    const html = fixture.nativeElement.innerHTML;    // Note that check the raw HTML, because (at the time of writing) the Node-based renderer
...
nine = '9';
    ...
    fixture.detectChanges();    const divs = fixture.nativeElement.querySelectorAll('div');    expect(divs[0].getAttribute('class')).toBe('a1b2c3d4e5f6g7h8i9j');
    ...
    expect(divs[9].getAttribute('class')).toBe('1');    instance.one = instance.two = instance.three = instance.four = instance.five = instance.six =
  instance.seven = instance.eight = instance.nine = '';
    fixture.detectChanges();    expect(divs[0].getAttribute('class')).toBe('abcdefghij');
...
nine = '9';
    ...
    const fixture = TestBed.createComponent(Cmp);
    const instance = fixture.componentInstance;
    fixture.detectChanges();    const divs = fixture.nativeElement.querySelectorAll('div');    expect(divs[0].style.getPropertyValue('content')).toBe('"a1b2c3d4e5f6g7h8i9j"');
    ...
    expect(divs[9].style.getPropertyValue('content')).toBe('"self"');    instance.one = instance.two = instance.three = instance.four = instance.five = instance.six =
  instance.seven = instance.eight = instance.nine = instance.self = '';
    fixture.detectChanges();    expect(divs[0].style.getPropertyValue('content')).toBe('"abcdefghij"');
...
two = 'two';
    ...
    const fixture = TestBed.createComponent(Cmp);
    fixture.detectChanges();
    const classList = fixture.nativeElement.querySelector('div').classList;    expect(classList).toContain('zero');
    expect(classList).toContain('i-one');
    expect(classList).toContain('two');
    expect(classList).toContain('three');    fixture.componentInstance.one = fixture.componentInstance.two = '';
    fixture.detectChanges();    expect(classList).toContain('zero');
...
nine = 9;
    ...
    const fixture = TestBed.createComponent(Cmp);
    const instance = fixture.componentInstance;
    fixture.detectChanges();    const divs: NodeListOf<HTMLElement> = fixture.nativeElement.querySelectorAll('div');    expect(divs[0].style.fontFamily).toBe('f123456789');
    ...
    expect(divs[9].style.width).toBe('1337px');    instance.singleBinding = null;
  ...
  instance.seven = instance.eight = instance.nine = 1;
    fixture.detectChanges();    expect(divs[0].style.fontFamily).toBe('f111111111');
...
three = 3;
    ...
    const fixture = TestBed.createComponent(Cmp);
    fixture.detectChanges();
    const div = fixture.nativeElement.querySelector('div');    expect(div.style.width).toBe('1337px');    fixture.componentInstance.one = 2;
    fixture.componentInstance.three = 6;
    fixture.detectChanges();    expect(div.style.width).toBe('2667px');
 ...
 let capturedMyClassBindingValue: string|null|undefined = undefined; @Component({template: '<div [class]="c" [my-class-dir]="x"></div>'})
 class Cmp {
null;
;
...
capturedClassBindingValue = v;y-class-dir')
ssVal(v: string) {
capturedMyClassBindingCount++;
capturedMyClassBindingValue = v; } TestBed.configureTestingModule({declarations: [Cmp, MyClassDir]});
 const fixture = TestBed.createComponent(Cmp);
 fixture.detectChanges(); expect(capturedClassBindingCount).toEqual(1);
 expect(capturedClassBindingValue as any).toEqual(null);
 expect(capturedMyClassBindingCount).toEqual(1);
 expect(capturedMyClassBindingValue!).toEqual('foo'); fixture.componentInstance.c = 'dynamic-value';
 fixture.detectChanges(); expect(capturedClassBindingCount).toEqual(2);
 expect(capturedClassBindingValue!).toEqual('dynamic-value');
 expect(capturedMyClassBindingCount).toEqual(1);
 expect(capturedMyClassBindingValue!).toEqual('foo'); fixture.componentInstance.c = null;
 fixture.detectChanges(); expect(capturedClassBindingCount).toEqual(3);
 expect(capturedClassBindingValue as any).toEqual(null);
 expect(capturedMyClassBindingCount).toEqual(1);
 expect(capturedMyClassBindingValue!).toEqual('foo'); fixture.componentInstance.c = '';
 fixture.detectChanges(); expect(capturedClassBindingCount).toEqual(4);
 ...
 expect(capturedMyClassBindingValue!).toEqual('foo');
     ...
     () => {
 let capturedClassBindingCount = 0;
 let capturedClassBindingValue: string|null|undefined = undefined; @Component({template: '<div [class]="c" my-class-dir></div>'})
 class Cmp {
'bar';
 } @Directive({selector: '[my-class-dir]'})
 class MyClassDir {
...
Val(v: string) {
capturedClassBindingCount++;
capturedClassBindingValue = v; } TestBed.configureTestingModule({declarations: [Cmp, MyClassDir]});
 const fixture = TestBed.createComponent(Cmp);
 expect(capturedClassBindingCount).toEqual(0);
 fixture.detectChanges(); expect(capturedClassBindingCount).toEqual(1);
 expect(capturedClassBindingValue as any).toEqual('bar'); fixture.componentInstance.c = 'dynamic-bar';
 fixture.detectChanges(); expect(capturedClassBindingCount).toEqual(2);
 expect(capturedClassBindingValue!).toEqual('dynamic-bar');
    ...
    let capturedMyClassBindingCount = 0;
    let capturedMyClassBindingValue: string|null = null;    @Component({template: '<div class="static-val" [my-class-dir]="x"></div>'})
    class Cmp {
x = 'foo';
    }    @Directive({selector: '[my-class-dir]'})
    class MyClassDir {
...
set myClassVal(v: string) {
  ...
  capturedMyClassBindingValue = v;
    ...
    const fixture = TestBed.createComponent(Cmp);
    fixture.detectChanges();    expect(capturedClassBindingValue!).toEqual('static-val');
...
template: `<comp class="static" [class]="'my-className'"></comp>`,
 ...
 let capturedClassBindingValue: string|null = null;
 let capturedMyClassBindingCount = 0;
 let capturedMyClassBindingValue: string|null = null; @Component({template: '<div class="static-val" [class]="c" [my-class-dir]="x"></div>'})
 class Cmp {
null;
'foo';
 } @Directive({selector: '[my-class-dir]'})
...
capturedMyClassBindingValue = v; } TestBed.configureTestingModule({declarations: [Cmp, MyClassDir]});
 const fixture = TestBed.createComponent(Cmp);
 fixture.detectChanges(); expect(capturedClassBindingCount)
.toEqual(
2
...
// with this.
 ...
 expect(capturedMyClassBindingCount).toEqual(1);
 expect(capturedMyClassBindingValue!).toEqual('foo'); capturedClassBindingCount = 0;
...
expect(fixture.debugElement.nativeElement.textContent).not.toContain('Hello');fixture.componentInstance.classMap = {'with-button': false};
fixture.componentInstance.showing = true;
fixture.detectChanges();const childDir = fixture.debugElement.query(By.directive(ChildDir)).injector.get(ChildDir);
...
template: '<span dir [classesInSchool]="classes" [styleOfClothing]="style"></span>',
    ...
    class App {
@ViewChild(Dir) dir!: Dir;classes = 'math';
style = '80s';
    }    TestBed.configureTestingModule({declarations: [App, Dir]});
    const fixture = TestBed.createComponent(App);
    fixture.detectChanges();
    const directive = fixture.componentInstance.dir;    expect(directive.classes).toBe('math');
...
@HostBinding('className') klass = 'one two';
    ...
    const fixture = TestBed.createComponent(App);
    fixture.detectChanges();
    const classList = fixture.nativeElement.classList;    expect(classList.contains('one')).toBe(true);
...
se;
 ...
 expect(element.classList.contains('xyz')).toBeFalsy(); fixture.componentInstance.w = undefined;
 ...
 fixture.detectChanges(); expect(element.style.width).toEqual('200px');
 expect(element.style.height).toEqual('200px');
 expect(element.style.opacity).toBeFalsy();
 expect(element.classList.contains('abc')).toBeFalsy();
 expect(element.classList.contains('xyz')).toBeTruthy(); fixture.componentInstance.w = null;
...
w2: string|null|undefined = null;
  ...
  {declarations: [Cmp, DirThatSetsWidthDirective, AnotherDirThatSetsWidthDirective]});
    ...
    fixture.detectChanges();    const element = fixture.nativeElement.querySelector('div');
    expect(element.style.width).toEqual('100px');    fixture.componentInstance.w0 = undefined;
    fixture.detectChanges();    expect(element.style.width).toEqual('300px');    fixture.componentInstance.w2 = undefined;
    fixture.detectChanges();    expect(element.style.width).toEqual('200px');    fixture.componentInstance.w1 = undefined;
    fixture.detectChanges();    expect(element.style.width).toBeFalsy();    fixture.componentInstance.w2 = '400px';
    fixture.detectChanges();    expect(element.style.width).toEqual('400px');    fixture.componentInstance.w1 = '500px';
    fixture.componentInstance.w0 = '600px';
    fixture.detectChanges();    expect(element.style.width).toEqual('600px');
...
ing('style.font-size') public fontSize = '100px';
 } @Component({selector: 'comp-with-styling'})
 class CompWithStyling {
ing('style.width') public width = '900px';ing('style.height') public height = '900px';
 } @Component({
 `
  <comp-with-styling
...
`
 ...
 class Cmp {
string|null = '0.5';
d(CompWithStyling, {static: true}) compWithStyling: CompWithStyling|null = null;
d(DirWithStyling, {static: true}) dirWithStyling: DirWithStyling|null = null;
 ...
 const element = fixture.nativeElement.querySelector('comp-with-styling'); expect(element.style.opacity).toEqual('0.5');
 expect(element.style.width).toEqual('900px');
 expect(element.style.height).toEqual('900px');
 expect(element.style.fontSize).toEqual('100px'); // once for the template flush and again for the host bindings
 expect(ngDevMode!.rendererSetStyle).toEqual(4);
 ngDevModeResetPerfCounters(); component.opacity = '0.6';
 component.compWithStyling!.height = '100px';
 component.compWithStyling!.width = '100px';
 component.dirWithStyling!.fontSize = '50px';
 fixture.detectChanges(); expect(element.style.opacity).toEqual('0.6');
 expect(element.style.width).toEqual('100px');
 expect(element.style.height).toEqual('100px');
 expect(element.style.fontSize).toEqual('50px'); // once for the template flush and again for the host bindings
 expect(ngDevMode!.rendererSetStyle).toEqual(4);
     });  it('should combine all styling across the template, directive and component host bindings',
     () => {
 @Directive({selector: '[dir-with-styling]'})
 class DirWithStyling {
ing('style.color') public color = 'red';ing('style.font-size') public fontSize = '100px';ing('class.dir') public dirClass = true;
 } @Component({selector: 'comp-with-styling'})
 class CompWithStyling {
ing('style.width') public width = '900px';ing('style.height') public height = '900px';ing('class.comp') public compClass = true;
 } @Component({
 `
  <comp-with-styling
[style.opacity]="opacity"
...
`
 ...
 class Cmp {
string|null|undefined = '0.5';
ring|null|undefined = 'auto';
= true;
 } TestBed.configureTestingModule({declarations: [Cmp, DirWithStyling, CompWithStyling]});
 const fixture = TestBed.createComponent(Cmp);
 fixture.detectChanges(); const element = fixture.nativeElement.querySelector('comp-with-styling'); expectStyle(element).toEqual({
'red',
e': '100px',
 '900px',
: '0.5',
...
ue,
 ...
 fixture.detectChanges(); expectStyle(element).toEqual(
...
rue,
 ...
 fixture.detectChanges(); expectStyle(element).toEqual({'color': 'red', 'height': '900px', 'font-size': '100px'});
...
w3: string|null|undefined = '300px';
    ...
    const fixture = TestBed.createComponent(Cmp);
    fixture.detectChanges();    const element = fixture.nativeElement.querySelector('div');    expectStyle(element).toEqual({
'width': '300px',
    });    fixture.componentInstance.w3 = null;
    fixture.detectChanges();    expectStyle(element).toEqual({});    fixture.componentInstance.w3 = undefined;
    fixture.detectChanges();    expectStyle(element).toEqual({
'width': '200px',
    });
...
updateStyles(prop: string, value: string|number|null) {
  ...
  this.c = null;
    ...
    expectClass(element).toEqual({abc: true});    comp.reset();
    comp.updateStyles('width', '500px');
    comp.updateStyles('height', null);
    comp.updateClasses('def');
    fixture.detectChanges();    expectStyle(element).toEqual({width: '500px'});
...
ing('style') public map: any = {color: 'red', width: '777px'};
 } @Component({
 `
...
`
 ...
 class Cmp {
= {width: '111px', opacity: '0.5'};
ring|null|undefined = '555px';d('dir', {read: DirThatSetsStyling, static: true}) dir!: DirThatSetsStyling;
...
e': '99px',
 ...
 class DirThatSetsStyling {
ing('style') public map: any = {width: '999px', height: '999px'};
 } @Component({
 `
 <div #dir
   [style.width]="width"
 ...
 class Cmp {
ring|null|undefined = '111px';
tring|null|undefined = '111px';= {width: '555px', height: '555px'};d('dir', {read: DirThatSetsStyling, static: true}) dir!: DirThatSetsStyling;
 } TestBed.configureTestingModule({declarations: [Cmp, DirThatSetsStyling]});
 const fixture = TestBed.createComponent(Cmp);
 const comp = fixture.componentInstance; ngDevModeResetPerfCounters();
 fixture.detectChanges();
 const element = fixture.nativeElement.querySelector('div'); assertStyleCounters(4, 0);
 assertStyle(element, 'width', '111px');
 assertStyle(element, 'height', '111px'); comp.width = '222px';
 ngDevModeResetPerfCounters();
 fixture.detectChanges(); assertStyleCounters(1, 0);
 assertStyle(element, 'width', '222px');
 assertStyle(element, 'height', '111px'); comp.height = '222px';
 ngDevModeResetPerfCounters();
 fixture.detectChanges(); assertStyleCounters(1, 0);
 assertStyle(element, 'width', '222px');
 assertStyle(element, 'height', '222px'); comp.width = undefined;
 ngDevModeResetPerfCounters();
 fixture.detectChanges(); assertStyleCounters(1, 0);
 assertStyle(element, 'width', '555px');
 assertStyle(element, 'height', '222px'); comp.width = '123px';
 comp.height = '123px';
 ngDevModeResetPerfCounters();
 fixture.detectChanges(); assertStyle(element, 'width', '123px');
 assertStyle(element, 'height', '123px'); comp.map = {};
 ngDevModeResetPerfCounters();
 fixture.detectChanges(); // No change, hence no write
 assertStyleCounters(0, 0);
 assertStyle(element, 'width', '123px');
 assertStyle(element, 'height', '123px'); comp.width = undefined;
 ngDevModeResetPerfCounters();
 fixture.detectChanges(); assertStyleCounters(1, 0);
 assertStyle(element, 'width', '999px');
 assertStyle(element, 'height', '123px'); comp.dir.map = null;
 ngDevModeResetPerfCounters();
 fixture.detectChanges(); // the width is only applied once
 assertStyleCounters(1, 0);
 assertStyle(element, 'width', '0px');
 assertStyle(element, 'height', '123px'); comp.dir.map = {width: '1000px', height: '1100px', color: 'red'};
 ngDevModeResetPerfCounters();
 fixture.detectChanges(); assertStyleCounters(2, 0);
 assertStyle(element, 'width', '1000px');
 assertStyle(element, 'height', '123px');
 assertStyle(element, 'color', 'red'); comp.height = undefined;
 ngDevModeResetPerfCounters();
 fixture.detectChanges(); // height gets applied twice and all other
 // values get applied
 assertStyleCounters(1, 0);
 assertStyle(element, 'width', '1000px');
 assertStyle(element, 'height', '1100px');
 assertStyle(element, 'color', 'red'); comp.map = {color: 'blue', width: '2000px', opacity: '0.5'};
 ngDevModeResetPerfCounters();
 fixture.detectChanges(); assertStyleCounters(3, 0);
 assertStyle(element, 'width', '2000px');
 assertStyle(element, 'height', '1100px');
 assertStyle(element, 'color', 'blue');
 assertStyle(element, 'opacity', '0.5'); comp.map = {color: 'blue', width: '2000px'};
 ngDevModeResetPerfCounters();
 fixture.detectChanges(); // all four are applied because the map was altered
...
styleMapExp: any = {};
    ...
    const fixture = TestBed.createComponent(Cmp);
    const comp = fixture.componentInstance;
    fixture.detectChanges();    const div = fixture.nativeElement.querySelector('div');    comp.bgImageExp = 'url("javascript:img")';
    fixture.detectChanges();
    expect(getSortedStyle(div)).toContain('javascript:img');    // Prove that bindings work.
    comp.widthExp = '789px';
    comp.bgImageExp = bypassSanitizationTrustStyle(comp.bgImageExp) as string;
    fixture.detectChanges();    expect(div.style.getPropertyValue('background-image')).toEqual('url("javascript:img")');
...
styleMapExp: {[key: string]: any} = {};
    ...
    const fixture = TestBed.createComponent(Cmp);
    const comp = fixture.componentInstance;
    fixture.detectChanges();    const div = fixture.nativeElement.querySelector('div');    comp.styleMapExp['background-image'] = 'url("javascript:img")';
    fixture.detectChanges();
    expect(getSortedStyle(div)).not.toContain('javascript');    // Prove that bindings work.
    comp.widthExp = '789px';
    comp.styleMapExp = {
...
heightExp: string|number|null = '';
    ...
    const fixture = TestBed.createComponent(Cmp);
    const comp = fixture.componentInstance;
    fixture.detectChanges();    const div = fixture.nativeElement.querySelector('div');    comp.widthExp = '200';
    comp.heightExp = 10;
    fixture.detectChanges();    expect(getSortedStyle(div)).toEqual('height: 10em; width: 200px;');    comp.widthExp = 0;
    comp.heightExp = null;
    fixture.detectChanges();    expect(getSortedStyle(div)).toEqual('width: 0px;');
  });  it('should be able to bind a SafeValue to clip-path', () => {
    @Component({template: '<div [style.clip-path]="path"></div>'})
    class Cmp {
path!: SafeStyle;
...
template: `
  ...
  <div [style.background]="getBackgroundSafe()"></div>  <!-- Verify regular style prop values wrapped in SafeValue -->
  <p [style.width]="getWidthSafe()" [style.height]="getHeightSafe()"></p>  <!-- Verify regular style prop values not wrapped in SafeValue -->
...
public color: string = 'red';private getSafeStyle(value: string) {
...
declarations: [MyComp],
    ...
    fixture.detectChanges();    const comp = fixture.componentInstance;
    const div = fixture.nativeElement.querySelector('div');
    const p = fixture.nativeElement.querySelector('p');
    const span = fixture.nativeElement.querySelector('span');    expect(div.style.background).toContain('url("/1.png")');
    expect(p.style.width).toBe('calc(20%)');
    expect(p.style.height).toBe('10px');
    expect(span.style.color).toBe('red');    comp.background = '2.png';
    comp.width = '5px';
    comp.height = '100%';
    comp.color = 'green';    fixture.detectChanges();    expect(div.style.background).toContain('url("/2.png")');
...
`
    ...
    class Cmp {
map: any = null;@ViewChild('div', {read: DirWithStyleMap, static: true}) dir1!: DirWithStyleMap;@ViewChild('div', {read: DirWithStyleMapPart2, static: true}) dir2!: DirWithStyleMapPart2;
...
items = [1, 2, 3];
    ...
    const fixture = TestBed.createComponent(Cmp);
    const comp = fixture.componentInstance;
    fixture.detectChanges();    function getItemElements(): HTMLElement[] {
...
'item-3',
    ...
    fixture.detectChanges();    expect(getItemElements().length).toEqual(4);
    expect(getItemClasses()).toEqual([
'initial-class',
'item-2',
'initial-class',
...
1, 2, 3];
 ...
 const comp = fixture.componentInstance;
 fixture.detectChanges(); function getItemElements(): HTMLElement[] {
.slice.call(fixture.nativeElement.querySelectorAll('div'));
 } function getItemClasses(): string[] {
tItemElements().map(e => e.className).sort().join(' ').split(' ');
 } const header = fixture.nativeElement.querySelector('header');
 expect(header.classList.contains('header')).toBeTrue(); const footer = fixture.nativeElement.querySelector('footer');
 expect(footer.classList.contains('footer')).toBeTrue(); expect(getItemElements().length).toEqual(3);
 expect(getItemClasses()).toEqual([ ]);
...
`
    ...
    const fixture = TestBed.createComponent(Cmp);
    fixture.detectChanges();    const dirOne = fixture.nativeElement.querySelector('dir-one');
    const div = fixture.nativeElement.querySelector('div');
    const dirTwo = fixture.nativeElement.querySelector('dir-two');    expect(dirOne.classList.contains('dir-one')).toBeTruthy();
 ...
 class DirOne {
ing('class') public className = 'dir-one';
 } @Directive({selector: '[two]'})
 class DirTwo {
ing('class') public className = 'dir-two';
 } @Component({
 `
 ...
 const fixture = TestBed.createComponent(Cmp);
 fixture.detectChanges(); const divA = fixture.nativeElement.querySelector('.a');
 const divB = fixture.nativeElement.querySelector('.b');
 const divC = fixture.nativeElement.querySelector('.c'); expect(divA.style.width).toEqual('100px');
...
h = 100;
    ...
    const comp = fixture.componentInstance;
    comp.items = [1, 2, 3, 4];
    fixture.detectChanges();    const items = fixture.nativeElement.querySelectorAll('.item');
    ...
    expect(items[3].style.height).toEqual('300px');    const section = fixture.nativeElement.querySelector('section');
    const p = fixture.nativeElement.querySelector('p');    expect(section.style['width']).toEqual('100px');
...
@ViewChild('target', {read: DirTwo, static: true}) two!: DirTwo;
    ...
    expect(div.style.height).toEqual('200px');    comp.two.h = '300px';
    fixture.detectChanges();
    expect(div.style.opacity).toEqual('0.5');
    expect(div.style.color).toEqual('red');
    expect(div.style.width).toEqual('100px');
...
o: any = null;
    ...
    const fixture = TestBed.createComponent(Cmp);
    const comp = fixture.componentInstance;    comp.w = '100px';
    comp.h = '200px';
    comp.o = '0.5';
    fixture.detectChanges();    const div = fixture.nativeElement.querySelector('div');
    expect(div.style.width).toEqual('100px');
    expect(div.style.height).toEqual('200px');
    expect(div.style.opacity).toEqual('0.5');    comp.w = '500px';
    comp.o = '1';
    fixture.detectChanges();    expect(div.style.width).toEqual('500px');
    expect(div.style.height).toEqual('200px');
...
`
    ...
    class Cmp {
s: any = {opacity: '1'};clearStyle(): void {
  this.s = null;
}
    }    TestBed.configureTestingModule({declarations: [Cmp]});
    const fixture = TestBed.createComponent(Cmp);
    const comp = fixture.componentInstance;
    fixture.detectChanges();    const div = fixture.nativeElement.querySelector('div');
    expect(div.style.opacity).toEqual('1');    comp.clearStyle();
    fixture.detectChanges();    expect(div.style.opacity).toEqual('');
...
<div [class.ready-child]="readyTpl"></div>
 ...
 class ChildCmp {
= false;ing('class.ready-host') readyHost = false;
 } @Component({
 'parent',
 `
  <div>
...
`,'[style.color]': 'color', })
 class ParentCmp {
prop = '';d('template', {read: ViewContainerRef}) vcr: ViewContainerRef = null!;hild: ComponentRef<ChildCmp> = null!;value: string) {
this._prop = value;
...
return this._prop;ewInit() {
this.child = this.vcr.createComponent(ChildCmp); } @Component({
 `<parent [prop]="prop"></parent>`,
 })
 class App {
';
 } TestBed.configureTestingModule({declarations: [App, ParentCmp, ChildCmp]});
 const fixture = TestBed.createComponent(App);
 fixture.detectChanges(false); let readyHost = fixture.nativeElement.querySelector('.ready-host');
 let readyChild = fixture.nativeElement.querySelector('.ready-child'); expect(readyHost).toBeFalsy();
 expect(readyChild).toBeFalsy(); fixture.componentInstance.prop = 'go';
 fixture.detectChanges(false); readyHost = fixture.nativeElement.querySelector('.ready-host');
...
<div>
 ...
 class ParentCmp {
ld = false;d('template', {read: ViewContainerRef}) vcr: ViewContainerRef = null!;hild: ComponentRef<ChildCmp> = null!;() {
if (this.updateChild) {
  this.child.instance.readyHost = true;
  this.child.instance.readyTpl = true;
  this.child.changeDetectorRef.detectChanges();
...
this.child = this.vcr.createComponent(ChildCmp); } @Component({
 ...
 class App {
d('parent', {static: true}) public parent: ParentCmp|null = null;
 } TestBed.configureTestingModule({declarations: [App, ParentCmp, ChildCmp]});
 const fixture = TestBed.createComponent(App);
 fixture.detectChanges(false); let readyHost = fixture.nativeElement.querySelector('.ready-host');
 let readyChild = fixture.nativeElement.querySelector('.ready-child');
 expect(readyHost).toBeFalsy();
 expect(readyChild).toBeFalsy(); const parent = fixture.componentInstance.parent!;
...
x';
x';
 {border: '10px solid black', width: '200px'};
 {border: '10px solid red', width: '300px'};
 } @Directive({selector: '[dir-with-styling]'})
 class DirectiveExpectingStyling {
ir-with-styling') @HostBinding('style') public styles: any = null;
 } TestBed.configureTestingModule({declarations: [Cmp, DirectiveExpectingStyling]});
 const fixture = TestBed.createComponent(Cmp);
 fixture.detectChanges(); const element = fixture.nativeElement.querySelector('div');
 expect(element.style.border).toEqual('10px solid black');
 expect(element.style.width).toEqual('100px');
 expect(element.style.height).toEqual('100px'); fixture.componentInstance.s1 = null;
 fixture.detectChanges(); expect(element.style.border).toEqual('10px solid red');
 expect(element.style.width).toEqual('100px');
 expect(element.style.height).toEqual('100px');
...
declarations: [App, Dir],
    ...
    const fixture = TestBed.createComponent(App);
    fixture.detectChanges();
    dirInstance.setStyles();    const div = fixture.debugElement.children[0];
...
declarations: [App, Dir],
    ...
    const fixture = TestBed.createComponent(App);
    fixture.detectChanges();    const div = fixture.debugElement.children[0];
    const nativeEl = dirInstance.elementRef.nativeElement;    // camel case
    ...
    expect(div.styles['backgroundColor']).toBe('');    // kebab case
...
background = 'orange';
    ...
    const fixture = TestBed.createComponent(AppComponent);
    fixture.detectChanges();    const span = fixture.nativeElement.querySelector('span');
    expect(span.classList).not.toContain('disabled');    // The issue we're testing for happens after the second change detection.
    fixture.detectChanges();
...
ing('style.border') border = '1px solid red';ing('style.background') background = 'white';
 } @Component({
 `<div class="container" [ngClass]="{disabled: isDisabled}" blockStyles></div>`,
 })
 class AppComponent {
d = false;
 ...
 const fixture = TestBed.createComponent(AppComponent);
 fixture.detectChanges(); const div = fixture.nativeElement.querySelector('div');
 expect(div.classList.contains('disabled')).toBe(false); // The issue we're testing for happens after the second change detection.
 fixture.detectChanges();
...
= true;ewInit() {
this.color = 'blue';
this.fooClass = false; } TestBed.configureTestingModule({declarations: [Cmp]});
 const fixture = TestBed.createComponent(Cmp); expect(() => {
etectChanges();
...
this.klass = 'bar'; } TestBed.configureTestingModule({declarations: [Cmp]});
 const fixture = TestBed.createComponent(Cmp); expect(() => {
etectChanges();
 }).toThrowError(/ExpressionChangedAfterItHasBeenCheckedError/);
...
one = 'one';
  ...
  TestBed.configureTestingModule({declarations: [MyComp]}).createComponent(MyComp);
    fixture.detectChanges();    expect(fixture.debugElement.nativeElement.innerHTML).toContain('zero');
...
one = 'one';
    ...
    const fixture = TestBed.createComponent(MyComp);
    fixture.detectChanges();    const first = fixture.nativeElement.querySelector('#first').outerHTML;
    expect(first).not.toContain('zero');
    expect(first).not.toContain('one');
    expect(first).toContain('two');    const second = fixture.nativeElement.querySelector('#second').outerHTML;
...
margin = '10px';
    ...
    expect(first).toContain('padding');    const second = fixture.nativeElement.querySelector('#second').outerHTML;
...
left = '';
    ...
    const fixture = TestBed.createComponent(MyComp);
    fixture.detectChanges();    const checks = [
['15', '15px'],
[undefined, ''],
[null, ''],
['', ''],
...
exp = '';
  ...
  TestBed.configureTestingModule({declarations: [MyComp]}).createComponent(MyComp);
    fixture.detectChanges();    const div = fixture.nativeElement.querySelector('div')!;
    div.className += ' abc';
    expect(splitSortJoin(div.className)).toEqual('abc');    fixture.componentInstance.exp = '1 2 3';
    fixture.detectChanges();    expect(splitSortJoin(div.className)).toEqual('1 2 3 abc');    fixture.componentInstance.exp = '4 5 6 7';
    fixture.detectChanges();    expect(splitSortJoin(div.className)).toEqual('4 5 6 7 abc');    function splitSortJoin(s: string) {
...
declarations: [MyComp],
    ...
    fixture.detectChanges();    // `styles` array values are applied first, styles from <style> tags second.
    const div = fixture.nativeElement.querySelector('div');
...
@HostBinding('class') public classes = '';
  ...
  TestBed.configureTestingModule({declarations: [MyComp]}).createComponent(MyComp);
    ...
    expect(root.className).toEqual('');    fixture.componentInstance.classes = '1 2 3';
    fixture.detectChanges();
    expect(root.className.split(/\s+/).sort().join(' ')).toEqual('1 2 3');    root.classList.add('0');
    expect(root.className.split(/\s+/).sort().join(' ')).toEqual('0 1 2 3');    fixture.componentInstance.classes = '1 2 3 4';
    fixture.detectChanges();
...
declarations: [MyComp],
    ...
    const fixture = TestBed.createComponent(MyComp);
    fixture.detectChanges();    const classList = (fixture.nativeElement.querySelector('div') as HTMLDivElement).classList;
...
declarations: [MyComp],
    ...
    fixture.detectChanges();    expect(div.style.getPropertyValue('font-size')).toEqual('200px');
  });  it('should recover from an error thrown in styling bindings', () => {
    let raiseWidthError = false;    @Component({template: `<div [style.width]="myWidth" [style.height]="'200px'"></div>`})
    class MyComp {
get myWidth() {
  if (raiseWidthError) {
throw new Error('...');
  ...
  return '100px';
    ...
    const fixture = TestBed.createComponent(MyComp);    raiseWidthError = true;
    expect(() => fixture.detectChanges()).toThrow();    raiseWidthError = false;
    fixture.detectChanges();
...
ing('style') myStyles: any = {width: '300px'};ing('style.height') myHeight: any = '305px';
 } @Directive({selector: '[my-dir-with-styling]'})
 class MyDirWithStyling {
ing('style') myStyles: any = {width: '200px'};ing('style.height') myHeight: any = '205px';
 } @Component({
 `
...
`
 ...
 string|null|undefined = '100px';d(MyDirWithStyling) dir!: MyDirWithStyling;
d(MyCompWithStyling) comp!: MyCompWithStyling;
 } TestBed.configureTestingModule(
{declarations: [MyComp, MyCompWithStyling, MyDirWithStyling]});
 const fixture = TestBed.createComponent(MyComp);
 const comp = fixture.componentInstance;
 const elm = fixture.nativeElement.querySelector('my-comp-with-styling')!; fixture.detectChanges();
 expect(elm.style.width).toEqual('100px');
 expect(elm.style.height).toEqual('100px'); comp.myStyles = {};
 comp.myHeight = undefined;
 fixture.detectChanges();
 expect(elm.style.width).toEqual('2px');
 expect(elm.style.height).toEqual('1px'); comp.comp.myStyles = {};
 comp.comp.myHeight = undefined;
 fixture.detectChanges();
 expect(elm.style.width).toEqual('2px');
 expect(elm.style.height).toEqual('1px'); comp.dir.myStyles = {};
...
public dirOneA: DirThatSetsOneTwo|null = null;@ViewChild('div1', {static: true, read: DirThatSetsThreeFour})
public dirTwoA: DirThatSetsThreeFour|null = null;@ViewChild('div2', {static: true, read: DirThatSetsOneTwo})
public dirOneB: DirThatSetsOneTwo|null = null;@ViewChild('div2', {static: true, read: DirThatSetsThreeFour})
public dirTwoB: DirThatSetsThreeFour|null = null;zero = false;
    }    TestBed.configureTestingModule(
  {declarations: [MyComp, DirThatSetsThreeFour, DirThatSetsOneTwo]});    const fixture = TestBed.createComponent(MyComp);
    fixture.detectChanges();    const divs = fixture.nativeElement.querySelectorAll('div') as HTMLDivElement[];    // TODO: Use destructuring once Domino supports native ES2015, or when jsdom is used.
    const div1 = divs[0];
    const div2 = divs[1];    expect(div1.className).toBe('');
    expect(div2.className).toBe('');    const comp = fixture.componentInstance;
    comp.dirOneA!.one = comp.dirOneB!.one = true;
    comp.dirOneA!.two = comp.dirOneB!.two = true;
    fixture.detectChanges();    expect(div1.classList.contains('one')).toBeTruthy();
    ...
    expect(div2.classList.contains('zero')).toBeFalsy();    comp.dirTwoA!.three = comp.dirTwoB!.three = true;
    ...
    expect(div2.classList.contains('zero')).toBeFalsy();    comp.zero = true;
    fixture.detectChanges();    expect(div1.classList.contains('one')).toBeTruthy();
    expect(div1.classList.contains('two')).toBeTruthy();
    expect(div1.classList.contains('three')).toBeTruthy();
    expect(div1.classList.contains('four')).toBeTruthy();
...
eTestingModule({
declarations: [MyComp, CompWithClasses],mponent(MyComp);
    fixture.detectChanges();    const [one, two, three] =
  fixture.nativeElement.querySelectorAll('comp-with-classes') as HTMLDivElement[];    expect(one.classList.contains('custom')).toBeTruthy();
    expect(one.classList.contains('inline')).toBeTruthy();
    expect(one.classList.contains('host')).toBeTruthy();    expect(two.classList.contains('custom')).toBeTruthy();
    expect(two.classList.contains('inline')).toBeTruthy();
    expect(two.classList.contains('host')).toBeTruthy();    expect(three.classList.contains('custom')).toBeTruthy();
...
template: '...',
    ...
    const fixture = TestBed.createComponent(Cmp);
    fixture.detectChanges();    const element = fixture.nativeElement.querySelector('child-comp');
    expect(element.classList.contains('template')).toBeTruthy();    expect(element.classList.contains('child-comp')).toBeTruthy();
    expect(element.classList.contains('child-comp-active')).toBeTruthy();    expect(element.classList.contains('parent-comp')).toBeFalsy();
    ...
    const logs: string[] = [];    @Directive({selector: '[test]'})
    class MyDir {
@Input('class')
...
template: `<div test></div>`
    ...
    const fixture = TestBed.createComponent(MyComp);
    fixture.detectChanges();    expect(logs).toEqual([]);
