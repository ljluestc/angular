...
import {expect} from '@angular/platform-browser/testing/src/matchers';describe('providers', () => {
  describe('inheritance', () => {
    it('should NOT inherit providers', () => {
const SOME_DIRS = new InjectionToken('someDirs');@Directive({
  selector: '[super-dir]',
...
{declarations: [SuperDirective, SubDirective, OtherDirective, App]});const fixture = TestBed.createComponent(App);
fixture.detectChanges();const otherDir = fixture.debugElement.query(By.css('div')).injector.get(OtherDirective);
...
fixture.destroy();expect(logs).toEqual(['OnDestroy']);
...
const fixture = TestBed.createComponent(App);
fixture.detectChanges();
fixture.destroy();expect(logs).toEqual([]);
...
const fixture = TestBed.createComponent(App);
fixture.detectChanges();
fixture.destroy();expect(logs).toEqual(['OnDestroy Value']);
...
const fixture = TestBed.createComponent(App);
fixture.detectChanges();
fixture.destroy();expect(logs).toEqual(['OnDestroy Existing']);
    });    it('should invoke ngOnDestroy with the correct context when providing a type provider multiple times on the same node',
 () => {
olvedServices: (DestroyService|undefined)[] = [];
troyContexts: (DestroyService|undefined)[] = [];
tService: DestroyService|undefined;
Service: DestroyService|undefined;le()
troyService {
constructor() {
...
}e({selector: '[dir-one]', providers: [DestroyService]})
One {
constructor(service: DestroyService) {
  childService = service;
}e({selector: '[dir-two]', providers: [DestroyService]})
Two {
constructor(service: DestroyService) {
  childService = service;
}t({template: '<div dir-one dir-two></div>', providers: [DestroyService]})
 {
constructor(service: DestroyService) {
  parentService = service;
}onfigureTestingModule({declarations: [App, DirOne, DirTwo]});
ture = TestBed.createComponent(App);
etectChanges();
estroy();rentService).toBeDefined();
ildService).toBeDefined();
rentService).not.toBe(childService);
solvedServices).toEqual([parentService, childService]);
stroyContexts).toEqual([parentService, childService]);
 });    it('should invoke ngOnDestroy with the correct context when providing a class provider multiple times on the same node',
 () => {
olvedServices: (DestroyService|undefined)[] = [];
troyContexts: (DestroyService|undefined)[] = [];
en = new InjectionToken<any>('token');
tService: DestroyService|undefined;
Service: DestroyService|undefined;le()
troyService {
constructor() {
...
it('should invoke ngOnDestroy on multi providers with the correct context', () => {
  ...
  const SERVICES = new InjectionToken<any>('SERVICES');  @Injectable()
...
constructor(@Inject(SERVICES) s: any) {}
  ...
  const fixture = TestBed.createComponent(App);
  fixture.detectChanges();
  fixture.destroy();  expect(destroyCalls).toEqual([
jasmine.any(DestroyService), jasmine.any(OtherDestroyService)
  ]);
});it('should invoke destroy hooks on multi providers with the correct context, if only some have a destroy hook',const destroyCalls: any[] = [];
const SERVICES = new InjectionToken<any>('SERVICES');@Injectable()
class Service1 {
}@Injectable()
class Service2 {
...
const fixture = TestBed.createComponent(App);
fixture.detectChanges();
fixture.destroy();expect(destroyCalls).toEqual([jasmine.any(Service2), jasmine.any(Service4)]);it('should not invoke ngOnDestroy on multi providers created via useFactory', () => {
  let destroyCalls = 0;
  const SERVICES = new InjectionToken<any>('SERVICES');  @Injectable()
  class DestroyService {
ngOnDestroy() {
...
constructor(@Inject(SERVICES) s: any) {}
  ...
  const fixture = TestBed.createComponent(App);
  fixture.detectChanges();
  fixture.destroy();  expect(destroyCalls).toBe(0);
});
...
fixture.detectChanges();fixture.componentInstance.condition = false;
fixture.detectChanges();expect(logs).toEqual(['OnDestroy Token']);
    });
...
ync(inject([MyComp, MyService], (comp: MyComp, service: MyService) => {
...
class MyModule {
}TestBed.configureTestingModule({imports: [MyModule]});const fixture = TestBed.createComponent(AppComp);
...
TestBed.configureTestingModule({declarations: [App]});
const fixture = TestBed.createComponent(App);
fixture.detectChanges();expect(fixture.componentInstance.foo).toBeInstanceOf(SomeProviderImpl);
...
constructor(public value: OtherService|null) {}
    }    class OtherService {}    it('should support Optional flag in deps', () => {
const injector = Injector.create(
{providers: [{provide: MyService, deps: [[new Optional(), OtherService]]}]});expect(injector.get(MyService).value).toBe(null);
    });    it('should support Optional flag in deps without instantiating it', () => {
const injector =
Injector.create({providers: [{provide: MyService, deps: [[Optional, OtherService]]}]});expect(injector.get(MyService).value).toBe(null);
    });
...
fixture.detectChanges();expect(fixture.nativeElement.textContent).toBe('bar-1,2');
