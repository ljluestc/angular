...
import {TestBed} from '@angular/core/testing';describe('ViewRef', () => {
...
constructor(public appRef: ApplicationRef, private injector: EnvironmentInjector) {}create() {
  ...
  (this.componentRef.hostView as InternalViewRef).detachFromAppRef();
    ...
    fixture.detectChanges();    const appComponent = fixture.componentInstance;
    appComponent.create();
    fixture.detectChanges();
    expect(document.body.querySelector('dynamic-cpt')).not.toBeFalsy();    appComponent.destroy();
    fixture.detectChanges();
    expect(document.body.querySelector('dynamic-cpt')).toBeFalsy();
  });  it('should invoke the onDestroy callback of a view ref', () => {
    let called = false;    @Component({template: ''})
    class App {
constructor(changeDetectorRef: ChangeDetectorRef) {
  (changeDetectorRef as InternalViewRef).onDestroy(() => called = true);
    ...
    const fixture = TestBed.createComponent(App);
    fixture.detectChanges();
    fixture.destroy();    expect(called).toBe(true);
...
constructor(private _viewContainerRef: ViewContainerRef) {}create() {
  ...
  this.componentRef.instance.viewContainerRef.insert(this.viewRef);
    ...
    const viewContainerRef = fixture.componentInstance.componentRef.instance.viewContainerRef;    expect(viewContainerRef.length).toBe(1);
...
constructor(private _viewContainerRef: ViewContainerRef) {}create() {
  ...
  this.componentRef.instance.viewContainerRef.insert(this.viewRef);
    ...
    fixture.detectChanges();
    fixture.componentInstance.create();
    const {componentRef, viewRef} = fixture.componentInstance;    expect(viewRef.destroyed).toBe(false);
