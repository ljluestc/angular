...
import {expectPerfCounters} from '@angular/private/testing';describe('acceptance integration tests', () => {
...
const fixture = TestBed.createComponent(App);expect(fixture.nativeElement.innerHTML).toEqual('<span title="Hello">Greetings</span>');
...
const fixture = TestBed.createComponent(App);fixture.componentInstance.name = 'World';
fixture.detectChanges();expect(fixture.nativeElement.innerHTML).toEqual('<h1>Hello, World!</h1>');
expectPerfCounters({
  tView: 2,  // Host view + App
  tNode: 3,  // Host Node + <h1> + #text
});fixture.componentInstance.name = 'New World';
fixture.detectChanges();expect(fixture.nativeElement.innerHTML).toEqual('<h1>Hello, New World!</h1>');
...
const fixture = TestBed.createComponent(App);// Strip comments since VE and Ivy put them in different places.
...
const fixture = TestBed.createComponent(App);expect(stripHtmlComments(fixture.nativeElement.innerHTML)).toEqual('');fixture.componentInstance.render = true;
fixture.detectChanges();
expect(stripHtmlComments(fixture.nativeElement.innerHTML)).toEqual('<div>content</div>');fixture.componentInstance.render = false;
fixture.detectChanges();
...
const fixture = TestBed.createComponent(App);expect(stripHtmlComments(fixture.nativeElement.innerHTML)).toEqual('');fixture.componentInstance.render = true;
fixture.detectChanges();
expect(stripHtmlComments(fixture.nativeElement.innerHTML)).toEqual('content');fixture.componentInstance.render = false;
fixture.detectChanges();
expect(stripHtmlComments(fixture.nativeElement.innerHTML)).toEqual('');
 ...
 () => {
e({selector: '[testDirective]'})
tDirective {
constructor(private _tplRef: TemplateRef<any>, private _vcRef: ViewContainerRef) {}createAndInsert() {
...
@ViewChild(TestDirective, {static: true}) testDirective!: TestDirective;onfigureTestingModule({declarations: [App, TestDirective]});
ture = TestBed.createComponent(App);
etectChanges();ripHtmlComments(fixture.nativeElement.innerHTML)).toBe('');omponentInstance.testDirective.createAndInsert();
etectChanges();
ripHtmlComments(fixture.nativeElement.innerHTML)).toBe('content');omponentInstance.testDirective.clear();
etectChanges();
ripHtmlComments(fixture.nativeElement.innerHTML)).toBe('');
...
const fixture = TestBed.createComponent(App);expect(stripHtmlComments(fixture.nativeElement.innerHTML))
...
fixture.detectChanges();expect(stripHtmlComments(fixture.nativeElement.innerHTML)).toBe('');fixture.componentInstance.testDirective.createAndInsert();
fixture.detectChanges();
expect(stripHtmlComments(fixture.nativeElement.innerHTML)).toBe('content');fixture.componentInstance.testDirective.createAndInsert();
fixture.detectChanges();
expect(stripHtmlComments(fixture.nativeElement.innerHTML)).toBe('contentcontent');fixture.componentInstance.testDirective.clear();
fixture.detectChanges();
...
const fixture = TestBed.createComponent(App);
fixture.detectChanges();expect(stripHtmlComments(fixture.nativeElement.innerHTML)).toEqual('<div></div>');
...
@Directive({selector: '[dir]'})
class TestDirective {
  @Input() contentTpl: TemplateRef<{}>|null = null;  constructor(private _vcRef: ViewContainerRef) {}  insertView() {
...
const fixture = TestBed.createComponent(App);
fixture.detectChanges();expect(stripHtmlComments(fixture.nativeElement.innerHTML)).toEqual('');fixture.componentInstance.testDirective.insertView();
fixture.detectChanges();
expect(stripHtmlComments(fixture.nativeElement.innerHTML)).toEqual('Content');fixture.componentInstance.testDirective.clear();
fixture.detectChanges();
expect(stripHtmlComments(fixture.nativeElement.innerHTML)).toEqual('');
    });    it('should support ViewContainerRef on <ng-template> inside <ng-container>', () => {
@Directive({selector: '[dir]'})
class TestDirective {
  constructor(private _tplRef: TemplateRef<{}>, private _vcRef: ViewContainerRef) {}  insertView() {
...
const fixture = TestBed.createComponent(App);
fixture.detectChanges();expect(fixture.nativeElement.innerHTML).toEqual('benoit');fixture.componentInstance.name = undefined;
...
const fixture = TestBed.createComponent(App);
fixture.detectChanges();expect(fixture.nativeElement.innerHTML).toEqual('benoit');fixture.componentInstance.name = null;
fixture.detectChanges();expect(fixture.nativeElement.innerHTML).toEqual('');
...
const fixture = TestBed.createComponent(App);
fixture.detectChanges();expect(stripNgNonBindable(fixture.nativeElement.innerHTML))
.toEqual('<b id="my-id"><i>Hello {{ name }}!</i></b> my-id ');
    });    it('should invoke directives for host element', () => {
let directiveInvoked: boolean = false;@Directive({selector: '[directive]'})
...
const fixture = TestBed.createComponent(App);fixture.componentInstance.name = 'world';
fixture.detectChanges();expect(fixture.nativeElement.innerHTML).toEqual('Hello world!');fixture.componentInstance.name = 'monde';
fixture.detectChanges();expect(fixture.nativeElement.innerHTML).toEqual('Hello monde!');
...
const fixture = TestBed.createComponent(App);fixture.componentInstance.name = 'world';
      fixture.detectChanges();      expect(fixture.nativeElement.innerHTML).toEqual('<b>Hello world!</b>');      fixture.componentInstance.name = 'mundo';
      fixture.detectChanges();      expect(fixture.nativeElement.innerHTML).toEqual('<b>Hello mundo!</b>');
      ...
      const fixture = TestBed.createComponent(App);      fixture.componentInstance.name = 'world';
      fixture.detectChanges();      expect(fixture.nativeElement.innerHTML).toEqual('<b><b><b><b>Hello world!</b></b></b></b>');      fixture.componentInstance.name = 'mundo';
      fixture.detectChanges();      expect(fixture.nativeElement.innerHTML).toEqual('<b><b><b><b>Hello mundo!</b></b></b></b>');
    });    it('should update 2 sibling elements', () => {
      @Component({template: '<b><span></span><span class="foo" [id]="id"></span></b>'})
      class App {
        id = '';
      }      TestBed.configureTestingModule({declarations: [App]});
      const fixture = TestBed.createComponent(App);      fixture.componentInstance.id = 'foo';
      fixture.detectChanges();
      expect(fixture.nativeElement.innerHTML)
.toEqual('<b><span></span><span class="foo" id="foo"></span></b>');      fixture.componentInstance.id = 'bar';
      fixture.detectChanges();
      expect(fixture.nativeElement.innerHTML)
.toEqual('<b><span></span><span class="foo" id="bar"></span></b>');
      ...
      const fixture = TestBed.createComponent(App);      fixture.componentInstance.name = 'world';
      fixture.detectChanges();      expect(fixture.nativeElement.innerHTML).toEqual('<p>hello</p>world');      fixture.componentInstance.name = 'mundo';
      fixture.detectChanges();      expect(fixture.nativeElement.innerHTML).toEqual('<p>hello</p>mundo');
    });
    ...
    class TodoComponent {
      ...
      const fixture = TestBed.createComponent(App);
      fixture.detectChanges();      expect(fixture.nativeElement.innerHTML).toEqual('<todo><p>Todo one</p></todo>');
    });    it('should support a component template with sibling', () => {
      @Component({template: '<todo></todo>two'})
      class App {
      }      TestBed.configureTestingModule({declarations: [App, TodoComponent]});
      const fixture = TestBed.createComponent(App);
      fixture.detectChanges();      expect(fixture.nativeElement.innerHTML).toEqual('<todo><p>Todo one</p></todo>two');
...
.toEqual('<todo><p>Todo one</p></todo><todo><p>Todo one</p></todo>');
      ...
      const fixture = TestBed.createComponent(App);
      fixture.detectChanges();      expect(fixture.nativeElement.innerHTML).toEqual('<todo title="one">one</todo>');      fixture.componentInstance.todoComponentHostBinding.title = 'two';
      fixture.detectChanges();      expect(fixture.nativeElement.innerHTML).toEqual('<todo title="two">two</todo>');
      ...
      fixture.detectChanges();      expect(fixture.nativeElement.getAttribute('role')).toEqual('button');
      ...
      const fixture = TestBed.createComponent(App);
      fixture.detectChanges();      expect(fixture.nativeElement.innerHTML).toEqual('<comp><p>Bess</p></comp>');
      ...
      const fixture = TestBed.createComponent(App);
      fixture.detectChanges();
      const compElement = fixture.nativeElement.querySelector('comp');      fixture.componentInstance.condition = true;
      fixture.detectChanges();
      expect(stripHtmlComments(compElement.innerHTML)).toEqual('<div>text</div>');      fixture.componentInstance.condition = false;
      fixture.detectChanges();
...
title: string|null = '';
        ...
        fixture.detectChanges();
        // initial binding
        expect(fixture.nativeElement.innerHTML).toEqual('<button title="Hello"></button>');        // update binding
...
title: any;
        ...
        fixture.detectChanges();
        expect(fixture.nativeElement.innerHTML).toEqual('<button title="NaN"></button>');        fixture.componentInstance.title = {toString: () => 'Custom toString'};
        fixture.detectChanges();
        expect(fixture.nativeElement.innerHTML)
...
c = ['(', 0, 'a', 1, 'b', 2, 'c', 3, 'd', 4, 'e', 5, 'f', 6, 'g', 7, ')'];
        ...
        const fixture = TestBed.createComponent(App);
        fixture.detectChanges();        expect(fixture.nativeElement.textContent.trim()).toEqual([
'a:(0a1b2c3d4e5f6g7)',
'a0:0',
'a1:(0)',
'a2:(0a1)',
...
shouldRender = true;
        ...
        const fixture = TestBed.createComponent(App);
        fixture.detectChanges();        const span: HTMLSpanElement = fixture.nativeElement.querySelector('span');
        const bold: HTMLElement = span.querySelector('b')!;        fixture.componentInstance.title = 'Hello';
        fixture.detectChanges();        // initial binding
        expect(span.getAttribute('title')).toBe('Hello');
        expect(bold.getAttribute('title')).toBe('Hello');        // update DOM manually
        bold.setAttribute('title', 'Goodbye');        // refresh with same binding
        fixture.detectChanges();
        expect(span.getAttribute('title')).toBe('Hello');
        expect(bold.getAttribute('title')).toBe('Goodbye');        // refresh again with same binding
        fixture.detectChanges();
        expect(span.getAttribute('title')).toBe('Hello');
...
@ViewChild(HostBindingDir) hostBindingDir!: HostBindingDir;
        ...
        const fixture = TestBed.createComponent(App);
        fixture.detectChanges();
        const hostBindingEl = fixture.nativeElement.querySelector('div');        // Needs `toLowerCase`, because different browsers produce
        // attributes either in camel case or lower case.
        expect(hostBindingEl.getAttribute('aria-label')).toBe('some label');        fixture.componentInstance.hostBindingDir.label = 'other label';
        fixture.detectChanges();        expect(hostBindingEl.getAttribute('aria-label')).toBe('other label');
      });
...
size: string|null = '';
        ...
        fixture.detectChanges();
        const span: HTMLElement = fixture.nativeElement.querySelector('span');        expect(span.style.fontSize).toBe('10px');        fixture.componentInstance.size = '16px';
        fixture.detectChanges();
...
size: string|number|null = '';
        ...
        fixture.detectChanges();
        const span: HTMLElement = fixture.nativeElement.querySelector('span');        expect(span.style.fontSize).toEqual('100px');        fixture.componentInstance.size = 200;
        fixture.detectChanges();
        expect(span.style.fontSize).toEqual('200px');        fixture.componentInstance.size = 0;
        fixture.detectChanges();
...
value: any;
        ...
        fixture.detectChanges();
        const span = fixture.nativeElement.querySelector('span');        expect(span.getAttribute('class')).toEqual('active');        fixture.componentInstance.value = false;
        fixture.detectChanges();
        expect(span.getAttribute('class')).toBeFalsy();        // truthy values
        fixture.componentInstance.value = 'a_string';
        fixture.detectChanges();
        expect(span.getAttribute('class')).toEqual('active');        fixture.componentInstance.value = 10;
        fixture.detectChanges();
        expect(span.getAttribute('class')).toEqual('active');        // falsy values
        fixture.componentInstance.value = '';
        fixture.detectChanges();
        expect(span.getAttribute('class')).toBeFalsy();        fixture.componentInstance.value = 0;
        fixture.detectChanges();
...
value: any;
        ...
        fixture.componentInstance.value = true;
        fixture.detectChanges();
        expect(fixture.nativeElement.innerHTML).toEqual('<span class="existing active"></span>');        fixture.componentInstance.value = false;
        fixture.detectChanges();
...
value: any;
        ...
        fixture.componentInstance.value = true;
        fixture.detectChanges();
        const compElement = fixture.nativeElement.querySelector('my-comp');        expect(fixture.nativeElement.textContent).toContain('Comp Content');
        expect(compElement.getAttribute('class')).toBe('active');        fixture.componentInstance.value = false;
        fixture.detectChanges();
...
value: any;
        ...
        fixture.componentInstance.value = true;
        fixture.detectChanges();
        const structuralCompEl = fixture.nativeElement.querySelector('structural-comp');        expect(structuralCompEl.getAttribute('class')).toEqual('active');        fixture.componentInstance.structuralComp.create();
        fixture.detectChanges();
        expect(structuralCompEl.getAttribute('class')).toEqual('active');        fixture.componentInstance.value = false;
        fixture.detectChanges();
        expect(structuralCompEl.getAttribute('class')).toBeFalsy();
      });      @Directive({selector: '[DirWithClass]'})
      class DirWithClassDirective {
        public classesVal: string = '';        @Input('class')
        set klass(value: string) {
this.classesVal = value;
        }
      }      @Directive({selector: '[DirWithStyle]'})
      class DirWithStyleDirective {
        public stylesVal: any = '';        @Input()
        set style(value: any) {
this.stylesVal = value;
        }
      }      it('should delegate initial classes to a [class] input binding if present on a directive on the same element',@Component({template: '<div class="apple orange banana" DirWithClass></div>'})
class App {
...
const fixture = TestBed.createComponent(App);
fixture.detectChanges();// the initial values always get sorted in non VE code
...
.toEqual(['apple', 'banana', 'orange']);      it('should delegate initial styles to a [style] input binding if present on a directive on the same element',@Component({template: '<div style="width: 100px; height: 200px" DirWithStyle></div>'})
class App {
...
const fixture = TestBed.createComponent(App);
fixture.detectChanges();const styles = fixture.componentInstance.mockStyleDirective.stylesVal;expect(styles).toEqual('width: 100px; height: 200px;');      it('should update `[class]` and bindings in the provided directive if the input is matched',@Component({template: '<div DirWithClass [class]="value"></div>'})
class App {
  @ViewChild(DirWithClassDirective) mockClassDirective!: DirWithClassDirective;
  value = '';
}TestBed.configureTestingModule({declarations: [App, DirWithClassDirective]});
...
fixture.detectChanges();expect(fixture.componentInstance.mockClassDirective.classesVal)
.toEqual('cucumber grape');      it('should update `[style]` and bindings in the provided directive if the input is matched',@Component({template: '<div DirWithStyle [style]="value"></div>'})
class App {
  @ViewChild(DirWithStyleDirective) mockStyleDirective!: DirWithStyleDirective;
...
fixture.detectChanges();expect(fixture.componentInstance.mockStyleDirective.stylesVal)
.toEqual({width: '200px', height: '500px'});      it('should apply initial styling to the element that contains the directive with host styling',@Directive({
...
const fixture = TestBed.createComponent(App);
fixture.detectChanges();const target: HTMLDivElement = fixture.nativeElement.querySelector('div');
const classes = target.getAttribute('class')!.split(/\s+/).sort();
expect(classes).toEqual(['big', 'golden', 'heavy']);expect(target.getAttribute('title')).toEqual('foo');
expect(target.style.getPropertyValue('color')).toEqual('black');
expect(target.style.getPropertyValue('font-size')).toEqual('200px');
expect(target.style.getPropertyValue('font-weight')).toEqual('bold');      it('should apply single styling bindings present within a directive onto the same element and defer the element\'s initial styling values when missing',@Directive({
...
expect(target.classList.contains('xyz')).toBeFalsy();dirInstance.width = '444px';
dirInstance.height = '999px';
dirInstance.activateXYZClass = true;
fixture.detectChanges();expect(target.style.getPropertyValue('width')).toEqual('100px');
expect(target.style.getPropertyValue('height')).toEqual('999px');
expect(target.classList.contains('abc')).toBeTruthy();
expect(target.classList.contains('def')).toBeTruthy();
expect(target.classList.contains('xyz')).toBeTruthy();dirInstance.width = undefined;
dirInstance.height = undefined;
fixture.detectChanges();expect(target.style.getPropertyValue('width')).toEqual('100px');
expect(target.style.getPropertyValue('height')).toEqual('');
expect(target.classList.contains('abc')).toBeTruthy();
expect(target.classList.contains('def')).toBeTruthy();
expect(target.classList.contains('xyz')).toBeTruthy();      it('should properly prioritize single style binding collisions when they exist on multiple directives',@Directive({selector: '[Dir1WithStyle]', host: {'[style.width]': 'width'}})
class Dir1WithStyle {
...
const fixture = TestBed.createComponent(App);
fixture.detectChanges();
const {dir1Instance, dir2Instance} = fixture.componentInstance;const target: HTMLDivElement = fixture.nativeElement.querySelector('div');
expect(target.style.getPropertyValue('width')).toEqual('111px');fixture.componentInstance.width = '999px';
dir1Instance.width = '222px';
dir2Instance.width = '333px';
fixture.detectChanges();
expect(target.style.getPropertyValue('width')).toEqual('999px');fixture.componentInstance.width = undefined;
fixture.detectChanges();
expect(target.style.getPropertyValue('width')).toEqual('222px');dir1Instance.width = undefined;
fixture.detectChanges();
expect(target.style.getPropertyValue('width')).toEqual('333px');dir2Instance.width = undefined;
fixture.detectChanges();
expect(target.style.getPropertyValue('width')).toEqual('111px');dir1Instance.width = '666px';
fixture.detectChanges();
expect(target.style.getPropertyValue('width')).toEqual('666px');fixture.componentInstance.width = '777px';
fixture.detectChanges();
expect(target.style.getPropertyValue('width')).toEqual('777px');      it('should properly prioritize multi style binding collisions when they exist on multiple directives',@Directive({
...
const fixture = TestBed.createComponent(App);
fixture.detectChanges();
const {dir1Instance, dir2Instance} = fixture.componentInstance;const target = fixture.nativeElement.querySelector('div')!;
expect(target.style.getPropertyValue('width')).toEqual('111px');const compInstance = fixture.componentInstance;
...
expect(target.classList.contains('three')).toBeFalsy();compInstance.stylesExp = {};
...
expect(target.classList.contains('three')).toBeFalsy();dir1Instance.stylesExp = {};
...
expect(target.classList.contains('one')).toBeFalsy();
expect(target.classList.contains('two')).toBeFalsy();
expect(target.classList.contains('three')).toBeFalsy();dir2Instance.stylesExp = {};
compInstance.stylesExp = {height: '900px'};
fixture.detectChanges();
expect(target.style.getPropertyValue('width')).toEqual('111px');
expect(target.style.getPropertyValue('height')).toEqual('900px');dir1Instance.stylesExp = {width: '666px', height: '600px'};
...
expect(target.classList.contains('four')).toBeTruthy();compInstance.stylesExp = {width: '777px'};
...
expect(target.classList.contains('two')).toBeFalsy();
expect(target.classList.contains('three')).toBeFalsy();
expect(target.classList.contains('four')).toBeFalsy();    });    it('should properly handle and render interpolation for class attribute bindings', () => {
      ...
      const fixture = TestBed.createComponent(App);
      const target = fixture.nativeElement.querySelector('div')!;      expect(target.classList.contains('-fred-36-')).toBeFalsy();      fixture.componentInstance.name = 'fred';
      fixture.componentInstance.age = '36';
      fixture.detectChanges();      expect(target.classList.contains('-fred-36-')).toBeTruthy();
    });
...
`Unexpected value 'SomeModule' declared by the module 'ModuleWithDeclaredModule'. Please add a @Pipe/@Directive/@Component annotation.`;      expect(() => {
...
.toThrowError(
   `Unexpected value 'SomeClass' declared by the module 'SomeModule'. Please add a @Pipe/@Directive/@Component annotation.`);
       ...
       () => {
t({template: ''})
tureComponent {eModule {}
({imports: [SomeModule], declarations: [FixtureComponent]})
uleWithImportedModule { => {
TestBed.configureTestingModule({imports: [ModuleWithImportedModule]})
.createComponent(FixtureComponent);  .toThrowError(
  /^Unexpected value 'SomeModule' imported by the module 'ModuleWithImportedModule'\. Please add an @NgModule annotation\.$/);
    ...
    it('should allow a self-closing tag for a custom tag name', () => {
      ...
      const fixture = TestBed.createComponent(App);      expect(fixture.nativeElement.innerHTML).toEqual('<my-comp>hello</my-comp>');
...
.toEqual('<my-comp title="a">Before<my-comp title="b"></my-comp>After</my-comp>');
    ...
    fixture.detectChanges();    button.nativeElement.click();
    fixture.detectChanges();    expect(clicks).toBe(1);
    ...
    fixture.detectChanges();    expect(subInstance.dirs.length).toBe(1);
    ...
    class NoAssignAfterDestroy {
      private _isDestroyed = false;      @Input()
      get value() {
        return this._value;
      }
...
throw Error('Cannot assign to value after destroy.');
      ...
      private _value: any;      ngOnDestroy() {
    ...
    fixture.detectChanges();    expect(fixture.componentInstance.tpl).not.toBeNull();
    ...
    fixture.detectChanges();    expect(button.isDisabled).toBe(false);    fixture.componentInstance.disableButton = true;
    fixture.detectChanges();    expect(button.isDisabled).toBe(true);
  });  it('should inherit outputs from undecorated superclasses', () => {
    let clicks = 0;    class ButtonSuperClass {
    ...
    const fixture = TestBed.createComponent(MyApp);
    const button = fixture.debugElement.query(By.directive(ButtonSubClass)).componentInstance;    button.emitClick();
    fixture.detectChanges();    expect(clicks).toBe(1);
    ...
    fixture.detectChanges();    expect(button.nativeElement.getAttribute('tabindex')).toBe('-1');    button.componentInstance.tabindex = 2;
    fixture.detectChanges();    expect(button.nativeElement.getAttribute('tabindex')).toBe('2');
  });  it('should inherit host bindings from undecorated grand superclasses', () => {
    class SuperBaseButton {
      @HostBinding('attr.tabindex') tabindex = -1;
    }    class BaseButton extends SuperBaseButton {}    @Component({selector: '[sub-button]', template: '<ng-content></ng-content>'})
    class SubButton extends BaseButton {
    }    @Component({template: '<button sub-button>Click me</button>'})
    class App {
    }    TestBed.configureTestingModule({declarations: [SubButton, App]});
    ...
    const fixture = TestBed.createComponent(App);
    const button = fixture.debugElement.query(By.directive(SubButton)).nativeElement;    button.click();
    fixture.detectChanges();    expect(clicks).toBe(1);
  });  it('should inherit host listeners from superclasses once', () => {
    let clicks = 0;    @Directive({selector: '[baseButton]'})
    class BaseButton {
      @HostListener('click')
      handleClick() {
        clicks++;
    ...
    let clicks = 0;    @Directive({selector: '[superBaseButton]'})
    class SuperBaseButton {
      @HostListener('click')
      handleClick() {
        clicks++;
    ...
    let clicks = 0;    @Directive({selector: '[superSuperBaseButton]'})
...
You are a Balrog: {{ falsyValue ?? true }}
    ...
    const fixture = TestBed.createComponent(App);
    fixture.detectChanges();
    const content = fixture.nativeElement.innerHTML;    expect(content).toContain('Hello, Frodo!');
    ...
    const fixture = TestBed.createComponent(App);
    fixture.detectChanges();
    const content = fixture.nativeElement.innerHTML;    expect(content).toContain('Hello, Bilbo!');
...
You are a Balrog: {{ person.getSpecies?.()?.()?.()?.()?.() || 'unknown' }}
    ...
    let plainCalls = 0;
    let safeCalls = 0;    @Component({template: `{{ safe?.()?.()?.()?.()?.() }} {{ plain()()()()() }}`})
    class App {
      plain() {
        plainCalls++;
        return returnValue;
    ...
    class Dir {
      firstName: string|null = null;
      lastName: string|null = null;
      lastNameFallback = 'Baggins';      logLastName(name: string) {
        logs.push(name);
      }
    ...
    button.click();
    fixture.detectChanges();    expect(button.getAttribute('first-name')).toBe('Hello, Frodo!');
...
<ng-template [ngIf]="condition">
 <text>Hello</text>
    ...
    fixture.detectChanges();    expect(fixture.nativeElement.innerHTML).toContain('<text>Hello</text>');
    ...
    const fixture = TestBed.createComponent(App);
    fixture.detectChanges();    expect(fixture.componentInstance.directive.value).toEqual({a: 1, b: 2, someProp: 3});
    ...
    const fixture = TestBed.createComponent(App);
    fixture.detectChanges();    expect(fixture.nativeElement.textContent).toBe('Balance: $5000000');
    ...
    const fixture = TestBed.createComponent(App);
    fixture.detectChanges();    expect(fixture.nativeElement.textContent).toContain('Hello, unknown!');
  });  it('should handle nested calls to a safe access methods in templates', () => {
    const log: string[] = [];    class Person {
      constructor(public name: string, public title: string) {}      getName(includeTitle: boolean|undefined) {
    ...
    class App {
      ...
      showTitle: boolean|null = null;      getConfig(name: string): {enabled: boolean}|null {
    ...
    log.length = 0;    fixture.componentInstance.person = new Person('Penelope', 'Lady');
    fixture.detectChanges(/* checkNoChanges */ false);
    ...
    log.length = 0;    fixture.componentInstance.showTitle = true;
    fixture.detectChanges(/* checkNoChanges */ false);
    ...
    log.length = 0;    fixture.componentInstance.showTitle = false;
    fixture.detectChanges(/* checkNoChanges */ false);
    expect(fixture.nativeElement.textContent).toContain('Hello, Penelope!');
    ...
    let current: LView|LContainer|null = leafLView;    while (current) {
    ...
    expect(lViewIds.every(id => getLViewById(id) !== null)).toBe(true);    fixture.destroy();    // Expect all 3 views to be removed from the registry once the root is destroyed.
    ...
    const fixture = TestBed.createComponent(App);
    fixture.detectChanges();    const template: HTMLTemplateElement = fixture.nativeElement.querySelector('template');
    // `content` won't exist in browsers that don't support `template`.
    const root = template.content || template;    expect(root.childNodes.length).toBe(2);
    ...
    fixture.detectChanges();    const template: HTMLTemplateElement = fixture.nativeElement.querySelector('template');
    // `content` won't exist in browsers that don't support `template`.
    const root = template.content || template;    expect(root.querySelector('strong')).toBeTruthy();    fixture.componentInstance.render = false;
    fixture.detectChanges();
    expect(root.querySelector('strong')).toBeFalsy();    fixture.componentInstance.render = true;
    fixture.detectChanges();
    ...
    const strong = root.querySelector('strong')!;    expect(strong.textContent).toBe('Hello Bilbo');    fixture.componentInstance.name = 'Frodo';
    fixture.detectChanges();    expect(strong.textContent).toBe('Hello Frodo');
...
declarations: [Cmp, Dir],ture = TestBed.createComponent(Cmp);
etectChanges(false);
ment = fixture.nativeElement.querySelector('div')!;rValues(element, 'first-update-pass');etectChanges(false);rValues(element, 'post-update-pass');
...
declarations: [Cmp, Dir],ture = TestBed.createComponent(Cmp);
etectChanges(false);ments = fixture.nativeElement.querySelectorAll('div');
rValues(elements[0], 'first-update-pass');
rValues(elements[1], 'post-update-pass');
rValues(elements[2], 'post-update-pass');etectChanges(false);
rValues(elements[0], 'post-update-pass');
rValues(elements[1], 'post-update-pass');
rValues(elements[2], 'post-update-pass');
       });
  });  describe('animations', () => {
...
<div *ngIf="showWarningMessage; else listOfItems">
 Nooo!
</div><ng-template #listOfItems>
 <animation-comp *ngFor="let item of items; trackBy: itemTrackFn">
   {{ item.value }}
 </animation-comp>
</ng-template>
        ` {
showWarningMessage = false;items: Item[] = [
  {value: 1, id: 1},
  {value: 2, id: 2},
  {value: 3, id: 3},
  {value: 4, id: 4},
...
template: `
 ...
 `mationComp {
@HostBinding('@host') public hostState = '';@HostListener('@host.start', ['$event'])
onLeaveStart(event: AnimationEvent) {
  // we just want to register the listener
}onfigureTestingModule({
declarations: [Cmp, AnimationComp],
providers: [{provide: AnimationDriver, useClass: MockAnimationDriver}],ture = TestBed.createComponent(Cmp);
etectChanges();nts = queryAll(fixture.nativeElement, 'animation-comp');
ements.length).toEqual(5);
ements.map(e => e.textContent?.trim())).toEqual(['1', '2', '3', '4', '5']);ms = fixture.componentInstance.items;
(items, 2, 0);  // 3 2 1 4 5
(items, 2, 1);  // 3 1 2 4 5
st = items.shift()!;
h(first);  // 1 2 4 5 3
etectChanges();= queryAll(fixture.nativeElement, 'animation-comp');
ements.length).toEqual(5);
ements.map(e => e.textContent?.trim())).toEqual(['1', '2', '4', '5', '3']);
nimations();omponentInstance.showWarningMessage = true;
etectChanges();
nimations();= queryAll(fixture.nativeElement, 'animation-comp');
ements.length).toEqual(0);
xture.nativeElement.textContent.trim()).toEqual('Nooo!');omponentInstance.showWarningMessage = false;
etectChanges();= queryAll(fixture.nativeElement, 'animation-comp');
ements.length).toEqual(5);
...
showIfContents = true;
items = [1];
log: string[] = [];track(name: string, event: AnimationEvent) {
  this.log.push(name);
}t({
selector: 'inner-comp',
animations: [
...
template: `
   <ng-content></ng-content>
 `erComp {
@HostBinding('@host') public hostState = '';constructor(@Inject(Cmp) private parent: Cmp) {}@HostListener('@host.start', ['$event'])
onLeaveStart(event: AnimationEvent) {
