...
import {NoopAnimationsModule} from '@angular/platform-browser/animations';describe('inheritance', () => {
...
const log: string[] = [];@Directive({selector: '[superDir]'})
class BaseDirective {
...
// to worry about it.)expect(log).toEqual([
...
const fixture = TestBed.createComponent(App);
fixture.detectChanges();expect(log).toEqual(['on changes!']);
    });    it('should be inherited when super is a simple class', () => {
const log: string[] = [];class SuperClass {
  ngOnChanges() {
log.push('on changes!');
  }
}@Directive({selector: '[subDir]'})
...
const log: string[] = [];@Directive({selector: '[grandSuperDir]'})
...
const log: string[] = [];class GrandSuperClass {
  ngOnChanges() {
log.push('on changes!');
  }
}@Directive({selector: '[superDir]'})
...
}class SuperClass extends GrandSuperDirective {}@Directive({selector: '[subDir]'})
class SubDirective extends SuperClass {
}@Component({template: `<div subDir [someInput]="1"></div>`})
class App {
}TestBed.configureTestingModule({
...
}class SuperClass extends GrandSuperClass {}@Directive({selector: '[subDir]'})
class SubDirective extends SuperClass {
  @Input() someInput = '';
}@Component({template: `<div subDir [someInput]="1"></div>`})
class App {
...
let changes = 0;abstract class Base {
...
const fixture = TestBed.createComponent(App);
fixture.detectChanges();expect(changes).toBe(1);
    });
  });  describe('of bare super class by a directive', () => {
    // TODO: Add tests for ContentChild
    // TODO: Add tests for ViewChild    describe('lifecycle hooks', () => {
const fired: string[] = [];class SuperDirective {
  ngOnInit() {
...
}beforeEach(() => fired.length = 0);it('ngOnInit', () => {
  @Directive({
selector: '[subDir]',
  })
  class SubDirective extends SuperDirective {
...
declarations: [SubDirective, App],
  ...
  const fixture = TestBed.createComponent(App);
  fixture.detectChanges();  expect(fired).toEqual([
'sub init',
'super do check',
...
// TODO: add test where super has an @Input('alias') on the property and sub has no aliasit('should inherit inputs', () => {
...
declarations: [App, SubDirective],
  ...
  const fixture = TestBed.createComponent(App);
  fixture.detectChanges();  const subDir =
 fixture.debugElement.query(By.directive(SubDirective)).injector.get(SubDirective);  expect(subDir.foo).toBe('a');
...
// TODO: add test where super has an @Input() on the property, and sub does notit('should inherit outputs', () => {
  class SuperDirective {
...
declarations: [App, SubDirective],
  ...
  const app = fixture.componentInstance;  expect(app.foo).toBe('test');
});
...
it('should compose host bindings for styles', () => {
  class SuperDirective {
@HostBinding('style.color') color = 'red';@HostBinding('style.backgroundColor') bg = 'black';
  }  @Directive({
selector: '[sub-dir]',
  })
  class SubDirective extends SuperDirective {
...
declarations: [App, SubDirective],
  ...
  const fixture = TestBed.createComponent(App);
  fixture.detectChanges();
  const queryResult = fixture.debugElement.query(By.directive(SubDirective));  expect(queryResult.nativeElement.tagName).toBe('P');
...
declarations: [App, SubDirective],
  ...
  const fixture = TestBed.createComponent(App);
  fixture.detectChanges();
  const queryResult = fixture.debugElement.query(By.directive(SubDirective));  expect(queryResult.nativeElement.title).toBe('test!!!');
});
    });    describe('ContentChildren', () => {
// TODO: sub and super HostBinding same property but different bindings
// TODO: sub and super HostBinding same binding on two different properties
it('should inherit ContentChildren queries', () => {
  let foundQueryList: QueryList<ChildDir>;  @Directive({selector: '[child-dir]'})
  class ChildDir {
  }  class SuperDirective {
...
declarations: [App, SubDirective, ChildDir],
  ...
  const fixture = TestBed.createComponent(App);
  fixture.detectChanges();  expect(foundQueryList!.length).toBe(2);
});
...
}class SuperDirective extends SuperSuperDirective {}beforeEach(() => fired.length = 0);it('ngOnInit', () => {
  @Directive({
selector: '[subDir]',
  })
  class SubDirective extends SuperDirective {
...
<div sub-dir (foo)="handleFoo($event)" (bar)="handleBar($event)"></div>
  ...
  class App {
foo = '';bar = '';handleFoo(event: string) {
 this.foo = event;
...
declarations: [App, SubDirective, SuperDirective, SuperSuperDirective],
  ...
  const fixture = TestBed.createComponent(App);
  fixture.detectChanges();
  const app = fixture.componentInstance;  expect(app.foo).toBe('test1');
...
declarations: [App, SubDirective, SuperDirective, SuperSuperDirective],
 ...
 fixture.debugElement.query(By.directive(SubDirective)).nativeElement;  expect(p.title).toBe('test1!!!');
  expect(p.accessKey).toBe('test2???');
});
    });    it('should inherit ContentChildren queries', () => {
let foundChildDir1s: QueryList<ChildDir1>;
let foundChildDir2s: QueryList<ChildDir2>;@Directive({selector: '[child-dir-one]'})
class ChildDir1 {
...
const fixture = TestBed.createComponent(App);
fixture.detectChanges();expect(foundChildDir1s!.length).toBe(2);
expect(foundChildDir2s!.length).toBe(2);
    ...
    // TODO: Add tests for ViewChild
    describe('lifecycle hooks', () => {
const fired: string[] = [];class SuperComponent {
  ngOnInit() {
fired.push('super init');
  }
  ngOnDestroy() {
...
declarations: [App, MyComponent],
  ...
  const fixture = TestBed.createComponent(App);
  fixture.detectChanges();  const subDir: MyComponent =
 fixture.debugElement.query(By.directive(MyComponent)).componentInstance;  expect(subDir.foo).toEqual('a');
...
declarations: [App, MyComponent],
  ...
  const fixture = TestBed.createComponent(App);
  fixture.detectChanges();
  const queryResult = fixture.debugElement.query(By.directive(MyComponent));  expect(queryResult.nativeElement.tagName).toBe('MY-COMP');
  expect(queryResult.nativeElement.style.color).toBe('red');
  expect(queryResult.nativeElement.style.backgroundColor).toBe('black');
});
    });    describe('host bindings (non-style related)', () => {
...
declarations: [App, MyComponent],
  ...
  const fixture = TestBed.createComponent(App);
  fixture.detectChanges();
  const queryResult = fixture.debugElement.query(By.directive(MyComponent));  expect(queryResult.nativeElement.title).toBe('test!!!');
});
    });    it('should inherit ContentChildren queries', () => {
let foundQueryList: QueryList<ChildDir>;@Directive({selector: '[child-dir]'})
class ChildDir {
...
const fixture = TestBed.createComponent(App);
fixture.detectChanges();expect(foundQueryList!.length).toBe(5);
    });    // TODO: sub has Input and super has Output on same property
    // TODO: sub has Input and super has HostBinding on same property
    // TODO: sub has Input and super has ViewChild on same property
    // TODO: sub has Input and super has ViewChildren on same property
...
}class BareClass extends SuperDirective {}beforeEach(() => fired.length = 0);it('ngOnInit', () => {
  @Component({selector: 'my-comp', template: `<p>test</p>`})
...
selector: '[super-dir]',
  ...
  class SuperDirective {
@Output() foo = new EventEmitter<string>();
  }  class BareClass extends SuperDirective {}  @Component({
selector: 'my-comp',
template: `<p>test</p>`,
  })
  class MyComponent extends BareClass {
...
declarations: [App, SuperDirective, BareClass, MyComponent],
  ...
  const fixture = TestBed.createComponent(App);
  fixture.detectChanges();
  const queryResult = fixture.debugElement.query(By.directive(MyComponent));  expect(queryResult.nativeElement.title).toBe('test1!!!');
...
imports: [NoopAnimationsModule],
  ...
  const fixture = TestBed.createComponent(App);
  fixture.detectChanges();
  const queryResult = fixture.debugElement.query(By.css('my-comp'));  expect(queryResult.nativeElement.style.color).toBe('red');
...
imports: [NoopAnimationsModule],
  ...
  const fixture = TestBed.createComponent(App);
  fixture.detectChanges();
  const queryResult = fixture.debugElement.query(By.css('my-comp'));  expect(queryResult.nativeElement.style.color).toBe('blue');
...
fixture.detectChanges();components.forEach(component => {
...
}class SuperComponent extends SuperSuperComponent {}beforeEach(() => fired.length = 0);it('ngOnInit', () => {
  @Component({
selector: 'my-comp',
template: `<p>test</p>`,
  })
...
declarations: [App, MyComponent, SuperSuperComponent, BareClass],
  ...
  const fixture = TestBed.createComponent(App);
  fixture.detectChanges();  const myComp: MyComponent =
 fixture.debugElement.query(By.directive(MyComponent)).componentInstance;  expect(myComp.foo).toEqual('a');
