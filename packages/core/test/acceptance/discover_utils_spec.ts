...
import {ComponentFixture, TestBed} from '@angular/core/testing';import {getLContext} from '../../src/render3/context_discovery';
import {getHostElement} from '../../src/render3/index';
import {ComponentDebugMetadata, getComponent, getComponentLView, getContext, getDirectiveMetadata, getDirectives, getInjectionTokens, getInjector, getListeners, getLocalRefs, getOwningComponent, getRootComponents} from '../../src/render3/util/discovery_utils';describe('discovery utils', () => {
...
expect(getOwningComponent<MyApp>(child[2])).toEqual(myApp);expect(getOwningComponent<MyApp>(childComponent[0])).toEqual(myApp);
...
expect(getLocalRefs(dirA[0])).toEqual({div: div[0], foo: dirA[0]});expect(getLocalRefs(child[1])).toEqual({child: childComponent[1]});
...
const component = fixture.componentInstance;expect(getRootComponents(hostElm)!).toEqual([component]);
...
const fixture = TestBed.createComponent(Comp);
fixture.detectChanges();const hostElm = fixture.nativeElement;
const elements = hostElm.querySelectorAll('div');const elm1 = elements[0];
const elm1Dirs = getDirectives(elm1);
expect(elm1Dirs).toContain(fixture.componentInstance.myDir1Instance!);
expect(elm1Dirs).toContain(fixture.componentInstance.myDir2Instance!);const elm2 = elements[1];
...
let result: any;expect(() => {
  result = getDirectives(document.createElement('div'));
}).not.toThrow();expect(result).toEqual([]);
    });
  });  describe('getInjector', () => {
...
const token = new InjectionToken<TestToken>('test token');TestBed.configureTestingModule(
...
const fixture = TestBed.createComponent(Comp);
fixture.detectChanges();const divEl = fixture.nativeElement.querySelector('div')!;
const localRefs = getLocalRefs(divEl);expect(localRefs['elRef'].tagName.toLowerCase()).toBe('div');
