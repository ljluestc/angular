...
import {TestBed} from '@angular/core/testing';describe('control flow', () => {
  describe('if', () => {
    beforeEach(() => setEnabledBlockTypes(['if']));
    afterEach(() => setEnabledBlockTypes([]));    // Basic shared pipe used during testing.
...
fixture.detectChanges();expect(fixture.nativeElement.textContent).toBe('Something');fixture.componentInstance.show = false;
...
fixture.detectChanges();
expect(fixture.nativeElement.textContent).toBe('true aliased to true');fixture.componentInstance.show = 1;
fixture.detectChanges();
...
fixture.detectChanges();
expect(fixture.nativeElement.textContent.trim()).toBe('If: 1 as true');fixture.componentInstance.value = 2;
fixture.detectChanges();
expect(fixture.nativeElement.textContent.trim()).toBe('ElseIf: 2 as unavailable');fixture.componentInstance.value = 3;
fixture.detectChanges();
...
expect(content).toContain('Innermost: 1/2/3/4');fixture.componentInstance.value = 2;
fixture.detectChanges();
...
let logs: any[] = [];@Component({
  standalone: true,
  imports: [MultiplyPipe],
  template: `
{#if value | multiply:2; as root}
 <button (click)="log(['Root', value, root])"></button> {#if value | multiply:3; as inner}
   <button (click)="log(['Inner', value, root, inner])"></button>   {#if value | multiply:4; as innermost}
...
fixture.detectChanges();expect(logs).toEqual([['Root', 1, 2], ['Inner', 1, 2, 3], ['Innermost', 1, 2, 3, 4]]);logs = [];
fixture.componentInstance.value = 2;
fixture.detectChanges();buttons.forEach(button => button.click());
fixture.detectChanges();
...
fixture.detectChanges();
expect(fixture.nativeElement.textContent).toBe('1 aliased to 2');fixture.componentInstance.value = 4;
fixture.detectChanges();
...
fixture.detectChanges();
expect(fixture.nativeElement.textContent).toBe('Something');fixture.componentInstance.show = false;
fixture.detectChanges();
expect(fixture.nativeElement.textContent).toBe('');
    });
  });  describe('switch', () => {
    beforeEach(() => setEnabledBlockTypes(['switch']));
    afterEach(() => setEnabledBlockTypes([]));    // Open question: == vs. === for comparison
...
fixture.detectChanges();expect(fixture.nativeElement.textContent).toBe('case 0 ');fixture.componentInstance.case = 1;
fixture.detectChanges();
expect(fixture.nativeElement.textContent).toBe('case 1 ');fixture.componentInstance.case = 5;
fixture.detectChanges();
expect(fixture.nativeElement.textContent).toBe('default ');
    });
  });  describe('for', () => {
    beforeEach(() => setEnabledBlockTypes(['for', 'if']));
    afterEach(() => setEnabledBlockTypes([]));    it('should create, remove and move views corresponding to items in a collection', () => {
@Component({
...
fixture.detectChanges();
expect(fixture.nativeElement.textContent).toBe('1(0)|2(1)|3(2)|');fixture.componentInstance.items.pop();
fixture.detectChanges();
expect(fixture.nativeElement.textContent).toBe('1(0)|2(1)|');fixture.componentInstance.items.push(3);
fixture.detectChanges();
expect(fixture.nativeElement.textContent).toBe('1(0)|2(1)|3(2)|');fixture.componentInstance.items[0] = 3;
...
fixture.detectChanges();
expect(fixture.nativeElement.textContent).toBe('|||');fixture.componentInstance.items = [];
fixture.detectChanges();
expect(fixture.nativeElement.textContent).toBe('Empty');fixture.componentInstance.items = [0, 1];
fixture.detectChanges();
expect(fixture.nativeElement.textContent).toBe('||');fixture.componentInstance.items = null;
fixture.detectChanges();
expect(fixture.nativeElement.textContent).toBe('Empty');fixture.componentInstance.items = [0];
fixture.detectChanges();
expect(fixture.nativeElement.textContent).toBe('|');fixture.componentInstance.items = undefined;
fixture.detectChanges();
expect(fixture.nativeElement.textContent).toBe('Empty');
    });    it('should have access to the host context in the track function', () => {
let offsetReads = 0;@Component({template: '{#for (item of items); track $index + offset}{{item}}{/for}'})
class TestComponent {
  items = ['a', 'b', 'c'];  get offset() {
offsetReads++;
return 0;
  }
}const fixture = TestBed.createComponent(TestComponent);
...
expect(offsetReads).toBeGreaterThan(0);const prevReads = offsetReads;
...
expect(offsetReads).toBeGreaterThan(prevReads);
 ...
 () => {
ls: string[][] = [];t({
template: `{#for (item of items); track trackingFn(item, compProp)}{{item}}{/for}`,tComponent {
items = ['one', 'two', 'three'];
compProp = 'hello';trackingFn(item: string, message: string) {
  calls.push([item, message]);
  return item;
}ture = TestBed.createComponent(TestComponent);
etectChanges();
lls).toEqual([
['one', 'hello'],
['two', 'hello'],
...
['one', 'hello'],
['two', 'hello'],
['three', 'hello'], });    it('should be able to access component properties in the tracking function from a nested template',
 () => {
ls: string[][] = [];t({
template: `
 {#if true}
