...
import {TestBed} from '@angular/core/testing';// **NOTE**: More details on why tests relying on `forwardRef` are put into this
// file can be found in the `BUILD.bazel` file declaring the forward ref test target.describe('di with forwardRef', () => {
...
fixture.detectChanges();const myComp = fixture.componentInstance.myComp;
