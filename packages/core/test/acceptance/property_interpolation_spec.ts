...
import {of} from 'rxjs';describe('property interpolation', () => {
...
nine = 9;
    ...
    fixture.detectChanges();    const titles =
  Array.from(<NodeListOf<HTMLDivElement>>fixture.nativeElement.querySelectorAll('div[title]'))
 .map((div: HTMLDivElement) => div.title);    expect(titles).toEqual([
'a1b2c3d4e5f6g7h8i9j',
'a1b2c3d4e5f6g7h8i',
'a1b2c3d4e5f6g7h',
'a1b2c3d4e5f6g',
...
details = of({
  ...
  url: 'http://somecooldomain:1234/cool_image.png',
    ...
    const fixture = TestBed.createComponent(App);
    fixture.detectChanges();    const img: HTMLImageElement = fixture.nativeElement.querySelector('img');
...
return {
 getPhotoUrl() {
   return 'http://somecooldomain:1234/cool_image.png';
    ...
    const img = fixture.nativeElement.querySelector('img');    expect(img.src).toBe('http://somecooldomain:1234/cool_image.png');
...
naughty = 'javascript:alert("haha, I am taking over your computer!!!");';
    ...
    const fixture = TestBed.createComponent(App);
    fixture.detectChanges();
    const img: HTMLImageElement = fixture.nativeElement.querySelector('img');    expect(img.src.indexOf('unsafe:')).toBe(0);
...
naughty = 'alert("I am a h4xx0rz1!!");';
    ...
    const fixture = TestBed.createComponent(App);
    fixture.detectChanges();
    const img = fixture.nativeElement.querySelector('img');    expect(img.src.indexOf('unsafe:')).toBe(0);
...
nine = 9;
    ...
    const fixture = TestBed.createComponent(AppComp);
    fixture.detectChanges();    const titles = Array
  .from(<NodeListOf<HTMLImageElement>>fixture.nativeElement.querySelectorAll(
 'img[title]'))
  .map((img: HTMLImageElement) => img.title);    expect(titles).toEqual([
'a1b2c3d4e5f6g7h8i9j',
'a1b2c3d4e5f6g7h8i',
'a1b2c3d4e5f6g7h',
'a1b2c3d4e5f6g',
...
'1',
 ...
 .map((img: HTMLImageElement) => img.alt);    expect(others).toEqual([
'a1b2c3d4e5f6g7h8i9j',
'a1b2c3d4e5f6g7h8i',
'a1b2c3d4e5f6g7h',
'a1b2c3d4e5f6g',
