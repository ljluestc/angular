 ...
 */import {ɵɵComponentDeclaration, ɵɵPipeDeclaration} from '@angular/core';declare class SuperComponent {
  ...
  onlyInSubtype: string;  static ɵcmp: ɵɵComponentDeclaration<SubComponent, '[sub]', never, {}, {}, never, never>;
}declare class SuperPipe {
  static ɵpipe: ɵɵPipeDeclaration<SuperPipe, 'super'>;
}declare class SubPipe extends SuperPipe {
  onlyInSubtype: string;  static ɵpipe: ɵɵPipeDeclaration<SubPipe, 'sub'>;
