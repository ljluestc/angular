...
import {ActivatedRoute, Router, RouterModule, RouterOutlet} from '@angular/router';(function() {
// these tests are only meant to be run within the DOM (for now)
if (isNode) return;describe('Animation Router Tests', function() {
...
<div [@routerAnimations]="prepareRouteAnimation(r)">
 <router-outlet #r="outlet"></router-outlet>
       ...
       class ContainerCmp {
or(public router: Router) {}uteAnimation(r: RouterOutlet) {
...
[
  transition(
      ...
      [
       ...
       class Page1Cmp {
ing('@page1Animation') public doAnimate = true;
       }       @Component({
 'page2',
 `page2`,
s: [
...
[
  transition(
      ...
      [
       ...
       class Page2Cmp {
ing('@page2Animation') public doAnimate = true;
       }       TestBed.configureTestingModule({
ons: [Page1Cmp, Page2Cmp, ContainerCmp],
[RouterModule.forRoot([
{path: 'page1', component: Page1Cmp, data: makeAnimationData('page1')},
{path: 'page2', component: Page2Cmp, data: makeAnimationData('page2')}       });       const engine = TestBed.inject(ɵAnimationEngine);
       const fixture = TestBed.createComponent(ContainerCmp);
       const cmp = fixture.componentInstance;
       cmp.router.initialNavigation();
       tick();
       fixture.detectChanges();
       engine.flush();       cmp.router.navigateByUrl('/page1');
       tick();
       fixture.detectChanges();
       engine.flush();       cmp.router.navigateByUrl('/page2');
       tick();
       fixture.detectChanges();
       engine.flush();       const player = engine.players[0]!;
       const groupPlayer =
(player as TransitionAnimationPlayer).getRealPlayer() as AnimationGroupPlayer;
       const players = groupPlayer.players as MockAnimationPlayer[];       expect(players.length).toEqual(2);
       const [p1, p2] = players;       expect(p1.duration).toEqual(1000);
       expect(p1.keyframes).toEqual([
tring, string|number>([['offset', 0], ['width', '200px']]),
tring, string|number>([['offset', 1], ['width', '0px']]),
       ]);       expect(p2.duration).toEqual(2000);
       expect(p2.keyframes).toEqual([
tring, string|number>([['offset', 0], ['opacity', '0']]),
tring, string|number>([['offset', .5], ['opacity', '0']]),
tring, string|number>([['offset', 1], ['opacity', '1']]),
       ]);
...
const animation = r.activatedRouteData['animation'];
const value = animation ? animation['value'] : null;
return value;       }       @Component({selector: 'page1', template: `page1`, animations: []})
       class Page1Cmp {
       }       @Component({
 'page2',
 `
...
[transition(':enter', [style({opacity: 0}), animate(1000, style({opacity: 1}))])])       })
       class Page2Cmp {
ing('@page2Animation') public doAnimate = true;p = true;
       }       TestBed.configureTestingModule({
ons: [Page1Cmp, Page2Cmp, ContainerCmp],
[RouterModule.forRoot([
{path: 'page1', component: Page1Cmp, data: makeAnimationData('page1')},
...
(player as TransitionAnimationPlayer).getRealPlayer() as AnimationGroupPlayer;
       const players = groupPlayer.players as MockAnimationPlayer[];       expect(players.length).toEqual(2);
       const [p1, p2] = players;       expect(p1.keyframes).toEqual([
tring, string|number>([['offset', 0], ['opacity', '0']]),
tring, string|number>([['offset', 1], ['opacity', '1']]),
       ]);       expect(p2.keyframes).toEqual([
tring, string|number>([['offset', 0], ['opacity', '0']]),
...
[transition(':leave', [style({opacity: 1}), animate(1000, style({opacity: 0}))])]),       })
       class Page1Cmp {
ing('@page1Animation') public doAnimate = true;p = true;
...
(player as TransitionAnimationPlayer).getRealPlayer() as AnimationGroupPlayer;
       const players = groupPlayer.players as MockAnimationPlayer[];       expect(players.length).toEqual(2);
       const [p1, p2] = players;       expect(p1.keyframes).toEqual([
tring, string|number>([['offset', 0], ['opacity', '1']]),
tring, string|number>([['offset', 1], ['opacity', '0']]),
       ]);       expect(p2.keyframes).toEqual([
tring, string|number>([['offset', 0], ['opacity', '1']]),
tring, string|number>([['offset', .5], ['opacity', '1']]),
tring, string|number>([['offset', 1], ['opacity', '0']]),
       ]);
...
<div [@pageAnimation]="prepRoute(outlet)">
 ...
 <section class="router-container">
   <router-outlet #outlet="outlet"></router-outlet>
       ...
       class ContainerCmp {
 false;or(public router: Router) {}(outlet: any) {
return outlet.activatedRouteData['animation'];       }       @Component({selector: 'page1', template: `page1`})
       class Page1Cmp {
...
{path: 'page2', component: Page2Cmp, data: makeAnimationData('page2')}       });       const engine = TestBed.inject(ɵAnimationEngine);
       ...
       const [p1] = players;       const innerPlayers =
((p1 as TransitionAnimationPlayer).getRealPlayer() as AnimationGroupPlayer).players;
       expect(innerPlayers.length).toEqual(2);       const [ip1, ip2] = innerPlayers as any;
     ...
     fakeAsync(() => {
       ...
       class ContainerCmp {
or(private _router: Router) {}
ng[] = [];this._router.navigateByUrl('/(recur:recur/nested)');this._router.navigateByUrl('/');       }       @Component({
 'recur-page',
...
query('@*', animateChild(), {optional: true})
       ...
       class RecurPageCmp {
ing('@pageAnimations') public animatePage = true;ing('attr.data-depth') public depth = 0;or(private container: ContainerCmp, private route: ActivatedRoute) {
this.route.data.subscribe(data => {
  this.container.log.push(`DEPTH ${data['depth']}`);
  this.depth = data['depth'];
});       }       TestBed.configureTestingModule({
ons: [ContainerCmp, RecurPageCmp],
[RouterModule.forRoot([{
path: 'recur',
component: RecurPageCmp,
outlet: 'recur',
data: {depth: 0},
children: [{path: 'nested', component: RecurPageCmp, data: {depth: 1}}]       });       const fixture = TestBed.createComponent(ContainerCmp);
       const cmp = fixture.componentInstance;
       cmp.enter();
       tick();
       fixture.detectChanges();
       flushMicrotasks();       expect(cmp.log).toEqual([
,
,
       ]);       cmp.leave();
       tick();
