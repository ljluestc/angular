 ...
 */import {NO_ERRORS_SCHEMA, SchemaMetadata, Type, ɵNgModuleDef, ɵɵngDeclareNgModule} from '@angular/core';describe('NgModule declaration jit compilation', () => {
...
class TestComponent {}
class TestModule {}type NgModuleDefExpectations = jasmine.Expected<{
