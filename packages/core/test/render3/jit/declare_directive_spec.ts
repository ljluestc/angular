 ...
 */import {ElementRef, forwardRef, ɵɵngDeclareDirective} from '@angular/core';import {AttributeMarker, DirectiveDef, ɵɵInheritDefinitionFeature, ɵɵNgOnChangesFeature} from '../../../src/render3';import {functionContaining} from './matcher';describe('directive declaration jit compilation', () => {
  it('should compile a minimal directive declaration', () => {
    const def = ɵɵngDeclareDirective({
   type: TestClass,
 }) as DirectiveDef<TestClass>;    expectDirectiveDef(def, {});
  });  it('should compile a selector', () => {
    const def =
  ɵɵngDeclareDirective({type: TestClass, selector: '[dir], test'}) as DirectiveDef<TestClass>;    expectDirectiveDef(def, {
selectors: [['', 'dir', ''], ['test']],
    });
...
contentQueries: functionContaining([
  ...
  '(ctx.byRef = _t)',  // "byToken" should use `viewQuery` with `3` (`QueryFlags.static|QueryFlags.descendants`)
 ...
 }) as DirectiveDef<TestClass>;    class Child {}    expectDirectiveDef(def, {
contentQueries: functionContaining([
