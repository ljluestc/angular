...
import {TestBed} from '@angular/core/testing';describe('query', () => {
  describe('predicate', () => {
    describe('providers', () => {
@Injectable()
class Service {
...
class Alias {
}let directive: MyDirective|null = null;@Directive({
  selector: '[myDir]',
  standalone: true,
  providers: [
Service,
...
}beforeEach(() => directive = null);// https://stackblitz.com/edit/ng-viewengine-viewchild-providers?file=src%2Fapp%2Fapp.component.ts
...
@ViewChildren('foo') query!: QueryList<any>;
    ...
    fixture.detectChanges();    expect(fixture.componentInstance.query.length).toBe(1);
  });
});
