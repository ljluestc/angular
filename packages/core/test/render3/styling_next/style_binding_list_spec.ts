...
import {newArray} from '@angular/core/src/util/array_utils';describe('TNode styling linked list', () => {
...
const tData: TData = [null, null];insertTStylingBinding(tData, tNode, 'tmpl1', 2, false, true);
...
const tNode = createTNode(null!, null!, TNodeType.Element, 0, '', null);insertTStylingBinding(tData, tNode, 'host1', 2, true, true);
...
//   ɵɵstyleProp('color', '#008');  // Binding index: 30const tNode = createTNode(null!, null!, TNodeType.Element, 0, '', null);
tNode.styles = '';
const tData: TData = newArray(32, null);insertTStylingBinding(tData, tNode, null, 10, false, false);
...
const empty_14_through_19 = [null, null, null, null, null, null];function expectRange(tStylingRange: TStylingRange) {
  return expect([
