 ...
 */import {TNodeType, toTNodeTypeAsString} from '@angular/core/src/render3/interfaces/node';describe('node interfaces', () => {
  describe('TNodeType', () => {
...
expect(toTNodeTypeAsString(TNodeType.Placeholder)).toEqual('Placeholder');expect(toTNodeTypeAsString(
