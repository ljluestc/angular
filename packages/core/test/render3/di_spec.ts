...
import {TestBed} from '@angular/core/testing';import {bloomAdd, bloomHashBitOrFactory as bloomHash, bloomHasToken, getOrCreateNodeInjectorForNode} from '../../src/render3/di';
import {TNodeType} from '../../src/render3/interfaces/node';
import {HEADER_OFFSET, LViewFlags, TVIEW, TViewType} from '../../src/render3/interfaces/view';
import {enterView, leaveView} from '../../src/render3/state';describe('di', () => {
...
class Dir260 {
  ...
  bloomAdd(0, mockTView, Dir198);
  bloomAdd(0, mockTView, Dir231);
  bloomAdd(0, mockTView, Dir260);  expect(bloomHasToken(bloomHash(Dir0) as number, 0, mockTView.data)).toEqual(true);
...
try {
 ...
 getOrCreateTNode(contentView[TVIEW], HEADER_OFFSET, TNodeType.Element, null, null);
  ...
  (parentTNode as {parent: any}).parent = undefined;  const injector = getOrCreateNodeInjectorForNode(parentTNode, contentView);
