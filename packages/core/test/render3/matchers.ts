...
import {TView} from '@angular/core/src/render3/interfaces/view';import {isDOMElement, isDOMText, isTI18n, isTIcu, isTNode, isTView} from './is_shape_of';/**
...
export function matchObjectShape<T>(
  ...
  let _matcherUtils: jasmine.MatchersUtil = null!;  matcher.asymmetricMatch = function(actual: any, matcherUtils: jasmine.MatchersUtil) {
    _actual = actual;
...
export function matchDomElement(
  ...
  const matcher = function() {};
  let _actual: any = null;  matcher.asymmetricMatch = function(actual: any) {
    _actual = actual;
...
JSON.stringify(_actual);
  ...
  const matcher = function() {};
  let _actual: any = null;  matcher.asymmetricMatch = function(actual: any, matchersUtil: jasmine.MatchersUtil) {
    _actual = actual;
