 ...
 */import '@angular/compiler';import {runfiles} from '@bazel/runfiles';
import * as fs from 'fs';
import * as path from 'path';const PACKAGE = 'angular/packages/core/test/bundling/animations-standalone';describe('treeshaking with uglify', () => {
  let content: string;
