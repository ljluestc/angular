...
import {BrowserModule, platformBrowser} from '@angular/platform-browser';class Todo {
  editing: boolean;  private _title!: string;
  get title() {
    return this._title;
  }
...
class ToDoAppComponent {
  newTodoText = '';  constructor(public todoStore: TodoStore) {
    ...
    todo.editing = false;    if (editedTitle.length === 0) {
