...
since there is a bigger one right below it
    -->
    <img ngSrc="/e2e/b.png" width="5" height="5">    <br>    <!-- 'a.png' should be treated as an LCP element -->
    <img [ngSrc]=imageSrc width="2500" height="2500">    <br>    <!--
