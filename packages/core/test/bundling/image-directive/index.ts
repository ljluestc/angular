...
import {RouterModule} from '@angular/router';import {BasicComponent} from './e2e/basic/basic';
...
export class RootComponent {
  ...
  {path: '', component: PlaygroundComponent},  // Paths below are used for e2e testing:
