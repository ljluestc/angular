...
import {Subscription} from 'rxjs';import {DeferBlockFixture} from './defer';/**
...
export class ComponentFixture<T> {
   ...
   */
  changeDetectorRef: ChangeDetectorRef;  private _renderer: RendererFactory2|null|undefined;
  ...
  private _onErrorSubscription: Subscription|null = null;  /** @nodoc */
  constructor(
...
return this._promise;
  ...
  getDeferBlocks(): Promise<DeferBlockFixture[]> {
    ...
    getDeferBlocks(lView, deferBlocks);    const deferBlockFixtures = [];
